...
{id:'q096',p:'Quem era o pai de Isaque?',a:['Abraão','Jacó','José','Davi'],c:0},
...
{id:'q061',p:'Quem construiu a arca?',a:['Noé','Moisés','Abraão','Davi'],c:0},
{id:'q062',p:'Quem abriu o Mar Vermelho?',a:['Moisés','Josué','Arão','Elias'],c:0},
{id:'q063',p:'Quem foi jogado na cova dos leões?',a:['Daniel','Davi','José','Elias'],c:0},
{id:'q064',p:'Quem derrotou Golias?',a:['Davi','Saul','Samuel','Josué'],c:0},
{id:'q065',p:'Quem foi o homem mais sábio?',a:['Salomão','Davi','Moisés','Isaías'],c:0},
{id:'q066',p:'Quem foi vendido como escravo pelos irmãos?',a:['José','Davi','Moisés','Esaú'],c:0},
{id:'q067',p:'Quem foi o primeiro homem?',a:['Adão','Caim','Noé','Abraão'],c:0},
{id:'q068',p:'Quem foi a primeira mulher?',a:['Eva','Sara','Rebeca','Raquel'],c:0},
{id:'q069',p:'Quem matou Abel?',a:['Caim','Adão','Noé','Esaú'],c:0},
{id:'q070',p:'Quem foi o pai da fé?',a:['Abraão','Moisés','Davi','José'],c:0},

{id:'q071',p:'Quem recebeu os 10 mandamentos?',a:['Moisés','Josué','Arão','Davi'],c:0},
{id:'q072',p:'Quem foi lançado na fornalha?',a:['Sadraque, Mesaque e Abede-Nego','Daniel','Elias','Isaías'],c:0},
{id:'q073',p:'Quem guiou o povo após Moisés?',a:['Josué','Calebe','Arão','Samuel'],c:0},
{id:'q074',p:'Quem era o pai de Davi?',a:['Jessé','Saul','Samuel','Salomão'],c:0},
{id:'q075',p:'Quem foi o primeiro rei de Israel?',a:['Saul','Davi','Salomão','Josias'],c:0},
{id:'q076',p:'Quem escreveu Salmos?',a:['Davi','Salomão','Moisés','Isaías'],c:0},
{id:'q077',p:'Quem construiu o templo?',a:['Salomão','Davi','Josué','Ezequias'],c:0},
{id:'q078',p:'Quem foi engolido por um grande peixe?',a:['Jonas','Elias','Daniel','Isaías'],c:0},
{id:'q079',p:'Quem foi discípulo amado?',a:['João','Pedro','Tiago','André'],c:0},
{id:'q080',p:'Quem negou Jesus três vezes?',a:['Pedro','João','Tomé','Mateus'],c:0},

{id:'q081',p:'Quem traiu Jesus?',a:['Judas','Pedro','João','Tiago'],c:0},
{id:'q082',p:'Quem foi crucificado com Jesus e se arrependeu?',a:['Ladrão na cruz','Pedro','João','Paulo'],c:0},
{id:'q083',p:'Quem batizou Jesus?',a:['João Batista','Pedro','Tiago','Paulo'],c:0},
{id:'q084',p:'Quem era a mãe de Jesus?',a:['Maria','Marta','Ana','Sara'],c:0},
{id:'q085',p:'Quem era o pai adotivo de Jesus?',a:['José','Pedro','João','Zacarias'],c:0},
{id:'q086',p:'Quem escreveu Apocalipse?',a:['João','Pedro','Paulo','Lucas'],c:0},
{id:'q087',p:'Quem foi o primeiro mártir?',a:['Estêvão','Paulo','Pedro','João'],c:0},
{id:'q088',p:'Quem foi o apóstolo dos gentios?',a:['Paulo','Pedro','João','Tiago'],c:0},
{id:'q089',p:'Quem era médico?',a:['Lucas','Mateus','Pedro','Tiago'],c:0},
{id:'q090',p:'Quem escreveu Gênesis?',a:['Moisés','Abraão','Davi','Salomão'],c:0},

{id:'q091',p:'Quem sonhou com vacas gordas e magras?',a:['Faraó','José','Moisés','Daniel'],c:0},
{id:'q092',p:'Quem interpretou esse sonho?',a:['José','Daniel','Elias','Isaías'],c:0},
{id:'q093',p:'Quem foi lançado numa cisterna?',a:['Jeremias','Isaías','Ezequiel','Daniel'],c:0},
{id:'q094',p:'Quem lutou com um anjo?',a:['Jacó','Abraão','Moisés','Josué'],c:0},
{id:'q095',p:'Quem recebeu o nome Israel?',a:['Jacó','Abraão','Moisés','Davi'],c:0},
{id:'q096',p:'Quem foi pai de Jacó?',a:['Isaque','Abraão','José','Moisés'],c:0},
{id:'q097',p:'Quem foi pai de Isaque?',a:['Abraão','Jacó','José','Davi'],c:0},
{id:'q098',p:'Quem era irmão de Jacó?',a:['Esaú','José','Davi','Samuel'],c:0},
{id:'q099',p:'Quem teve túnica colorida?',a:['José','Davi','Moisés','Samuel'],c:0},
{id:'q100',p:'Quem interpretava sonhos na Babilônia?',a:['Daniel','José','Elias','Isaías'],c:0},

{id:'q101',p:'Quem era rainha que salvou seu povo?',a:['Ester','Rute','Débora','Sara'],c:0},
{id:'q102',p:'Quem foi bisavó de Davi?',a:['Rute','Ester','Sara','Rebeca'],c:0},
{id:'q103',p:'Quem foi juiz mulher?',a:['Débora','Rute','Ester','Sara'],c:0},
{id:'q104',p:'Quem derrubou os muros de Jericó?',a:['Josué','Moisés','Davi','Saul'],c:0},
{id:'q105',p:'Quem teve força sobrenatural?',a:['Sansão','Davi','Saul','Josué'],c:0},
{id:'q106',p:'Quem cortou o cabelo de Sansão?',a:['Dalila','Ester','Rute','Sara'],c:0},
{id:'q107',p:'Quem foi profeta do fogo?',a:['Elias','Eliseu','Isaías','Jeremias'],c:0},
{id:'q108',p:'Quem sucedeu Elias?',a:['Eliseu','Isaías','Jeremias','Daniel'],c:0},
{id:'q109',p:'Quem multiplicou o azeite?',a:['Eliseu','Elias','Isaías','Daniel'],c:0},
{id:'q110',p:'Quem foi levado ao céu sem morrer?',a:['Enoque','Abraão','Davi','Isaías'],c:0},

{id:'q111',p:'Quem escreveu Provérbios?',a:['Salomão','Davi','Moisés','Isaías'],c:0},
{id:'q112',p:'Quem escreveu Eclesiastes?',a:['Salomão','Davi','Moisés','Isaías'],c:0},
{id:'q113',p:'Quem escreveu Isaías?',a:['Isaías','Jeremias','Ezequiel','Daniel'],c:0},
{id:'q114',p:'Quem escreveu Jeremias?',a:['Jeremias','Isaías','Ezequiel','Daniel'],c:0},
{id:'q115',p:'Quem escreveu Ezequiel?',a:['Ezequiel','Isaías','Jeremias','Daniel'],c:0},
{id:'q116',p:'Quem foi o profeta chorão?',a:['Jeremias','Isaías','Daniel','Ezequiel'],c:0},
{id:'q117',p:'Quem viu o vale de ossos secos?',a:['Ezequiel','Isaías','Jeremias','Daniel'],c:0},
{id:'q118',p:'Quem foi o profeta do exílio?',a:['Daniel','Isaías','Jeremias','Ezequiel'],c:0},
{id:'q119',p:'Quem escreveu Apocalipse?',a:['João','Pedro','Paulo','Lucas'],c:0},
{id:'q120',p:'Quem foi preso em Patmos?',a:['João','Pedro','Paulo','Lucas'],c:0},
