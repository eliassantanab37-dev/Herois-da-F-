// js/livros/primeiro_reis.js
const sortear = (lista) => lista[Math.floor(Math.random() * lista.length)];

export const primeiro_reis = {
    nome: "1 Reis",
   icone: "📜",         // Emoji ou Ícone que aparece no card
    autor: "Jeremias (tradição)",
    //background: "./imagens/primeiro_reis_bg.jpg", 
    ...
    capitulos: {
        1: {
            titulo: "Salomão é Ungido Rei",
            texto: ` ¹ Sendo, pois, o rei Davi já velho, e entrado em dias, cobriam-no de roupas, porém não se aquecia.
...
`,
            get pergunta() {
                return sortear([
                    {
                        texto: "Quem tentou se exaltar para ser rei antes de Salomão ser ungido?",
                        opcoes: [
                            { numero: 1, texto: "Absalão", correta: false },
                            { numero: 2, texto: "Adonias", correta: true },
                            { numero: 3, texto: "Natã", correta: false },
                            { numero: 4, texto: "Benaia", correta: false }
                        ],
                        explicacao: "1 Reis 1:5 - Então Adonias, filho de Hagite, se exaltou, dizendo: Eu reinarei.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "Qual profeta avisou Bate-Seba sobre a tentativa de Adonias de tomar o trono?",
                        opcoes: [
                            { numero: 1, texto: "Samuel", correta: false },
                            { numero: 2, texto: "Elias", correta: false },
                            { numero: 3, texto: "Natã", correta: true },
                            { numero: 4, texto: "Gade", correta: false }
                        ],
                        explicacao: "1 Reis 1:11 - Então falou Natã a Bate-Seba, mãe de Salomão, dizendo: Não ouviste que Adonias... reina?",
                        pontosGanhos: 20
                    },
                    {
                        texto: "Sobre qual animal Salomão foi montado para ser levado à sua unção?",
                        opcoes: [
                            { numero: 1, texto: "Um cavalo branco", correta: false },
                            { numero: 2, texto: "Um camelo", correta: false },
                            { numero: 3, texto: "Um carro de guerra", correta: false },
                            { numero: 4, texto: "A mula do rei Davi", correta: true }
                        ],
                        explicacao: "1 Reis 1:33 - ...fazei montar a meu filho Salomão na minha mula, e levai-o a Giom.",
                        pontosGanhos: 20
                    }
                ]);
            }
        ...
        2: {
            titulo: "As Últimas Instruções de Davi",
            texto: ` ¹ E aproximaram-se os dias da morte de Davi; e deu ele ordem a Salomão, seu filho, dizendo:
...
`,
            get pergunta() {
                return sortear([
                    {
                        texto: "O que Davi disse a Salomão para ele ser, antes de morrer?",
                        opcoes: [
                            { numero: 1, texto: "Rico e poderoso", correta: false },
                            { numero: 2, texto: "Corajoso e sê homem", correta: true },
                            { numero: 3, texto: "Um grande guerreiro", correta: false },
                            { numero: 4, texto: "Um viajante", correta: false }
                        ],
                        explicacao: "1 Reis 2:2 - Eu vou pelo caminho de toda a terra; esforça-te, pois, e sê homem.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "Por quantos anos Davi reinou sobre todo o Israel?",
                        opcoes: [
                            { numero: 1, texto: "Trinta anos", correta: false },
                            { numero: 2, texto: "Quarenta anos", correta: true },
                            { numero: 3, texto: "Setenta anos", correta: false },
                            { numero: 4, texto: "Vinte e cinco anos", correta: false }
                        ],
                        explicacao: "1 Reis 2:11 - E foram os dias que Davi reinou sobre Israel quarenta anos.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "Onde Davi foi sepultado?",
                        opcoes: [
                            { numero: 1, texto: "Em Belém", correta: false },
                            { numero: 2, texto: "No Monte Sinai", correta: false },
                            { numero: 3, texto: "No Egito", correta: false },
                            { numero: 4, texto: "Na cidade de Davi", correta: true }
                        ],
                        explicacao: "1 Reis 2:10 - E Davi dormiu com seus pais, e foi sepultado na cidade de Davi.",
                        pontosGanhos: 20
                    }
                ]);
            }
        ...
        3: {
            titulo: "O Pedido de Sabedoria",
            texto: ` ¹ E Salomão se aparentou com Faraó, rei do Egito; e tomou a filha de Faraó, e a trouxe à cidade de Davi, até que acabasse de edificar a sua casa, e a casa do Senhor, e a muralha de Jerusalém em redor.
...
`,
            get pergunta() {
                return sortear([
                    {
                        texto: "O que Salomão pediu a Deus em sonho quando estava em Gibeão?",
                        opcoes: [
                            { numero: 1, texto: "Longa vida", correta: false },
                            { numero: 2, texto: "Riquezas e glória", correta: false },
                            { numero: 3, texto: "Coração entendido (sabedoria) para julgar o povo", correta: true },
                            { numero: 4, texto: "A morte de seus inimigos", correta: false }
                        ],
                        explicacao: "1 Reis 3:9 - A teu servo, pois, dá um coração entendido para julgar a teu povo...",
                        pontosGanhos: 20
                    },
                    {
                        texto: "Como Salomão resolveu a disputa entre as duas mulheres pelo bebê?",
                        opcoes: [
                            { numero: 1, texto: "Mandou prender as duas", correta: false },
                            { numero: 2, texto: "Mandou dividir a criança ao meio com uma espada", correta: true },
                            { numero: 3, texto: "Sorteou quem ficaria com o filho", correta: false },
                            { numero: 4, texto: "Deu o bebê para uma terceira mulher", correta: false }
                        ],
                        explicacao: "1 Reis 3:24-25 - E disse o rei: Trazei-me uma espada... Dividi em duas partes o menino vivo.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "Como o povo reagiu ao julgamento de Salomão?",
                        opcoes: [
                            { numero: 1, texto: "Ficaram com raiva", correta: false },
                            { numero: 2, texto: "Ignoraram o rei", correta: false },
                            { numero: 3, texto: "Pediram um novo rei", correta: false },
                            { numero: 4, texto: "Tiveram temor, pois viram que havia nele a sabedoria de Deus", correta: true }
                        ],
                        explicacao: "1 Reis 3:28 - ...temeram ao rei, porque viram que havia nele a sabedoria de Deus, para fazer justiça.",
                        pontosGanhos: 20
                    }
                ]);
            }
        ...
        4: {
            titulo: "A Prosperidade de Salomão",
            texto: ` ¹ Assim foi Salomão rei sobre todo o Israel.
...
`,
            get pergunta() {
                return sortear([
                    {
                        texto: "Qual era a extensão do domínio de Salomão?",
                        opcoes: [
                            { numero: 1, texto: "Desde o rio Eufrates até à terra dos filisteus e ao Egito", correta: true },
                            { numero: 2, texto: "Apenas a cidade de Jerusalém", correta: false },
                            { numero: 3, texto: "Toda a Europa", correta: false },
                            { numero: 4, texto: "Somente o deserto", correta: false }
                        ],
                        explicacao: "1 Reis 4:21 - E dominava Salomão sobre todos os reinos desde o rio até à terra dos filisteus, e até ao termo do Egito.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "Quantos provérbios e cânticos Salomão compôs?",
                        opcoes: [
                            { numero: 1, texto: "100 provérbios e 50 cânticos", correta: false },
                            { numero: 2, texto: "3.000 provérbios e 1.005 cânticos", correta: true },
                            { numero: 3, texto: "500 provérbios e 100 cânticos", correta: false },
                            { numero: 4, texto: "1.000 provérbios e 1.000 cânticos", correta: false }
                        ],
                        explicacao: "1 Reis 4:32 - E disse três mil provérbios, e foram os seus cânticos mil e cinco.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "De onde vinham pessoas para ouvir a sabedoria de Salomão?",
                        opcoes: [
                            { numero: 1, texto: "Apenas das aldeias vizinhas", correta: false },
                            { numero: 2, texto: "De nenhum lugar", correta: false },
                            { numero: 3, texto: "Somente do deserto", correta: false },
                            { numero: 4, texto: "De todos os povos e de todos os reis da terra", correta: true }
                        ],
                        explicacao: "1 Reis 4:34 - E vinham de todos os povos a ouvir a sabedoria de Salomão...",
                        pontosGanhos: 20
                    }
                ]);
            }
        ...
        5: {
            ...
            texto: `¹ E enviou Hirão, rei de Tiro, os seus servos a Salomão (porque ouvira que ungiram a Salomão rei em lugar de seu pai), porquanto Hirão sempre tinha amado a Davi.
...
⁸ E enviou Hirão a Salomão, dizendo: Ouvi o que me mandaste dizer. Eu farei toda a tua vontade acerca da madeira de cedro e da madeira de cipreste.
...
¹⁸ E as lavraram os edificadores de Salomão, e os edificadores de Hirão, e os giblitas; e preparavam a madeira e as pedras para edificar a casa.

 `,
            get pergunta() {
                return sortear([
                    {
                        texto: "Quem era o rei de Tiro que enviou servos a Salomão?",
                        opcoes: [
                            { numero: 1, texto: "Hirão", correta: true },
                            { numero: 2, texto: "Nabucodonosor", correta: false },
                            { numero: 3, texto: "Faraó", correta: false },
                            { numero: 4, texto: "Ciro", correta: false }
                        ],
                        explicacao: "1 Reis 5:1 - E enviou Hirão, rei de Tiro, os seus servos a Salomão...",
                        pontosGanhos: 20
                    },
                    {
                        texto: "Que tipo de madeira Salomão pediu a Hirão para a construção do Templo?",
                        opcoes: [
                            { numero: 1, texto: "Madeira de Gofer", correta: false },
                            { numero: 2, texto: "Cedros do Líbano", correta: true },
                            { numero: 3, texto: "Carvalho de Basã", correta: false },
                            { numero: 4, texto: "Oliveiras bravas", correta: false }
                        ],
                        explicacao: "1 Reis 5:6 - Dá ordem, pois, agora, que do Líbano me cortem cedros...",
                        pontosGanhos: 20
                    },
                    {
                        texto: "Como Salomão pagava a Hirão pelo suprimento de madeira e trigo?",
                        opcoes: [
                            { numero: 1, texto: "Com ouro e prata", correta: false },
                            { numero: 2, texto: "Com escravos", correta: false },
                            { numero: 3, texto: "Com trigo e azeite batido", correta: true },
                            { numero: 4, texto: "Não pagava, era presente", correta: false }
                        ],
                        explicacao: "1 Reis 5:11 - E Salomão deu a Hirão vinte mil coros de trigo... e vinte coros de azeite batido.",
                        pontosGanhos: 20
                    }
                ]);
            }
        ...
        6: {
            titulo: "A Construção do Templo",
            texto: ` ¹ E sucedeu que no ano de quatrocentos e oitenta, depois de saírem os filhos de Israel do Egito, no ano quarto do reinado de Salomão sobre Israel, no mês de Zive (este é o mês segundo), começou a edificar a casa do Senhor.
...
³⁸ E no ano undécimo, no mês de Bul, que é o mês oitavo, se acabou esta casa com todas as suas coisas, e com tudo o que lhe convinha; e a edificou em sete anos.`,
            get pergunta() {
                return sortear([
                    {
                        texto: "Quanto tempo depois da saída do Egito Salomão começou a edificar a casa do Senhor?",
                        opcoes: [
                            { numero: 1, texto: "100 anos", correta: false },
                            { numero: 2, texto: "480 anos", correta: true },
                            { numero: 3, texto: "250 anos", correta: false },
                            { numero: 4, texto: "400 anos", correta: false }
                        ],
                        explicacao: "1 Reis 6:1 - E sucedeu que, no ano de quatrocentos e oitenta, depois de saírem os filhos de Israel do Egito...",
                        pontosGanhos: 20
                    },
                    {
                        texto: "O que não se ouviu na casa enquanto se edificava?",
                        opcoes: [
                            { numero: 1, texto: "O som de vozes", correta: false },
                            { numero: 2, texto: "Música de harpas", correta: false },
                            { numero: 3, texto: "Nem martelo, nem machado, nem nenhum instrumento de ferro", correta: true },
                            { numero: 4, texto: "O barulho de animais", correta: false }
                        ],
                        explicacao: "1 Reis 6:7 - ...nem martelo, nem machado, nem nenhum instrumento de ferro se ouviu na casa quando a edificavam.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "De que madeira foram feitos os dois querubins no oráculo?",
                        opcoes: [
                            { numero: 1, texto: "De cedro", correta: false },
                            { numero: 2, texto: "De carvalho", correta: false },
                            { numero: 3, texto: "De ébano", correta: false },
                            { numero: 4, texto: "De madeira de oliveira", correta: true }
                        ],
                        explicacao: "1 Reis 6:23 - E no oráculo fez dois querubins de madeira de oliveira, cada um da altura de dez côvados.",
                        pontosGanhos: 20
                    }
                ]);
            }
        ...
        7: {
            titulo: "O Palácio e os Utensílios de Bronze",
            texto: ` ¹ Porém a sua casa edificou Salomão em treze anos; e acabou toda a sua casa.
...
¹² E no grande pátio ao redor havia três ordens de pedras lavradas, com uma ordem de vigas de cedro; assim era também o pátio interior da casa do Senhor e o pórtico daquela casa.
...
³⁹ E pôs cinco bases do lado direito da casa, e cinco do lado esquerdo da casa; porém o mar pôs ao lado direito da casa para o lado do oriente, da parte do sul.
...
⁴⁹ E os castiçais, cinco à direita e cinco à esquerda, diante do oráculo, de ouro finíssimo; e as flores, e as lâmpadas, e as tenazes, também de ouro.
...
⁵¹ Assim se acabou toda a obra que fez o rei Salomão para a casa do Senhor; então trouxe Salomão as coisas que seu pai Davi havia consagrado; a prata, e o ouro, e os objetos pôs entre os tesouros da casa do Senhor.`,
            get pergunta() {
                return sortear([
                    {
                        texto: "Quanto tempo Salomão levou para edificar a sua própria casa (palácio)?",
                        opcoes: [
                            { numero: 1, texto: "Sete anos", correta: false },
                            { numero: 2, texto: "Treze anos", correta: true },
                            { numero: 3, texto: "Dez anos", correta: false },
                            { numero: 4, texto: "Vinte anos", correta: false }
                        ],
                        explicacao: "1 Reis 7:1 - E a sua casa edificou Salomão em treze anos, e acabou toda a sua casa.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "Quais eram os nomes das duas colunas de bronze postas no pórtico do templo?",
                        opcoes: [
                            { numero: 1, texto: "Elias e Eliseu", correta: false },
                            { numero: 2, texto: "Davi e Salomão", correta: false },
                            { numero: 3, texto: "Jaquim e Boaz", correta: true },
                            { numero: 4, texto: "Alfa e Ômega", correta: false }
                        ],
                        explicacao: "1 Reis 7:21 - ...e chamou o nome da direita Jaquim, e o nome da esquerda chamou Boaz.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "O 'mar de fundição' (grande pia) era feito de que material?",
                        opcoes: [
                            { numero: 1, texto: "Ouro puro", correta: false },
                            { numero: 2, texto: "Prata da Arábia", correta: false },
                            { numero: 3, texto: "Pedra esculpida", correta: false },
                            { numero: 4, texto: "Bronze", correta: true }
                        ],
                        explicacao: "1 Reis 7:23 - Fez mais o mar de fundição, de dez côvados de uma borda à outra...",
                        pontosGanhos: 20
                    }
                ]);
            }
        ...
        8: {
            ...
            texto: `¹ Então congregou Salomão os anciãos de Israel, e todos os cabeças das tribos, os chefes dos pais dos filhos de Israel, diante de si em Jerusalém; para fazerem subir a arca da aliança do Senhor da cidade de Davi, que é Sião.
...
²³ E disse: Ó Senhor Deus de Israel, não há Deus como tu, em cima nos céus nem embaixo na terra; que guardas a aliança e a beneficência a teus servos que andam com todo o seu coração diante de ti.
...
⁴⁷ E na terra aonde forem levados em cativeiro caírem em si, e se converterem, e na terra do seu cativeiro te suplicarem, dizendo: Pecamos, e perversamente procedemos, e cometemos iniquidade,
...
⁶⁶ E no oitavo dia despediu o povo, e eles abençoaram o rei; então se foram às suas tendas, alegres e felizes de coração, por causa de todo o bem que o Senhor fizera a Davi seu servo, e a Israel seu povo. `,
            get pergunta() {
                return sortear([
                    {
                        texto: "O que os sacerdotes trouxeram para o Lugar Santíssimo?",
                        opcoes: [
                            { numero: 1, texto: "A arca da aliança do Senhor", correta: true },
                            { numero: 2, texto: "O cajado de Moisés", correta: false },
                            { numero: 3, texto: "As roupas de Davi", correta: false },
                            { numero: 4, texto: "A espada de Golias", correta: false }
                        ],
                        explicacao: "1 Reis 8:6 - Assim trouxeram os sacerdotes a arca da aliança do Senhor ao seu lugar...",
                        pontosGanhos: 20
                    },
                    {
                        texto: "O que havia dentro da arca quando foi colocada no Templo?",
                        opcoes: [
                            { numero: 1, texto: "O pote de maná e a vara de Arão", correta: false },
                            { numero: 2, texto: "Apenas as duas tábuas de pedra que Moisés ali pusera", correta: true },
                            { numero: 3, texto: "Um rolo da lei", correta: false },
                            { numero: 4, texto: "Ouro e incenso", correta: false }
                        ],
                        explicacao: "1 Reis 8:9 - Na arca nada havia, senão as duas tábuas de pedra, que Moisés ali pusera em Horebe.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "O que encheu a casa do Senhor de modo que os sacerdotes não podiam parar para ministrar?",
                        opcoes: [
                            { numero: 1, texto: "Uma chuva forte", correta: false },
                            { numero: 2, texto: "Uma multidão de anjos", correta: false },
                            { numero: 3, texto: "Um perfume suave", correta: false },
                            { numero: 4, texto: "Uma nuvem (a glória do Senhor)", correta: true }
                        ],
                        explicacao: "1 Reis 8:10-11 - ...uma nuvem encheu a casa do Senhor... porque a glória do Senhor enchera a casa do Senhor.",
                        pontosGanhos: 20
                    }
                ]);
            }
        ...
        9: {
            titulo: "Deus Aparece a Salomão pela Segunda Vez",
            texto: `¹ Sucedeu, pois, que, acabando Salomão de edificar a casa do Senhor, e a casa do rei, e todo o desejo de Salomão, que lhe veio à vontade fazer,
...
²⁸ E vieram a Ofir, e tomaram de lá quatrocentos e vinte talentos de ouro, e os trouxeram ao rei Salomão. `,
            get pergunta() {
                return sortear([
                    {
                        texto: "Qual foi a condição de Deus para que o trono de Salomão fosse confirmado para sempre?",
                        opcoes: [
                            { numero: 1, texto: "Que ele construísse mais palácios", correta: false },
                            { numero: 2, texto: "Andar diante de Deus em integridade e retidão", correta: true },
                            { numero: 3, texto: "Aumentar os impostos do povo", correta: false },
                            { numero: 4, texto: "Fazer alianças com todos os reis", correta: false }
                        ],
                        explicacao: "1 Reis 9:4 - E se tu andares diante de mim como andou Davi, teu pai, em inteireza de coração e em equidade...",
                        pontosGanhos: 20
                    },
                    {
                        texto: "O que aconteceria com o Templo se Israel se desviasse para outros deuses?",
                        opcoes: [
                            { numero: 1, texto: "Ele seria pintado de outra cor", correta: false },
                            { numero: 2, texto: "Seria fechado para reformas", correta: false },
                            { numero: 3, texto: "Deus o lançaria fora da sua presença e seria objeto de escárnio", correta: true },
                            { numero: 4, texto: "Os anjos o protegeriam mesmo assim", correta: false }
                        ],
                        explicacao: "1 Reis 9:7-8 - ...e a esta casa, que santifiquei a meu nome, lançarei longe da minha presença...",
                        pontosGanhos: 20
                    },
                    {
                        texto: "Quantas cidades Salomão deu a Hirão, as quais ele chamou de 'Cabul'?",
                        opcoes: [
                            { numero: 1, texto: "Cinco", correta: false },
                            { numero: 2, texto: "Dez", correta: false },
                            { numero: 3, texto: "Cinquenta", correta: false },
                            { numero: 4, texto: "Vinte", correta: true }
                        ],
                        explicacao: "1 Reis 9:11-13 - ...deu o rei Salomão a Hirão vinte cidades na terra de Galiléia... e chamaram-nas terra de Cabul.",
                        pontosGanhos: 20
                    }
                ]);
            }
        ...
        10: {
            titulo: "A Rainha de Sabá",
            texto: ` ¹ E ouvindo a rainha de Sabá a fama de Salomão, acerca do nome do Senhor, veio prová-lo com questões difíceis.
...
¹³ E o rei Salomão deu à rainha de Sabá tudo o que ela desejou, tudo quanto pediu, além do que Salomão dera por sua generosidade real; então ela voltou e partiu para a sua terra, ela e os seus servos.
...
²⁹ E subia e saía um carro do Egito por seiscentos siclos de prata, e um cavalo por cento e cinquenta; e assim, por meio deles, eram exportados para todos os reis dos heteus e para os reis da Síria.`,
            get pergunta() {
                return sortear([
                    {
                        texto: "Por que a rainha de Sabá foi visitar Salomão?",
                        opcoes: [
                            { numero: 1, texto: "Para declarar guerra", correta: false },
                            { numero: 2, texto: "Para prová-lo com perguntas difíceis", correta: true },
                            { numero: 3, texto: "Para pedir dinheiro emprestado", correta: false },
                            { numero: 4, texto: "Para vender especiarias", correta: false }
                        ],
                        explicacao: "1 Reis 10:1 - E ouvindo a rainha de Sabá a fama de Salomão... veio prová-lo com perguntas difíceis.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "O que a rainha disse sobre o que ouviu em sua terra comparado ao que viu pessoalmente?",
                        opcoes: [
                            { numero: 1, texto: "Que era tudo mentira", correta: false },
                            { numero: 2, texto: "Que a fama era maior que a realidade", correta: false },
                            { numero: 3, texto: "Não me contaram a metade", correta: true },
                            { numero: 4, texto: "Que seu reino era melhor", correta: false }
                        ],
                        explicacao: "1 Reis 10:7 - ...eis que não me contaram a metade; sobrepujaste em sabedoria e bens a fama que ouvi.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "De que material era feito o grande trono de Salomão?",
                        opcoes: [
                            { numero: 1, texto: "Pura prata", correta: false },
                            { numero: 2, texto: "Madeira de acácia", correta: false },
                            { numero: 3, texto: "Ferro forjado", correta: false },
                            { numero: 4, texto: "Marfim coberto de ouro puro", correta: true }
                        ],
                        explicacao: "1 Reis 10:18 - Fez mais o rei um grande trono de marfim, e o cobriu de ouro puríssimo.",
                        pontosGanhos: 20
                    }
                ]);
            }
        ...
        11: {
            titulo: "A Queda de Salomão",
            texto: `¹ E o rei Salomão amou muitas mulheres estrangeiras, além da filha de Faraó: moabitas, amonitas, edomitas, sidônias e heteias,
...
⁶ Assim fez Salomão o que parecia mau aos olhos do Senhor; e não perseverou em seguir ao Senhor, como Davi, seu pai.
...
³³ Porque me deixaram, e adoraram Astarote, deusa dos sidônios, a Quemós, deus dos moabitas, e a Milcom, deus dos filhos de Amom; e não andaram pelos meus caminhos, para fazerem o que é reto aos meus olhos, a saber, os meus estatutos e os meus juízos, como Davi, seu pai.
...
⁴³ E adormeceu Salomão com seus pais, e foi sepultado na cidade de Davi, seu pai; e Roboão, seu filho, reinou em seu lugar.
 `,
            get pergunta() {
                return sortear([
                    {
                        texto: "O que fez o coração de Salomão se desviar do Senhor?",
                        opcoes: [
                            { numero: 1, texto: "O excesso de trabalho", correta: false },
                            { numero: 2, texto: "Suas muitas mulheres estrangeiras", correta: true },
                            { numero: 3, texto: "A falta de profetas", correta: false },
                            { numero: 4, texto: "As viagens constantes", correta: false }
                        ],
                        explicacao: "1 Reis 11:4 - Porque sucedeu que, no tempo da velhice de Salomão, suas mulheres lhe perverteram o coração...",
                        pontosGanhos: 20
                    },
                    {
                        texto: "Quantas tribos Deus prometeu dar a Jeroboão através do profeta Aias?",
                        opcoes: [
                            { numero: 1, texto: "Duas tribos", correta: false },
                            { numero: 2, texto: "Todas as doze", correta: false },
                            { numero: 3, texto: "Dez tribos", correta: true },
                            { numero: 4, texto: "Cinco tribos", correta: false }
                        ],
                        explicacao: "1 Reis 11:31 - ...Toma para ti os dez pedaços, porque assim diz o Senhor... das mãos de Salomão rasgarei o reino, e a ti darei dez tribos.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "Quanto tempo Salomão reinou em Jerusalém sobre todo o Israel?",
                        opcoes: [
                            { numero: 1, texto: "Vinte anos", correta: false },
                            { numero: 2, texto: "Trinta anos", correta: false },
                            { numero: 3, texto: "Sessenta anos", correta: false },
                            { numero: 4, texto: "Quarenta anos", correta: true }
                        ],
                        explicacao: "1 Reis 11:42 - E os dias que Salomão reinou em Jerusalém sobre todo o Israel foram quarenta anos.",
                        pontosGanhos: 20
                    }
                ]);
            }
        ...
        12: {
            titulo: "A Divisão do Reino",
            texto: `¹ E foi Roboão para Siquém; porque todo o Israel se reuniu em Siquém, para o fazerem rei.
² Sucedeu que, Jeroboão, filho de Nebate, achando-se ainda no Egito, para onde fugira de diante do rei Salomão, e Jeroboão habitava no Egito,
³ E mandaram chamá-lo; veio, pois, Jeroboão e toda a congregação de Israel, e falaram a Roboão, dizendo:
...
³³ E sacrificou no altar que fizera em Betel, no dia décimo quinto do oitavo mês, que ele tinha imaginado no seu coração; assim fez a festa aos filhos de Israel, e sacrificou no altar, queimando incenso. `,
            get pergunta() {
                return sortear([
                    {
                        texto: "Qual conselho Roboão seguiu: o dos anciãos ou o dos jovens?",
                        opcoes: [
                            { numero: 1, texto: "O conselho dos anciãos", correta: false },
                            { numero: 2, texto: "O conselho dos jovens que cresceram com ele", correta: true },
                            { numero: 3, texto: "O conselho de sua mãe", correta: false },
                            { numero: 4, texto: "O conselho dos profetas", correta: false }
                        ],
                        explicacao: "1 Reis 12:8 - Mas ele deixou o conselho que os anciãos lhe tinham dado, e tomou conselho com os jovens...",
                        pontosGanhos: 20
                    },
                    {
                        texto: "Onde Jeroboão colocou os dois bezerros de ouro para o povo adorar?",
                        opcoes: [
                            { numero: 1, texto: "Em Jerusalém e Belém", correta: false },
                            { numero: 2, texto: "Em Betel e em Dã", correta: true },
                            { numero: 3, texto: "No deserto do Sinai", correta: false },
                            { numero: 4, texto: "No alto dos montes", correta: false }
                        ],
                        explicacao: "1 Reis 12:29 - E pôs um em Betel, e colocou o outro em Dã.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "Qual foi a resposta de Roboão ao povo que pedia alívio nos impostos?",
                        opcoes: [
                            { numero: 1, texto: "Que os perdoaria", correta: false },
                            { numero: 2, texto: "Que manteria tudo igual", correta: false },
                            { numero: 3, texto: "Que daria mais terras", correta: false },
                            { numero: 4, texto: "Meu pai vos castigou com açoites, eu vos castigarei com escorpiões", correta: true }
                        ],
                        explicacao: "1 Reis 12:14 - ...Meu pai vos carregou de um jugo pesado, porém eu ainda acrescentarei ao vosso jugo...",
                        pontosGanhos: 20
                    }
                ]);
            }
        ...
        13: {
            titulo: "O Profeta de Judá",
            texto: `¹ E eis que, por ordem do Senhor, veio, de Judá a Betel, um homem de Deus; e Jeroboão estava junto ao altar, para queimar incenso.
...
³⁴ E isso foi causa de pecado à casa de Jeroboão, para destruí-la e extingui-la da face da terra. `,
            get pergunta() {
                return sortear([
                    {
                        texto: "O que aconteceu com a mão do rei Jeroboão quando ele apontou contra o homem de Deus?",
                        opcoes: [
                            { numero: 1, texto: "Ficou curada", correta: false },
                            { numero: 2, texto: "Secou-se, e não a podia tornar a recolher", correta: true },
                            { numero: 3, texto: "Caiu ao chão", correta: false },
                            { numero: 4, texto: "Tornou-se de ouro", correta: false }
                        ],
                        explicacao: "1 Reis 13:4 - ...a sua mão, que estendera contra ele, se secou, e não a podia tornar a recolher a si.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "O que aconteceu com o homem de Deus por ter desobedecido e comido pão no caminho?",
                        opcoes: [
                            { numero: 1, texto: "Foi preso pelo rei", correta: false },
                            { numero: 2, texto: "Um leão o encontrou no caminho e o matou", correta: true },
                            { numero: 3, texto: "Ficou doente por muitos dias", correta: false },
                            { numero: 4, texto: "Voltou em paz para Judá", correta: false }
                        ],
                        explicacao: "1 Reis 13:24 - Foi-se, pois, e um leão o encontrou no caminho, e o matou...",
                        pontosGanhos: 20
                    },
                    {
                        texto: "O leão comeu o corpo do profeta ou o jumento?",
                        opcoes: [
                            { numero: 1, texto: "Comeu apenas o jumento", correta: false },
                            { numero: 2, texto: "Comeu o profeta e o jumento", correta: false },
                            { numero: 3, texto: "Não comeu nem o corpo nem o jumento", correta: true },
                            { numero: 4, texto: "Levou o corpo para a caverna", correta: false }
                        ],
                        explicacao: "1 Reis 13:28 - ...e o leão não tinha comido o corpo, nem despedaçado o jumento.",
                        pontosGanhos: 20
                    }
                ]);
            }
        ...
        14: {
            titulo: "O Juízo sobre Jeroboão",
            texto: `¹ Naquele tempo adoeceu Abias, filho de Jeroboão.
...
³¹ E Roboão dormiu com seus pais, e foi sepultado com seus pais na cidade de Davi; e era o nome de sua mãe Naamá, amonita; e Abias, seu filho, reinou em seu lugar. `,
            get pergunta() {
                return sortear([
                    {
                        texto: "Quem se disfarçou para consultar o profeta Aias sobre a doença de seu filho?",
                        opcoes: [
                            { numero: 1, texto: "A mulher de Jeroboão", correta: true },
                            { numero: 2, texto: "O próprio rei", correta: false },
                            { numero: 3, texto: "Um servo fiel", correta: false },
                            { numero: 4, texto: "Uma rainha estrangeira", correta: false }
                        ],
                        explicacao: "1 Reis 14:2 - E disse Jeroboão à sua mulher: Levanta-te agora, e disfarça-te... e vai a Siló; eis que lá está o profeta Aias.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "Qual rei do Egito subiu contra Jerusalém no tempo de Roboão?",
                        opcoes: [
                            { numero: 1, texto: "Ramsés", correta: false },
                            { numero: 2, texto: "Senaqueribe", correta: false },
                            { numero: 3, texto: "Sisaque", correta: true },
                            { numero: 4, texto: "Tutancâmon", correta: false }
                        ],
                        explicacao: "1 Reis 14:25 - Sucedeu, pois, no quinto ano do rei Roboão, que Sisaque, rei do Egito, subiu contra Jerusalém.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "O que Sisaque levou do Templo do Senhor?",
                        opcoes: [
                            { numero: 1, texto: "Apenas as roupas dos sacerdotes", correta: false },
                            { numero: 2, texto: "Os rolos da lei", correta: false },
                            { numero: 3, texto: "As colunas de bronze", correta: false },
                            { numero: 4, texto: "Os tesouros da casa do Senhor e os escudos de ouro", correta: true }
                        ],
                        explicacao: "1 Reis 14:26 - E tomou os tesouros da casa do Senhor... e também tomou todos os escudos de ouro que Salomão fizera.",
                        pontosGanhos: 20
                    }
                ]);
            }
        ...
        15: {
            titulo: "Abiam, Asa e Nadabe",
            texto: ` ¹ E no décimo oitavo ano do rei Jeroboão, filho de Nebate, Abias começou a reinar sobre Judá.
...
³⁴ E fez o que era mau aos olhos do Senhor; e andou no caminho de Jeroboão, e no pecado com que ele tinha feito Israel pecar.`,
            get pergunta() {
                return sortear([
                    {
                        texto: "Qual rei de Judá fez o que era reto aos olhos do Senhor, como seu pai Davi?",
                        opcoes: [
                            { numero: 1, texto: "Abiam", correta: false },
                            { numero: 2, texto: "Asa", correta: true },
                            { numero: 3, texto: "Jeroboão", correta: false },
                            { numero: 4, texto: "Baasa", correta: false }
                        ],
                        explicacao: "1 Reis 15:11 - E Asa fez o que era reto aos olhos do Senhor, como Davi seu pai.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "O que Asa fez com os ídolos que seus pais tinham feito?",
                        opcoes: [
                            { numero: 1, texto: "Guardou-os no museu", correta: false },
                            { numero: 2, texto: "Os tirou e destruiu", correta: true },
                            { numero: 3, texto: "Mudou-os de lugar", correta: false },
                            { numero: 4, texto: "Pediu para o povo limpá-los", correta: false }
                        ],
                        explicacao: "1 Reis 15:12 - Porque tirou da terra os sodomitas, e removeu todos os ídolos que seus pais fizeram.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "Houve guerra entre Asa (Judá) e Baasa (Israel) por quanto tempo?",
                        opcoes: [
                            { numero: 1, texto: "Por apenas um ano", correta: false },
                            { numero: 2, texto: "Por dez anos", correta: false },
                            { numero: 3, texto: "Não houve guerra", correta: false },
                            { numero: 4, texto: "Por todos os seus dias", correta: true }
                        ],
                        explicacao: "1 Reis 15:16 - E houve guerra entre Asa e Baasa, rei de Israel, todos os seus dias.",
                        pontosGanhos: 20
                    }
                ]);
            }
        ...
        16: {
            titulo: "O Reinado de Acabe",
            texto: `¹ Então veio a palavra do Senhor a Jeú, filho de Hanani, contra Baasa, dizendo:
...
³⁴ Em seus dias Hiel, o betelita, edificou a Jericó; em Abirão, seu primogênito, a fundou, e em Segube, seu filho menor, pôs as suas portas; conforme a palavra do Senhor, que falara pelo ministério de Josué, filho de Num.
 `,
            get pergunta() {
                return sortear([
                    {
                        texto: "Quem Acabe tomou por mulher, que o incitou a servir a Baal?",
                        opcoes: [
                            { numero: 1, texto: "Bate-Seba", correta: false },
                            { numero: 2, texto: "Jezabel, filha de Etbaal", correta: true },
                            { numero: 3, texto: "Dalila", correta: false },
                            { numero: 4, texto: "Rute", correta: false }
                        ],
                        explicacao: "1 Reis 16:31 - ...tomou por mulher a Jezabel, filha de Etbaal... e foi e serviu a Baal.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "O que Acabe fez em Samaria para a adoração de Baal?",
                        opcoes: [
                            { numero: 1, texto: "Uma estátua de prata", correta: false },
                            { numero: 2, texto: "Um grande poço", correta: false },
                            { numero: 3, texto: "Um altar e uma casa (templo) para Baal", correta: true },
                            { numero: 4, texto: "Um jardim de flores", correta: false }
                        ],
                        explicacao: "1 Reis 16:32 - E levantou um altar a Baal, na casa de Baal que edificara em Samaria.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "Quem edificou a cidade de Jericó no tempo de Acabe, perdendo seus filhos conforme a profecia?",
                        opcoes: [
                            { numero: 1, texto: "Zimri", correta: false },
                            { numero: 2, texto: "Onri", correta: false },
                            { numero: 3, texto: "Tibni", correta: false },
                            { numero: 4, texto: "Hiel, o betelita", correta: true }
                        ],
                        explicacao: "1 Reis 16:34 - Em seus dias Hiel, o betelita, edificou a Jericó... com a perda de Segube, seu primogênito...",
                        pontosGanhos: 20
                    }
                ]);
            }
        ...
        17: {
            ...
            texto: `¹ Então Elias, o tisbita, dos moradores de Gileade, disse a Acabe: Vive o Senhor Deus de Israel, perante cuja face estou, que nestes anos nem orvalho nem chuva haverá, senão segundo a minha palavra.
...
²⁴ Então a mulher disse a Elias: Nisto conheço agora que tu és homem de Deus, e que a palavra do Senhor na tua boca é verdade.
 ...
 `,
            get pergunta() {
                return sortear([
                    {
                        texto: "Quem alimentou Elias junto ao ribeiro de Querite?",
                        opcoes: [
                            { numero: 1, texto: "Os anjos", correta: false },
                            { numero: 2, texto: "Os corvos, que traziam pão e carne", correta: true },
                            { numero: 3, texto: "Pastores de ovelhas", correta: false },
                            { numero: 4, texto: "Sua própria família", correta: false }
                        ],
                        explicacao: "1 Reis 17:6 - E os corvos lhe traziam pão e carne pela manhã, como também pão e carne à noite...",
                        pontosGanhos: 20
                    },
                    {
                        texto: "O que aconteceu com a farinha e o azeite da viúva de Sarepta?",
                        opcoes: [
                            { numero: 1, texto: "Foram roubados", correta: false },
                            { numero: 2, texto: "Acabaram no primeiro dia", correta: false },
                            { numero: 3, texto: "A farinha da panela não se acabou, e o azeite da botija não faltou", correta: true },
                            { numero: 4, texto: "Tornaram-se amargos", correta: false }
                        ],
                        explicacao: "1 Reis 17:16 - Da panela a farinha se não acabou, e da botija o azeite não faltou; conforme a palavra do Senhor...",
                        pontosGanhos: 20
                    },
                    {
                        texto: "Que milagre Elias realizou na casa da viúva em relação ao filho dela?",
                        opcoes: [
                            { numero: 1, texto: "Curou a sua cegueira", correta: false },
                            { numero: 2, texto: "Ensinou-o a ler", correta: false },
                            { numero: 3, texto: "Deu-lhe sapatos novos", correta: false },
                            { numero: 4, texto: "Clamou ao Senhor e a alma do menino tornou a ele (ressuscitou)", correta: true }
                        ],
                        explicacao: "1 Reis 17:22 - E o Senhor ouviu a voz de Elias; e a alma do menino tornou a entrar nele, e reviveu.",
                        pontosGanhos: 20
                    }
                ]);
            }
        ...
        18: {
            titulo: "O Desafio no Monte Carmelo",
            texto: ` ¹ E sucedeu que, depois de muitos dias, a palavra do Senhor veio a Elias, no terceiro ano, dizendo: Vai, apresenta-te a Acabe; porque darei chuva sobre a terra.
...
⁴⁶ E a mão do Senhor estava sobre Elias, o qual cingiu os lombos, e veio correndo perante Acabe, até à entrada de Jizreel.`,
            get pergunta() {
                return sortear([
                    {
                        texto: "Quem era o mordomo de Acabe que temia muito ao Senhor e escondeu cem profetas?",
                        opcoes: [
                            { numero: 1, texto: "Obadias", correta: true },
                            { numero: 2, texto: "Nabote", correta: false },
                            { numero: 3, texto: "Jeú", correta: false },
                            { numero: 4, texto: "Hazael", correta: false }
                        ],
                        explicacao: "1 Reis 18:3-4 - E Acabe chamou a Obadias... Obadias temia muito ao Senhor... e escondeu cem profetas, de cinquenta em cinquenta.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "Como Deus respondeu ao desafio de Elias contra os profetas de Baal?",
                        opcoes: [
                            { numero: 1, texto: "Com um grande vento", correta: false },
                            { numero: 2, texto: "Com uma chuva de pedras", correta: false },
                            { numero: 3, texto: "Caindo fogo do Senhor, que consumiu o holocausto e a lenha", correta: true },
                            { numero: 4, texto: "Com um terremoto", correta: false }
                        ],
                        explicacao: "1 Reis 18:38 - Então caiu fogo do Senhor, e consumiu o holocausto, e a lenha, e as pedras, e o pó...",
                        pontosGanhos: 20
                    },
                    {
                        texto: "Quantos profetas de Baal foram desafiados por Elias no Carmelo?",
                        opcoes: [
                            { numero: 1, texto: "Cinquenta", correta: false },
                            { numero: 2, texto: "Dois mil", correta: false },
                            { numero: 3, texto: "Sete mil", correta: false },
                            { numero: 4, texto: "Quatrocentos e cinquenta", correta: true }
                        ],
                        explicacao: "1 Reis 18:19 - ...os quatrocentos e cinquenta profetas de Baal...",
                        pontosGanhos: 20
                    }
                ]);
            }
        ...
        19: {
            ...
            texto: ` ¹ E Acabe fez saber a Jezabel tudo quanto Elias havia feito, e como totalmente matara todos os profetas à espada.
...
²¹ Voltou, pois, de o seguir, e tomou a junta de bois, e os matou, e com os aparelhos dos bois cozeu as carnes, e as deu ao povo, e comeram; então se levantou e seguiu a Elias, e o servia.`,
            get pergunta() {
                return sortear([
                    {
                        texto: "Como Deus falou com Elias após o vento, o terremoto e o fogo?",
                        opcoes: [
                            { numero: 1, texto: "Com um trovão forte", correta: false },
                            { numero: 2, texto: "Através de um caturro suave (uma voz mansa e delicada)", correta: true },
                            { numero: 3, texto: "Por meio de um anjo gigante", correta: false },
                            { numero: 4, texto: "Pela escrita na pedra", correta: false }
                        ],
                        explicacao: "1 Reis 19:12 - ...e depois do fogo uma voz mansa e delicada.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "Quem Deus mandou Elias ungir como seu sucessor (profeta em seu lugar)?",
                        opcoes: [
                            { numero: 1, texto: "Jeú", correta: false },
                            { numero: 2, texto: "Hazael", correta: false },
                            { numero: 3, texto: "Eliseu, filho de Safate", correta: true },
                            { numero: 4, texto: "Josafá", correta: false }
                        ],
                        explicacao: "1 Reis 19:16 - ...também ungirás a Eliseu... para ser profeta em teu lugar.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "Quantas pessoas em Israel Deus disse que ainda não haviam dobrado os joelhos a Baal?",
                        opcoes: [
                            { numero: 1, texto: "Apenas Elias", correta: false },
                            { numero: 2, texto: "Setecentas", correta: false },
                            { numero: 3, texto: "Cem", correta: false },
                            { numero: 4, texto: "Sete mil", correta: true }
                        ],
                        explicacao: "1 Reis 19:18 - Também deixei ficar em Israel sete mil: todos os joelhos que se não dobraram a Baal...",
                        pontosGanhos: 20
                    }
                ]);
            }
        ...
        20: {
            titulo: "Guerra contra a Síria",
            texto: ` ¹ E Ben-Hadade, rei da Síria, ajuntou todo o seu exército; e havia com ele trinta e dois reis, e cavalos e carros; e subiu, e cercou a Samaria, e pelejou contra ela.
...
`,
            get pergunta() {
                return sortear([
                    {
                        texto: "Quem era o rei da Síria que sitiou Samaria?",
                        opcoes: [
                            { numero: 1, texto: "Ben-Hadade", correta: true },
                            { numero: 2, texto: "Senaqueribe", correta: false },
                            { numero: 3, texto: "Nabucodonosor", correta: false },
                            { numero: 4, texto: "Ciro", correta: false }
                        ],
                        explicacao: "1 Reis 20:1 - E Ben-Hadade, rei da Síria, ajuntou todo o seu exército...",
                        pontosGanhos: 20
                    },
                    {
                        texto: "Por que os sírios acharam que perderam a primeira batalha?",
                        opcoes: [
                            { numero: 1, texto: "Disseram que o Deus de Israel era Deus dos montes e não das planícies", correta: true },
                            { numero: 2, texto: "Porque estavam com fome", correta: false },
                            { numero: 3, texto: "Porque não tinham cavalos", correta: false },
                            { numero: 4, texto: "Por causa da chuva", correta: false }
                        ],
                        explicacao: "1 Reis 20:23 - ...Seus deuses são deuses dos montes... mas pelejemos contra eles na planície...",
                        pontosGanhos: 20
                    },
                    {
                        texto: "O que aconteceu com Acabe por ter deixado Ben-Hadade ir em paz?",
                        opcoes: [
                            { numero: 1, texto: "Foi recompensado", correta: false },
                            { numero: 2, texto: "Tornou-se o rei mais rico", correta: false },
                            { numero: 3, texto: "Mudou-se para a Síria", correta: false },
                            { numero: 4, texto: "O profeta avisou que sua vida seria entregue pela vida dele", correta: true }
                        ],
                        explicacao: "1 Reis 20:42 - ...assim a tua vida será em lugar da sua vida, e o teu povo em lugar do seu povo.",
                        pontosGanhos: 20
                    }
                ]);
            }
        ...
        21: {
            ...
            texto: ` ¹ E sucedeu depois destas coisas que, Nabote, o jizreelita, tinha uma vinha em Jizreel junto ao palácio de Acabe, rei de Samaria.
...
²⁹ Não viste que Acabe se humilha perante mim? Por isso, porquanto se humilha perante mim, não trarei este mal nos seus dias, mas nos dias de seu filho trarei este mal sobre a sua casa.`,
            get pergunta() {
                return sortear([
                    {
                        texto: "Por que Nabote não quis vender sua vinha para o rei Acabe?",
                        opcoes: [
                            { numero: 1, texto: "Porque o preço era muito baixo", correta: false },
                            { numero: 2, texto: "Porque era a herança de seus pais", correta: true },
                            { numero: 3, texto: "Porque ele não gostava do rei", correta: false },
                            { numero: 4, texto: "Porque a terra estava improdutiva", correta: false }
                        ],
                        explicacao: "1 Reis 21:3 - Porém Nabote disse a Acabe: Guarde-me o Senhor de que eu te dê a herança de meus pais.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "Quem armou um plano falso para matar Nabote e tomar a vinha?",
                        opcoes: [
                            { numero: 1, texto: "O próprio Acabe", correta: false },
                            { numero: 2, texto: "O profeta Elias", correta: false },
                            { numero: 3, texto: "Jezabel", correta: true },
                            { numero: 4, texto: "Os anciãos de Judá", correta: false }
                        ],
                        explicacao: "1 Reis 21:7 - Então Jezabel, sua mulher, lhe disse... eu te darei a vinha de Nabote, o jizreelita.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "Qual foi a profecia de Elias sobre o destino de Jezabel?",
                        opcoes: [
                            { numero: 1, texto: "Que ela morreria de velhice", correta: false },
                            { numero: 2, texto: "Que ela seria rainha de outra terra", correta: false },
                            { numero: 3, texto: "Que ela seria levada cativa", correta: false },
                            { numero: 4, texto: "Que os cães comeriam Jezabel junto ao muro de Jizreel", correta: true }
                        ],
                        explicacao: "1 Reis 21:23 - E também de Jezabel falou o Senhor, dizendo: Os cães comerão Jezabel junto ao muro de Jizreel.",
                        pontosGanhos: 20
                    }
                ]);
            }
        ...
        22: {
            ...
            texto: ` ¹ E estiveram quietos três anos, não havendo guerra entre a Síria e Israel.
...
⁸ Então disse o rei de Israel a Jeosafá: Ainda há um homem por quem podemos consultar ao Senhor; porém eu o odeio, porque nunca profetiza de mim o que é bom, mas só o mau; este é Micaías, filho de Inlá. E disse Jeosafá: Não fale o rei assim.
...
⁵⁴ E serviu a Baal, e adorou-o, e provocou a ira do Senhor Deus de Israel, conforme a tudo quanto fizera seu pai.`,
            get pergunta() {
                return sortear([
                    {
                        texto: "Qual profeta avisou que Acabe morreria na batalha contra os sírios?",
                        opcoes: [
                            { numero: 1, texto: "Micaías, filho de Inlá", correta: true },
                            { numero: 2, texto: "Zedequias", correta: false },
                            { numero: 3, texto: "Samuel", correta: false },
                            { numero: 4, texto: "Natã", correta: false }
                        ],
                        explicacao: "1 Reis 22:17 - Então disse ele: Vi a todo o Israel disperso pelos montes, como ovelhas que não têm pastor...",
                        pontosGanhos: 20
                    },
                    {
                        texto: "Como Acabe foi ferido mortalmente na batalha, apesar de estar disfarçado?",
                        opcoes: [
                            { numero: 1, texto: "Por um golpe de espada direto", correta: false },
                            { numero: 2, texto: "Pela queda do seu cavalo", correta: false },
                            { numero: 3, texto: "Um homem entesou o arco e o feriu por acaso entre as fivelas e a couraça", correta: true },
                            { numero: 4, texto: "Por um raio", correta: false }
                        ],
                        explicacao: "1 Reis 22:34 - Então um homem entesou o arco, e feriu o rei de Israel por entre as fivelas e as couraças...",
                        pontosGanhos: 20
                    },
                    {
                        texto: "O que aconteceu quando lavaram o carro de Acabe no tanque de Samaria?",
                        opcoes: [
                            { numero: 1, texto: "O carro brilhou como novo", correta: false },
                            { numero: 2, texto: "A água secou", correta: false },
                            { numero: 3, texto: "O povo chorou", correta: false },
                            { numero: 4, texto: "Os cães lamberam o seu sangue, conforme a palavra do Senhor", correta: true }
                        ],
                        explicacao: "1 Reis 22:38 - Lavando-se, pois, o carro no tanque de Samaria, os cães lamberam o seu sangue...",
                        pontosGanhos: 20
                    }
                ]);
            }
        }
    } // Fim do objeto capitulos
