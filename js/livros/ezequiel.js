...
export const ezequiel = {
    ...
    autor: "Ezequiel",
   // background: "./imagens/ezequiel_bg.jpg",
    ...
    capitulos: {
        1: {
            titulo: "A Visão da Glória de Deus",
            texto: `¹ E aconteceu no trigésimo ano, no quarto mês, no quinto dia do mês, que estando eu no meio dos cativos, junto ao rio Quebar, se abriram os céus, e eu tive visões de Deus.
...
²⁸ Como o aspecto do arco que aparece na nuvem no dia da chuva, assim era o aspecto do resplendor em redor. Este era o aspecto da semelhança da glória do Senhor; e, vendo isto, caí sobre o meu rosto, e ouvi a voz de quem falava.
 `,
            get pergunta() {
                return sortear([
                    {
                        texto: "Onde Ezequiel estava quando os céus se abriram e ele teve visões de Deus?",
                        opcoes: [
                            { numero: 1, texto: "No templo em Jerusalém", correta: false },
                            { numero: 2, texto: "Junto ao rio Quebar, entre os cativos", correta: true },
                            { numero: 3, texto: "No palácio da Babilônia", correta: false },
                            { numero: 4, texto: "No deserto da Judeia", correta: false }
                        ],
                        explicacao: "Ezequiel 1:1 - ...estando eu no meio dos cativos, junto ao rio Quebar, se abriram os céus, e eu tive visões de Deus.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "Quais eram as quatro faces dos seres viventes na visão de Ezequiel?",
                        opcoes: [
                            { numero: 1, texto: "Homem, Leão, Boi e Águia", correta: true },
                            { numero: 2, texto: "Anjo, Dragão, Cordeiro e Pomba", correta: false },
                            { numero: 3, texto: "Rei, Servo, Profeta e Sacerdote", correta: false },
                            { numero: 4, texto: "Sol, Lua, Estrela e Nuvem", correta: false }
                        ],
                        explicacao: "Ezequiel 1:10 - E a semelhança das suas faces era como a face de homem; e à direita... face de leão, e à esquerda... face de boi; e também face de águia.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "Como era o aspecto das rodas que estavam junto aos seres viventes?",
                        opcoes: [
                            { numero: 1, texto: "Eram rodas duplas e feitas de madeira", correta: false },
                            { numero: 2, texto: "Eram como que uma roda no meio de outra roda", correta: true },
                            { numero: 3, texto: "Eram rodas de fogo que não giravam", correta: false },
                            { numero: 4, texto: "Eram rodas quadradas e fixas", correta: false }
                        ],
                        explicacao: "Ezequiel 1:16 - ...e o seu aspecto, e a sua obra, eram como se fora uma roda no meio de outra roda.",
                        pontosGanhos: 20
                    }
                ]);
            }
        ...
        2: {
            ...
            texto: ` ¹ E disse-me: Filho do homem, põe-te em pé, e falarei contigo.
...
`,
            get pergunta() {
                return sortear([
                    {
                        texto: "Como o Senhor chamou Ezequiel ao falar com ele pela primeira vez?",
                        opcoes: [
                            { numero: 1, texto: "Filho do homem", correta: true },
                            { numero: 2, texto: "Santo Profeta", correta: false },
                            { numero: 3, texto: "Ezequiel, meu servo", correta: false },
                            { numero: 4, texto: "Pastor de Israel", correta: false }
                        ],
                        explicacao: "Ezequiel 2:1 - E disse-me: Filho do homem, põe-te em pé, e falarei contigo.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "A quem o Senhor estava enviando o profeta Ezequiel?",
                        opcoes: [
                            { numero: 1, texto: "Aos egípcios", correta: false },
                            { numero: 2, texto: "Aos filhos de Israel, a uma nação rebelde", correta: true },
                            { numero: 3, texto: "Apenas ao rei da Babilônia", correta: false },
                            { numero: 4, texto: "Aos filisteus", correta: false }
                        ],
                        explicacao: "Ezequiel 2:3 - E disse-me: Filho do homem, eu te envio aos filhos de Israel, às nações rebeldes que se rebelaram contra mim.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "O que Ezequiel viu escrito no rolo que lhe foi estendido?",
                        opcoes: [
                            { numero: 1, texto: "Nomes de pessoas que seriam salvas", correta: false },
                            { numero: 2, texto: "Lamentações, suspiros e ais", correta: true },
                            { numero: 3, texto: "Instruções para construir o templo", correta: false },
                            { numero: 4, texto: "Palavras de bênçãos e prosperidade", correta: false }
                        ],
                        explicacao: "Ezequiel 2:10 - ...e estava escrito nele: Lamentações, e suspiros, e ais.",
                        pontosGanhos: 20
                    }
                ]);
            }
        ...
        3: {
            ...
            texto: ` ¹ Depois me disse: Filho do homem, come o que achares; come este rolo, e vai, fala à casa de Israel.
...
`,
            get pergunta() {
                return sortear([
                    {
                        texto: "Qual foi o sabor do rolo na boca de Ezequiel ao comê-lo?",
                        opcoes: [
                            { numero: 1, texto: "Amargo como o fel", correta: false },
                            { numero: 2, texto: "Doce como o mel", correta: true },
                            { numero: 3, texto: "Sem sabor algum", correta: false },
                            { numero: 4, texto: "Salgado como o mar", correta: false }
                        ],
                        explicacao: "Ezequiel 3:3 - ...e comi-o, e era na minha boca doce como o mel.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "O que Deus faria com o sangue do ímpio se o atalaia não o avisasse?",
                        opcoes: [
                            { numero: 1, texto: "O sangue seria requerido da mão do atalaia", correta: true },
                            { numero: 2, texto: "O sangue seria perdoado", correta: false },
                            { numero: 3, texto: "O atalaia seria recompensado", correta: false },
                            { numero: 4, texto: "Nada aconteceria ao atalaia", correta: false }
                        ],
                        explicacao: "Ezequiel 3:18 - ...aquele ímpio morrerá na sua iniquidade, mas o seu sangue, da tua mão o requererei.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "Onde o Espírito levou Ezequiel para que ele ficasse pasmo por sete dias?",
                        opcoes: [
                            { numero: 1, texto: "Para Jerusalém", correta: false },
                            { numero: 2, texto: "Para Tel-Abibe, junto ao rio Quebar", correta: true },
                            { numero: 3, texto: "Para o palácio de Faraó", correta: false },
                            { numero: 4, texto: "Para o cume de um monte", correta: false }
                        ],
                        explicacao: "Ezequiel 3:15 - E fui a Tel-Abibe... e assentei-me ali sete dias, pasmado no meio deles.",
                        pontosGanhos: 20
                    }
                ]);
            }
        ...
        4: {
            titulo: "O Cerco Simbolizado",
            texto: `¹ Tu, pois, ó filho do homem, toma um tijolo, e pô-lo-ás diante de ti, e grava nele a cidade de Jerusalém.
...
⁵ Porque eu já te tenho fixado os anos da sua iniquidade, conforme o número dos dias, trezentos e noventa dias; e levarás a iniquidade da casa de Israel.
...
¹⁷ Para que lhes falte o pão e a água, e se espantem uns com os outros, e se consumam nas suas iniquidades.
 `,
            get pergunta() {
                return sortear([
                    {
                        texto: "O que Ezequiel deveria desenhar em um tijolo?",
                        opcoes: [
                            { numero: 1, texto: "A cidade de Jerusalém", correta: true },
                            { numero: 2, texto: "O rosto do rei", correta: false },
                            { numero: 3, texto: "Um mapa do deserto", correta: false },
                            { numero: 4, texto: "O Rio Nilo", correta: false }
                        ],
                        explicacao: "Ezequiel 4:1 - Tu, pois, ó filho do homem, toma um tijolo... e esculpe nele a cidade de Jerusalém.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "Por quantos dias ao todo Ezequiel deveria ficar deitado para simbolizar o castigo de Israel e Judá?",
                        opcoes: [
                            { numero: 1, texto: "40 dias apenas", correta: false },
                            { numero: 2, texto: "390 dias de um lado e 40 do outro", correta: true },
                            { numero: 3, texto: "70 dias", correta: false },
                            { numero: 4, texto: "100 dias", correta: false }
                        ],
                        explicacao: "Ezequiel 4:4-6 - ...390 dias levarás a sua iniquidade... e levarás a iniquidade da casa de Judá quarenta dias.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "O que o alimento de Ezequiel, pesado e racionado, simbolizava?",
                        opcoes: [
                            { numero: 1, texto: "A fome que haveria em Jerusalém durante o cerco", correta: true },
                            { numero: 2, texto: "A abundância que viria", correta: false },
                            { numero: 3, texto: "Um jejum espiritual", correta: false },
                            { numero: 4, texto: "A dieta dos sacerdotes", correta: false }
                        ],
                        explicacao: "Ezequiel 4:16 - ...Eis que eu quebrarei o báculo do pão em Jerusalém, e comerão o pão por peso, e com ansiedade.",
                        pontosGanhos: 20
                    }
                ]);
            }
        ...
        5: {
            titulo: "O Julgamento da Navalha",
            texto: `¹ E tu, ó filho do homem, toma uma faca afiada, como navalha de barbeiro, e a farás passar pela tua cabeça e pela tua barba; então tomarás uma balança de peso, e repartirás os cabelos.
...
¹⁷ E enviarei sobre vós a fome, e as feras que te desfilharão; e a peste e o sangue passarão por ti; e trarei a espada sobre ti. Eu, o Senhor, falei.
 `,
            get pergunta() {
                return sortear([
                    {
                        texto: "O que Ezequiel deveria fazer com uma pequena parte dos cabelos que rapou?",
                        opcoes: [
                            { numero: 1, texto: "Queimar tudo no fogo", correta: false },
                            { numero: 2, texto: "Atá-los nas abas de suas vestes", correta: true },
                            { numero: 3, texto: "Lançá-los ao mar", correta: false },
                            { numero: 4, texto: "Enterrá-los no jardim", correta: false }
                        ],
                        explicacao: "Ezequiel 5:3 - E tomarás deles um pequeno número, e os atarás nas abas das tuas vestes.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "O que aconteceria com a terça parte do povo, segundo a profecia do cabelo espalhado ao vento?",
                        opcoes: [
                            { numero: 1, texto: "Seria espalhada por todos os ventos e perseguida pela espada", correta: true },
                            { numero: 2, texto: "Ficaria protegida nos muros", correta: false },
                            { numero: 3, texto: "Voltaria para o Egito", correta: false },
                            { numero: 4, texto: "Morreria de velhice", correta: false }
                        ],
                        explicacao: "Ezequiel 5:12 - ...e uma terça parte espalharei a todos os ventos, e desembainharei a espada atrás deles.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "Por que o Senhor executaria juízos no meio de Jerusalém à vista das nações?",
                        opcoes: [
                            { numero: 1, texto: "Porque ela foi mais rebelde que as nações ao seu redor", correta: true },
                            { numero: 2, texto: "Porque ela era a cidade mais rica", correta: false },
                            { numero: 3, texto: "Porque o rei pediu", correta: false },
                            { numero: 4, texto: "Para mostrar Sua força física", correta: false }
                        ],
                        explicacao: "Ezequiel 5:6-7 - E ela mudou os meus juízos em impiedade, mais do que as nações...",
                        pontosGanhos: 20
                    }
                ]);
            }
        ...
        6: {
            titulo: "Profecia contra os Montes de Israel",
...
`,
            get pergunta() {
                return sortear([
                    {
                        texto: "Contra o que Ezequiel deveria dirigir o rosto e profetizar no capítulo 6?",
                        opcoes: [
                            { numero: 1, texto: "Contra os vales do Egito", correta: false },
                            { numero: 2, texto: "Contra os montes de Israel", correta: true },
                            { numero: 3, texto: "Contra as ilhas do mar", correta: false },
                            { numero: 4, texto: "Contra os muros de Babilônia", correta: false }
                        ],
                        explicacao: "Ezequiel 6:2 - Filho do homem, dirige o teu rosto para os montes de Israel, e profetiza contra eles.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "O que aconteceria com os ídolos e altares de incenso de Israel?",
                        opcoes: [
                            { numero: 1, texto: "Seriam cobertos de prata", correta: false },
                            { numero: 2, texto: "Seriam destruídos e quebrados", correta: true },
                            { numero: 3, texto: "Seriam levados para o templo", correta: false },
                            { numero: 4, texto: "Seriam escondidos em cavernas", correta: false }
                        ],
                        explicacao: "Ezequiel 6:4 - E serão assolados os vossos altares, e quebrados os vossos deuses de ouro (imagens de sol)...",
                        pontosGanhos: 20
                    },
                    {
                        texto: "O que restaria do povo para que se lembrassem do Senhor entre as nações?",
                        opcoes: [
                            { numero: 1, texto: "Um remanescente que escapasse da espada", correta: true },
                            { numero: 2, texto: "Apenas os sacerdotes", correta: false },
                            { numero: 3, texto: "Ninguém restaria", correta: false },
                            { numero: 4, texto: "Apenas as crianças", correta: false }
                        ],
                        explicacao: "Ezequiel 6:8 - No entanto deixarei um remanescente, para que tenhais alguns que escapem da espada entre as nações.",
                        pontosGanhos: 20
                    }
                ]);
            }
        ...
        7: {
            titulo: "O Fim Chegou",
            texto: ` ¹ Depois veio a mim a palavra do Senhor, dizendo:
...
¹³ Porque o que vende não tornará a possuir o que vendeu, ainda que esteja entre os viventes; porque a visão, sobre toda a sua multidão, não tornará para trás, nem ninguém fortalecerá a sua vida com a sua iniquidade.
...
`,
            get pergunta() {
                return sortear([
                    {
                        texto: "Qual anúncio o Senhor faz repetidamente sobre a terra de Israel no capítulo 7?",
                        opcoes: [
                            { numero: 1, texto: "Que a paz duraria para sempre", correta: false },
                            { numero: 2, texto: "O fim vem, o fim chegou sobre os quatro cantos da terra", correta: true },
                            { numero: 3, texto: "Que haveria chuva em abundância", correta: false },
                            { numero: 4, texto: "Que o ouro aumentaria", correta: false }
                        ],
                        explicacao: "Ezequiel 7:2 - ...Assim diz o Senhor Deus à terra de Israel: O fim vem, o fim vem sobre os quatro cantos da terra.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "O que o povo faria com sua prata e ouro, vendo que não podiam livrá-los no dia do furor?",
                        opcoes: [
                            { numero: 1, texto: "Lançariam pelas ruas como imundícia", correta: true },
                            { numero: 2, texto: "Fariam novos ídolos", correta: false },
                            { numero: 3, texto: "Comprariam comida dos inimigos", correta: false },
                            { numero: 4, texto: "Pagariam o seu resgate", correta: false }
                        ],
                        explicacao: "Ezequiel 7:19 - A sua prata lançarão pelas ruas, e o seu ouro será como imundícia...",
                        pontosGanhos: 20
                    },
                    {
                        texto: "Segundo o verso 26, o que o povo buscaria em vão dos profetas, sacerdotes e anciãos?",
                        opcoes: [
                            { numero: 1, texto: "Ouro e prata", correta: false },
                            { numero: 2, texto: "Visão, lei e conselho", correta: true },
                            { numero: 3, texto: "Armas de guerra", correta: false },
                            { numero: 4, texto: "Caminhos de fuga", correta: false }
                        ],
                        explicacao: "Ezequiel 7:26 - ...então buscarão do profeta uma visão, mas do sacerdote perecerá a lei e dos anciãos o conselho.",
                        pontosGanhos: 20
                    }
                ]);
            }
        ...
        8: {
            titulo: "Abominações no Templo",
            texto: ` ¹ Sucedeu, pois, no sexto ano, no sexto mês, no quinto dia do mês, estando eu assentado na minha casa, e os anciãos de Judá assentados diante de mim, que ali a mão do Senhor Deus caiu sobre mim.
...
`,
            get pergunta() {
                return sortear([
                    {
                        texto: "Para onde a mão do Senhor levou Ezequiel em visões?",
                        opcoes: [
                            { numero: 1, texto: "Para o palácio do Egito", correta: false },
                            { numero: 2, texto: "Para Jerusalém, à entrada da porta do pátio interior", correta: true },
                            { numero: 3, texto: "Para as montanhas de Edom", correta: false },
                            { numero: 4, texto: "Para o fundo do Mar Morto", correta: false }
                        ],
                        explicacao: "Ezequiel 8:3 - ...e levou-me a Jerusalém em visões de Deus, até à entrada da porta do pátio interior...",
                        pontosGanhos: 20
                    },
                    {
                        texto: "O que Ezequiel viu pintado na parede em uma câmara escondida?",
                        opcoes: [
                            { numero: 1, texto: "Imagens de anjos", correta: false },
                            { numero: 2, texto: "Toda a forma de répteis e animais abomináveis, e ídolos", correta: true },
                            { numero: 3, texto: "Os Dez Mandamentos", correta: false },
                            { numero: 4, texto: "Um mapa das nações", correta: false }
                        ],
                        explicacao: "Ezequiel 8:10 - ...e eis que toda a forma de répteis, e de animais abomináveis, e todos os ídolos... estavam pintados na parede em todo o redor.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "O que os vinte e cinco homens estavam fazendo entre o pórtico e o altar?",
                        opcoes: [
                            { numero: 1, texto: "Limpando as cinzas", correta: false },
                            { numero: 2, texto: "Adorando o sol, virados para o oriente", correta: true },
                            { numero: 3, texto: "Oferecendo sacrifícios ao Senhor", correta: false },
                            { numero: 4, texto: "Reparando as colunas", correta: false }
                        ],
                        explicacao: "Ezequiel 8:16 - ...estavam cerca de vinte e cinco homens... e adoravam o sol, virados para o oriente.",
                        pontosGanhos: 20
                    }
                ]);
            }
        ...
        9: {
            titulo: "A Marca dos Fiéis",
            texto: `¹ Então me gritou aos ouvidos com grande voz, dizendo: Fazei chegar os intendentes da cidade, cada um com as suas armas destruidoras na mão.
...
¹¹ Eis que o homem que estava vestido de linho, a cuja cintura estava o tinteiro, tornou com a resposta, dizendo: Fiz como me mandaste.
 `,
            get pergunta() {
                return sortear([
                    {
                        texto: "Qual era a missão do homem vestido de linho com um tinteiro de escrivão?",
                        opcoes: [
                            { numero: 1, texto: "Contar os tesouros do templo", correta: false },
                            { numero: 2, texto: "Marcar a testa dos que gemiam pelas abominações", correta: true },
                            { numero: 3, texto: "Escrever uma carta ao rei", correta: false },
                            { numero: 4, texto: "Desenhar o mapa da cidade", correta: false }
                        ],
                        explicacao: "Ezequiel 9:4 - ...põe uma marca nas testas dos homens que suspiram e que gemem por causa de todas as abominações...",
                        pontosGanhos: 20
                    },
                    {
                        texto: "Por onde os executores deveriam começar o julgamento?",
                        opcoes: [
                            { numero: 1, texto: "Pelas portas da cidade", correta: false },
                            { numero: 2, texto: "Pelo santuário de Deus, começando pelos anciãos", correta: true },
                            { numero: 3, texto: "Pelas casas dos camponeses", correta: false },
                            { numero: 4, texto: "Pelas pastagens", correta: false }
                        ],
                        explicacao: "Ezequiel 9:6 - ...começai pelo meu santuário. E começaram pelos homens anciãos que estavam diante da casa.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "O que aconteceu com aqueles que não tinham a marca na testa?",
                        opcoes: [
                            { numero: 1, texto: "Foram levados cativos", correta: false },
                            { numero: 2, texto: "Foram mortos sem compaixão", correta: true },
                            { numero: 3, texto: "Receberam uma segunda chance", correta: false },
                            { numero: 4, texto: "Tornaram-se governadores", correta: false }
                        ],
                        explicacao: "Ezequiel 9:5-6 - ...Passai pela cidade após ele, e feri; não poupe o vosso olho... mas a todo o homem que tiver a marca não vos chegueis.",
                        pontosGanhos: 20
                    }
                ]);
            }
        ...
        10: {
            titulo: "As Rodas e a Glória",
            texto: `¹ Depois olhei, e eis que no firmamento, que estava por cima da cabeça dos querubins, apareceu sobre eles uma como pedra de safira, semelhante a forma de um trono.
...
²² E a semelhança dos seus rostos era a dos rostos que eu tinha visto junto ao rio Quebar, o aspecto deles, e eles mesmos; cada um andava para diante do seu rosto.
 `,
            get pergunta() {
                return sortear([
                    {
                        texto: "O que o homem vestido de linho pegou do meio das rodas dos querubins?",
                        opcoes: [
                            { numero: 1, texto: "Pedras preciosas", correta: false },
                            { numero: 2, texto: "Brasas de fogo", correta: true },
                            { numero: 3, texto: "Água pura", correta: false },
                            { numero: 4, texto: "Uma espada", correta: false }
                        ],
                        explicacao: "Ezequiel 10:2 - ...Enche as tuas mãos de brasas de fogo do meio dos querubins...",
                        pontosGanhos: 20
                    },
                    {
                        texto: "O que estava cheio de olhos em todo o redor na visão de Ezequiel?",
                        opcoes: [
                            { numero: 1, texto: "Os muros do templo", correta: false },
                            { numero: 2, texto: "O corpo, as costas, as mãos, as asas e as rodas", correta: true },
                            { numero: 3, texto: "O chão do santuário", correta: false },
                            { numero: 4, texto: "As nuvens do céu", correta: false }
                        ],
                        explicacao: "Ezequiel 10:12 - E todo o seu corpo, as suas costas, as suas mãos, as suas asas e as rodas... estavam cheios de olhos em redor.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "Para onde a glória do Senhor se moveu após sair da entrada da casa?",
                        opcoes: [
                            { numero: 1, texto: "Para dentro do Santo dos Santos", correta: false },
                            { numero: 2, texto: "Parou sobre os querubins", correta: true },
                            { numero: 3, texto: "Desapareceu instantaneamente", correta: false },
                            { numero: 4, texto: "Foi para o Egito", correta: false }
                        ],
                        explicacao: "Ezequiel 10:18 - Então saiu a glória do Senhor de sobre a entrada da casa, e parou sobre os querubins.",
                        pontosGanhos: 20
                    }
                ]);
            }
        ...
        11: {
            ...
            texto: `¹ Então me levantou o Espírito, e me levou à porta oriental da casa do Senhor, a qual olha para o oriente; e eis que estavam à entrada da porta vinte e cinco homens; e no meio deles vi a Jaazanias, filho de Azur, e a Pelatias, filho de Benaia, príncipes do povo.
...
²⁵ E falei aos do cativeiro todas as coisas que o Senhor me havia mostrado. `,
            get pergunta() {
                return sortear([
                    {
                        texto: "O que aconteceu com Pelatias, filho de Benaia, enquanto Ezequiel profetizava?",
                        opcoes: [
                            { numero: 1, texto: "Ele caiu morto", correta: true },
                            { numero: 2, texto: "Ele se arrependeu", correta: false },
                            { numero: 3, texto: "Ele fugiu para o Egito", correta: false },
                            { numero: 4, texto: "Ele tornou-se mudo", correta: false }
                        ],
                        explicacao: "Ezequiel 11:13 - E aconteceu que, profetizando eu, morreu Pelatias, filho de Benaia.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "Que promessa espiritual Deus faz aos exilados no verso 19?",
                        opcoes: [
                            { numero: 1, texto: "Darei a eles um coração de carne e um espírito novo", correta: true },
                            { numero: 2, texto: "Darei a eles riquezas infinitas", correta: false },
                            { numero: 3, texto: "Farei deles anjos", correta: false },
                            { numero: 4, texto: "Darei a eles um coração de pedra", correta: false }
                        ],
                        explicacao: "Ezequiel 11:19 - E lhes darei um só coração, e porei dentro deles um espírito novo; e tirarei da sua carne o coração de pedra, e lhes darei um coração de carne.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "Para onde se moveu a glória do Senhor ao sair do meio da cidade?",
                        opcoes: [
                            { numero: 1, texto: "Para o monte que está ao oriente da cidade", correta: true },
                            { numero: 2, texto: "Para o fundo do mar", correta: false },
                            { numero: 3, texto: "Para o Egito", correta: false },
                            { numero: 4, texto: "Para o deserto", correta: false }
                        ],
                        explicacao: "Ezequiel 11:23 - E a glória do Senhor se alçou do meio da cidade, e se pôs sobre o monte que está ao oriente da cidade.",
                        pontosGanhos: 20
                    }
                ]);
            }
...
²⁸ Portanto dize-lhes: Assim diz o Senhor Deus: Não será mais adiada nenhuma das minhas palavras; e a palavra que falei se cumprirá, diz o Senhor Deus.
 `,
            get pergunta() {
                return sortear([
                    {
                        texto: "O que Ezequiel deveria preparar à vista do povo como sinal do exílio?",
                        opcoes: [
                            { numero: 1, texto: "Bagagem para mudar de país", correta: true },
                            { numero: 2, texto: "Uma grande festa", correta: false },
                            { numero: 3, texto: "Um altar de sacrifício", correta: false },
                            { numero: 4, texto: "Uma armadura de guerra", correta: false }
                        ],
                        explicacao: "Ezequiel 12:3 - Tu, pois, ó filho do homem, prepara aparelhos para mudar de país, e muda de lugar de dia, à vista deles.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "Como Ezequiel deveria sair de sua casa através da parede?",
                        opcoes: [
                            { numero: 1, texto: "Escavando a parede com a mão", correta: true },
                            { numero: 2, texto: "Derrubando a porta", correta: false },
                            { numero: 3, texto: "Saltando pela janela", correta: false },
                            { numero: 4, texto: "Pelo telhado", correta: false }
                        ],
                        explicacao: "Ezequiel 12:5 - Escava a parede à vista deles, e sai por ali.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "Qual ditado popular em Israel o Senhor disse que faria cessar?",
                        opcoes: [
                            { numero: 1, texto: "Prolongar-se-ão os dias, e perecerá toda a visão", correta: true },
                            { numero: 2, texto: "O sol brilha para todos", correta: false },
                            { numero: 3, texto: "Deus tarda mas não falha", correta: false },
                            { numero: 4, texto: "Onde há fumaça, há fogo", correta: false }
                        ],
                        explicacao: "Ezequiel 12:22-23 - ...Prolongar-se-ão os dias, e perecerá toda a visão? ...Farei cessar este provérbio.",
                        pontosGanhos: 20
                    }
                ]);
            }
...
²³ Portanto não vereis mais vaidade, nem mais fareis adivinhações; mas livrarei o meu povo da vossa mão, e sabereis que eu sou o Senhor.
 `,
            get pergunta() {
                return sortear([
                    {
                        texto: "A que Ezequiel compara os profetas de Israel no verso 4?",
                        opcoes: [
                            { numero: 1, texto: "A raposas nos desertos", correta: true },
                            { numero: 2, texto: "A lobos famintos", correta: false },
                            { numero: 3, texto: "A pombas sem juízo", correta: false },
                            { numero: 4, texto: "A leões velhos", correta: false }
                        ],
                        explicacao: "Ezequiel 13:4 - Os teus profetas, ó Israel, são como raposas nos desertos.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "O que os falsos profetas faziam para enganar o povo sobre a segurança de Jerusalém?",
                        opcoes: [
                            { numero: 1, texto: "Diziam 'Paz', quando não havia paz", correta: true },
                            { numero: 2, texto: "Diziam para fugir", correta: false },
                            { numero: 3, texto: "Pediam mais ofertas", correta: false },
                            { numero: 4, texto: "Diziam para lutar", correta: false }
                        ],
                        explicacao: "Ezequiel 13:10 - ...visto que enganaram o meu povo, dizendo: Paz; e não havia paz.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "O que aconteceria com a parede que foi caiada com argamassa fraca?",
                        opcoes: [
                            { numero: 1, texto: "Cairia sob uma chuva transbordante e grandes pedras de saraiva", correta: true },
                            { numero: 2, texto: "Tornar-se-ia a mais forte do mundo", correta: false },
                            { numero: 3, texto: "Seria pintada de ouro", correta: false },
                            { numero: 4, texto: "Seria movida de lugar", correta: false }
                        ],
                        explicacao: "Ezequiel 13:11 - Dize aos que a caiam com argamassa fraca que ela cairá. Haverá uma chuva transbordante...",
                        pontosGanhos: 20
                    }
                ]);
            }
        ...
        14: {
            titulo: "Idolatria no Coração",
            texto: `¹ E vieram a mim alguns homens dos anciãos de Israel, e se assentaram diante de mim.
² Então veio a mim a palavra do Senhor, dizendo:
...
²³ E sereis consolados, quando virdes o seu caminho e os seus feitos; e sabereis que não fiz sem razão tudo quanto nela tenho feito, diz o Senhor Deus.
 `,
            get pergunta() {
                return sortear([
                    {
                        texto: "Onde os anciãos de Israel haviam assentado seus ídolos, segundo o verso 3?",
                        opcoes: [
                            { numero: 1, texto: "No seu coração", correta: true },
                            { numero: 2, texto: "No meio da rua", correta: false },
                            { numero: 3, texto: "Debaixo das árvores", correta: false },
                            { numero: 4, texto: "Nos telhados", correta: false }
                        ],
                        explicacao: "Ezequiel 14:3 - Filho do homem, estes homens assentaram os seus ídolos no seu coração.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "Quais são os três homens exemplares mencionados que só poderiam livrar suas próprias almas?",
                        opcoes: [
                            { numero: 1, texto: "Noé, Daniel e Jó", correta: true },
                            { numero: 2, texto: "Abraão, Isaque e Jacó", correta: false },
                            { numero: 3, texto: "Moisés, Elias e Samuel", correta: false },
                            { numero: 4, texto: "Davi, Salomão e Josias", correta: false }
                        ],
                        explicacao: "Ezequiel 14:14 - Ainda que estivessem no meio dela estes três homens, Noé, Daniel e Jó, eles, pela sua justiça, livrariam apenas as suas almas.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "Quais são os quatro maus juízos que o Senhor enviaria contra Jerusalém?",
                        opcoes: [
                            { numero: 1, texto: "A espada, a fome, as feras e a peste", correta: true },
                            { numero: 2, texto: "O fogo, o vento, a água e o terremoto", correta: false },
                            { numero: 3, texto: "A cegueira, a surdez, a mudez e a paralisia", correta: false },
                            { numero: 4, texto: "O exílio, a escravidão, a dívida e a vergonha", correta: false }
                        ],
                        explicacao: "Ezequiel 14:21 - ...quanto mais enviando eu contra Jerusalém os meus quatro maus juízos: a espada, a fome, as feras e a peste...",
                        pontosGanhos: 20
                    }
                ]);
            }
        ...
        15: {
            titulo: "A Parábola da Videira Inútil",
            texto: ` ¹ E veio a mim a palavra do Senhor, dizendo:
² Filho do homem, que mais é a árvore da videira do que qualquer outra árvore, ou do que o ramo que está entre as árvores do bosque?
...
⁸ E tornarei a terra em desolação, porquanto grandemente transgrediram, diz o Senhor Deus.`,
            get pergunta() {
                return sortear([
                    {
                        texto: "Para que serve a madeira da videira em comparação com as outras árvores?",
                        opcoes: [
                            { numero: 1, texto: "Para nada, a não ser para o fogo", correta: true },
                            { numero: 2, texto: "Para construir navios", correta: false },
                            { numero: 3, texto: "Para fazer móveis de luxo", correta: false },
                            { numero: 4, texto: "Para fabricar espadas", correta: false }
                        ],
                        explicacao: "Ezequiel 15:2-4 - Que mais é a madeira da videira do que qualquer outra madeira... Eis que é lançado no fogo, para ser consumido.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "Pode-se fazer algum objeto útil com a madeira da videira?",
                        opcoes: [
                            { numero: 1, texto: "Não se pode tirar dela nem uma estaca para pendurar um vaso", correta: true },
                            { numero: 2, texto: "Sim, colheres de pau", correta: false },
                            { numero: 3, texto: "Sim, vigas para casas", correta: false },
                            { numero: 4, texto: "Sim, arados para o campo", correta: false }
                        ],
                        explicacao: "Ezequiel 15:3 - Tomar-se-ia dela madeira para fazer alguma obra? Ou tomar-se-ia dela alguma estaca para nela se pendurar algum vaso?",
                        pontosGanhos: 20
                    }
                ]);
            }
        ...
        16: {
            titulo: "A Parábola da Criança Abandonada",
            texto: ` ¹ E veio a mim outra vez a palavra do Senhor, dizendo:
...
`,
            get pergunta() {
                return sortear([
                    {
                        texto: "Como era a origem e o nascimento de Jerusalém descritos metaforicamente no início do capítulo?",
                        opcoes: [
                            { numero: 1, texto: "Nascida em berço de ouro", correta: false },
                            { numero: 2, texto: "Como uma criança abandonada no campo, sem ter o umbigo cortado nem lavada com água", correta: true },
                            { numero: 3, texto: "Como uma princesa cuidada por muitas amas", correta: false },
                            { numero: 4, texto: "Como uma videira plantada junto às águas", correta: false }
                        ],
                        explicacao: "Ezequiel 16:4-5 - ...no dia em que nasceste não te foi cortado o umbigo, nem foste lavada com água... mas foste lançada no campo.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "O que o Senhor fez por Jerusalém quando ela cresceu e se tornou formosa?",
                        opcoes: [
                            { numero: 1, texto: "Estendeu sobre ela a sua aba, cobriu a sua nudez e fez um pacto com ela", correta: true },
                            { numero: 2, texto: "Deixou-a entregue à própria sorte", correta: false },
                            { numero: 3, texto: "Mandou-a de volta para a terra dos amorreus", correta: false },
                            { numero: 4, texto: "Deu-lhe apenas o básico para sobreviver", correta: false }
                        ],
                        explicacao: "Ezequiel 16:8 - ...estendi sobre ti a minha aba, e cobri a tua nudez; e dei-te juramento, e entrei em pacto contigo.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "Qual foi o pecado de Sodoma, irmã de Jerusalém, segundo o verso 49?",
                        opcoes: [
                            { numero: 1, texto: "Soberba, fartura de pão e abundância de ociosidade, sem ajudar o pobre", correta: true },
                            { numero: 2, texto: "Apenas a falta de templos", correta: false },
                            { numero: 3, texto: "Não ter exércitos fortes", correta: false },
                            { numero: 4, texto: "Ter muitos estrangeiros na cidade", correta: false }
                        ],
                        explicacao: "Ezequiel 16:49 - Eis que esta foi a iniquidade de Sodoma, tua irmã: Soberba, fartura de pão, e abundância de ociosidade... mas nunca fortaleceu a mão do pobre.",
                        pontosGanhos: 20
                    }
                ]);
            }
        ...
        17: {
            titulo: "A Parábola das Duas Águias",
            texto: ` ¹ E veio a mim a palavra do Senhor, dizendo:
...
`,
            get pergunta() {
                return sortear([
                    {
                        texto: "Na parábola das duas águias, o que a primeira grande águia representa?",
                        opcoes: [
                            { numero: 1, texto: "O rei do Egito", correta: false },
                            { numero: 2, texto: "O rei de Babilônia", correta: true },
                            { numero: 3, texto: "O sumo sacerdote", correta: false },
                            { numero: 4, texto: "O profeta Ezequiel", correta: false }
                        ],
                        explicacao: "Ezequiel 17:3,12 - ...Uma grande águia... veio ao Líbano e tomou o topo do cedro. ...Eis que veio o rei de Babilônia a Jerusalém.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "O que aconteceu com a videira que inclinou suas raízes para a segunda águia (Egito)?",
                        opcoes: [
                            { numero: 1, texto: "Seria arrancada e secaria", correta: true },
                            { numero: 2, texto: "Tornar-se-ia a maior videira da terra", correta: false },
                            { numero: 3, texto: "Daria uvas de ouro", correta: false },
                            { numero: 4, texto: "Seria protegida contra todo mal", correta: false }
                        ],
                        explicacao: "Ezequiel 17:9-10 - ...Não será arrancada a sua raiz...? Secar-se-á totalmente.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "O que o Senhor promete plantar no alto monte de Israel no final do capítulo?",
                        opcoes: [
                            { numero: 1, texto: "Um renovo tenro do topo do cedro alto", correta: true },
                            { numero: 2, texto: "Um campo de espinhos", correta: false },
                            { numero: 3, texto: "Uma estátua de ouro", correta: false },
                            { numero: 4, texto: "Uma muralha de fogo", correta: false }
                        ],
                        explicacao: "Ezequiel 17:22-23 - ...do topo do cedro alto... plantá-lo-ei sobre um monte alto e sublime... no monte alto de Israel.",
                        pontosGanhos: 20
                    }
                ]);
            }
...
`,
            get pergunta() {
                return sortear([
                    {
                        texto: "Qual provérbio Deus diz que não seria mais usado em Israel?",
                        opcoes: [
                            { numero: 1, texto: "Os pais comeram uvas verdes, e os dentes dos filhos se embotaram", correta: true },
                            { numero: 2, texto: "Quem tudo quer, tudo perde", correta: false },
                            { numero: 3, texto: "Filho de peixe, peixinho é", correta: false },
                            { numero: 4, texto: "Onde o rei vai, o povo vai atrás", correta: false }
                        ],
                        explicacao: "Ezequiel 18:2-3 - ...Os pais comeram uvas verdes, e os dentes dos filhos se embotaram? ...nunca mais direis este provérbio em Israel.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "Qual é a regra clara de Deus sobre a vida e o pecado no verso 4?",
                        opcoes: [
                            { numero: 1, texto: "A alma que pecar, essa morrerá", correta: true },
                            { numero: 2, texto: "O filho pagará pelo erro do pai", correta: false },
                            { numero: 3, texto: "O sacrifício apaga todo o passado", correta: false },
                            { numero: 4, texto: "A morte é o fim de todos", correta: false }
                        ],
                        explicacao: "Ezequiel 18:4 - Eis que todas as almas são minhas... a alma que pecar, essa morrerá.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "O que acontece se o ímpio se converter de todos os seus pecados?",
                        opcoes: [
                            { numero: 1, texto: "Certamente viverá; não morrerá e suas transgressões não serão lembradas", correta: true },
                            { numero: 2, texto: "Terá que pagar uma multa alta", correta: false },
                            { numero: 3, texto: "Será castigado pelo passado mesmo assim", correta: false },
                            { numero: 4, texto: "Deverá sair da terra de Israel", correta: false }
                        ],
                        explicacao: "Ezequiel 18:21-22 - Mas se o ímpio se converter... certamente viverá, não morrerá. De todas as suas transgressões... não haverá lembrança contra ele.",
                        pontosGanhos: 20
                    }
                ]);
            }
        ...
        19: {
            titulo: "Lamento pelos Príncipes",
            texto: ` 1 E tu levanta uma lamentação sobre os príncipes de Israel,
...
`,
            get pergunta() {
                return sortear([
                    {
                        texto: "A que animal a mãe dos príncipes de Israel é comparada nesta parábola?",
                        opcoes: [
                            { numero: 1, texto: "A uma leoa entre leões", correta: true },
                            { numero: 2, texto: "A uma águia real", correta: false },
                            { numero: 3, texto: "A uma ovelha perdida", correta: false },
                            { numero: 4, texto: "A uma pomba", correta: false }
                        ],
                        explicacao: "Ezequiel 19:2 - ...Que era tua mãe? Uma leoa; entre os leões se deitava.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "O que aconteceu com o primeiro leãozinho que aprendeu a apanhar a presa?",
                        opcoes: [
                            { numero: 1, texto: "Foi levado com ganchos para a terra do Egito", correta: true },
                            { numero: 2, texto: "Tornou-se o rei da floresta", correta: false },
                            { numero: 3, texto: "Morreu em combate", correta: false },
                            { numero: 4, texto: "Fugiu para o deserto", correta: false }
                        ],
                        explicacao: "Ezequiel 19:3-4 - ...e ele aprendeu a apanhar a presa... e foi levado com ganchos para a terra do Egito.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "A que planta a mãe é comparada na segunda parte do lamento?",
                        opcoes: [
                            { numero: 1, texto: "A uma videira plantada junto às águas", correta: true },
                            { numero: 2, texto: "A um espinheiro seco", correta: false },
                            { numero: 3, texto: "A um cedro do Líbano", correta: false },
                            { numero: 4, texto: "A uma figueira sem frutos", correta: false }
                        ],
                        explicacao: "Ezequiel 19:10 - Tua mãe era como uma videira no teu sangue, plantada junto às águas.",
                        pontosGanhos: 20
                    }
                ]);
            }
        ...
        20: {
            titulo: "A História da Rebeldia",
            texto: ` ¹ E aconteceu, no sétimo ano, no quinto mês, aos dez do mês, que vieram alguns dos anciãos de Israel, para consultarem o Senhor; e assentaram-se diante de mim.
² Então veio a mim a palavra do Senhor, dizendo:
...
`,
            get pergunta() {
                return sortear([
                    {
                        texto: "Por amor de que o Senhor não destruiu Israel no deserto, apesar da rebeldia?",
                        opcoes: [
                            { numero: 1, texto: "Por amor do seu nome, para que não fosse profanado diante das nações", correta: true },
                            { numero: 2, texto: "Por causa do ouro que eles tinham", correta: false },
                            { numero: 3, texto: "Porque eles eram muito numerosos", correta: false },
                            { numero: 4, texto: "Por causa da bondade do povo", correta: false }
                        ],
                        explicacao: "Ezequiel 20:9 - O que fiz, porém, foi por amor do meu nome, para que não fosse profanado diante dos olhos das nações.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "O que o Senhor deu ao povo como um sinal entre Ele e eles?",
                        opcoes: [
                            { numero: 1, texto: "Os seus sábados", correta: true },
                            { numero: 2, texto: "Uma arca de ouro", correta: false },
                            { numero: 3, texto: "Uma espada mágica", correta: false },
                            { numero: 4, texto: "Pedras preciosas", correta: false }
                        ],
                        explicacao: "Ezequiel 20:12 - E também lhes dei os meus sábados, para que servissem de sinal entre mim e eles.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "O que o Senhor promete fazer quando congregar a casa de Israel de entre os povos?",
                        opcoes: [
                            { numero: 1, texto: "Ser santificado neles aos olhos das nações", correta: true },
                            { numero: 2, texto: "Destruí-los em segredo", correta: false },
                            { numero: 3, texto: "Torná-los escravos novamente", correta: false },
                            { numero: 4, texto: "Levá-los para uma ilha deserta", correta: false }
                        ],
                        explicacao: "Ezequiel 20:41 - ...quando eu vos tirar de entre os povos... e serei santificado em vós aos olhos das nações.",
                        pontosGanhos: 20
                    }
                ]);
            }
        ...
        21: {
            titulo: "A Espada Afiada do Senhor",
            texto: `¹ E veio a mim a palavra do Senhor, dizendo:
...
³² Ao fogo servirás para ser consumido; o teu sangue estará no meio da terra; já não serás mais lembrado, porque eu, o Senhor, o disse.
 ...
 `,
            get pergunta() {
                return sortear([
                    {
                        texto: "O que o Senhor ordena que Ezequiel faça em direção ao meio-dia e às florestas do sul?",
                        opcoes: [
                            { numero: 1, texto: "Que plante árvores frutíferas", correta: false },
                            { numero: 2, texto: "Que profetize contra o bosque do campo do sul", correta: true },
                            { numero: 3, texto: "Que busque água no deserto", correta: false },
                            { numero: 4, texto: "Que construa uma cidade", correta: false }
                        ],
                        explicacao: "Ezequiel 21:2 - Filho do homem, põe o teu rosto para o lado do sul... e profetiza contra o bosque do campo do sul.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "Como é descrita a espada que o Senhor preparou para o julgamento no verso 10?",
                        opcoes: [
                            { numero: 1, texto: "Está enferrujada pelo tempo", correta: false },
                            { numero: 2, texto: "Está afiada para a matança e polida para reluzir", correta: true },
                            { numero: 3, texto: "Está guardada em uma arca", correta: false },
                            { numero: 4, texto: "É uma espada de madeira", correta: false }
                        ],
                        explicacao: "Ezequiel 21:10 - Para fazer uma grande matança está afiada, para reluzir como relâmpago está polida.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "O que o rei de Babilônia faz na encruzilhada para decidir qual caminho seguir?",
                        opcoes: [
                            { numero: 1, texto: "Usa adivinhação: sacode flechas, consulta ídolos e examina o fígado", correta: true },
                            { numero: 2, texto: "Pergunta aos seus soldados", correta: false },
                            { numero: 3, texto: "Senta-se para esperar um sinal do céu", correta: false },
                            { numero: 4, texto: "Segue o caminho mais curto", correta: false }
                        ],
                        explicacao: "Ezequiel 21:21 - Porque o rei de Babilônia parou na encruzilhada... para consultar a adivinhação; sacudiu as flechas, consultou os ídolos domésticos, examinou o fígado.",
                        pontosGanhos: 20
                    }
                ]);
            }
        ...
        22: {
            titulo: "Os Pecados de Jerusalém",
            texto: ` ¹ E veio a mim a palavra do Senhor, dizendo:
...
`,
            get pergunta() {
                return sortear([
                    {
                        texto: "Como Jerusalém é chamada no início do capítulo 22?",
                        opcoes: [
                            { numero: 1, texto: "A cidade ensanguentada", correta: true },
                            { numero: 2, texto: "A cidade de ouro", correta: false },
                            { numero: 3, texto: "O jardim do Senhor", correta: false },
                            { numero: 4, texto: "A fortaleza fiel", correta: false }
                        ],
                        explicacao: "Ezequiel 22:2 - ...julgarás tu a cidade ensanguentada? Faz-lhe saber, pois, todas as suas abominações.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "A que o Senhor compara a casa de Israel no verso 18?",
                        opcoes: [
                            { numero: 1, texto: "A escória de metal (cobre, estanho, ferro e chumbo)", correta: true },
                            { numero: 2, texto: "A pedras preciosas", correta: false },
                            { numero: 3, texto: "A trigo limpo", correta: false },
                            { numero: 4, texto: "A ovelhas sem pastor", correta: false }
                        ],
                        explicacao: "Ezequiel 22:18 - Filho do homem, a casa de Israel se tornou para mim em escória; todos eles são cobre, e estanho, e ferro, e chumbo no meio do forno.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "O que Deus buscou entre o povo, mas não encontrou ninguém?",
                        opcoes: [
                            { numero: 1, texto: "Um homem que fizesse um muro e se pusesse na brecha perante Ele", correta: true },
                            { numero: 2, texto: "Alguém que tivesse muito ouro", correta: false },
                            { numero: 3, texto: "Um rei para governar o Egito", correta: false },
                            { numero: 4, texto: "Um exército de mil homens", correta: false }
                        ],
                        explicacao: "Ezequiel 22:30 - E busquei dentre eles um homem que fizesse um muro, e se pusesse na brecha perante mim por esta terra... mas a ninguém achei.",
                        pontosGanhos: 20
                    }
                ]);
            }
        ...
        23: {
            titulo: "As Duas Irmãs: Aolá e Aolibá",
            texto: ` ¹ Veio mais a mim a palavra do Senhor, dizendo:
...
¹⁵ Cingidos de cinto nos seus lombos, e tiaras largas e tingidas nas suas cabeças, todos com parecer de príncipes, semelhantes aos filhos de Babilônia em Caldeia, terra do seu nascimento.
¹⁶ E enamorou-se deles, ao lançar sobre eles os seus olhos; e lhes mandou mensageiros à Caldeia.
...
²⁶ Também te despirão as tuas vestes, e te tomarão as tuas belas joias.
...
`,
            get pergunta() {
                return sortear([
                    {
                        texto: "Quem são as duas irmãs mencionadas nesta parábola e o que elas representam?",
                        opcoes: [
                            { numero: 1, texto: "Aolá (Samaria) e Aolibá (Jerusalém)", correta: true },
                            { numero: 2, texto: "Raquel e Lia", correta: false },
                            { numero: 3, texto: "Marta e Maria", correta: false },
                            { numero: 4, texto: "Sodoma e Gomorra", correta: false }
                        ],
                        explicacao: "Ezequiel 23:4 - E os seus nomes eram: Aolá, a mais velha, e Aolibá, sua irmã... Samaria é Aolá, e Jerusalém é Aolibá.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "Qual foi o erro de Aolibá ao ver o castigo de sua irmã Aolá?",
                        opcoes: [
                            { numero: 1, texto: "Corrompeu-se com desejos ainda piores que os de sua irmã", correta: true },
                            { numero: 2, texto: "Arrependeu-se profundamente", correta: false },
                            { numero: 3, texto: "Fugiu para o deserto para orar", correta: false },
                            { numero: 4, texto: "Pediu ajuda aos sacerdotes", correta: false }
                        ],
                        explicacao: "Ezequiel 23:11 - Vendo isto sua irmã Aolibá, corrompeu-se na sua paixão mais do que ela.",
                        pontosGanhos: 20
                    }
                ]);
            }
        ...
        24: {
            titulo: "A Panela Fervente e a Perda do Profeta",
            texto: `¹ E veio a mim a palavra do Senhor, no nono ano, no décimo mês, aos dez do mês, dizendo:
...
²⁷ Naquele dia abrir-se-á a tua boca para com aquele que escapar, e falarás, e não mais ficarás mudo; assim virás a ser para eles um sinal, e saberão que eu sou o Senhor.
 `,
            get pergunta() {
                return sortear([
                    {
                        texto: "A que Jerusalém é comparada na parábola do início do capítulo 24?",
                        opcoes: [
                            { numero: 1, texto: "A uma panela de ferro posta ao fogo", correta: true },
                            { numero: 2, texto: "A um jardim seco", correta: false },
                            { numero: 3, texto: "A uma arca vazia", correta: false },
                            { numero: 4, texto: "A uma rede rasgada", correta: false }
                        ],
                        explicacao: "Ezequiel 24:3 - ...Põe a panela ao lume, põe-na, e deita nela água.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "Qual perda pessoal Ezequiel sofreu como um sinal para o povo?",
                        opcoes: [
                            { numero: 1, texto: "A morte de sua esposa (o desejo dos seus olhos)", correta: true },
                            { numero: 2, texto: "A perda de sua visão", correta: false },
                            { numero: 3, texto: "A destruição de sua casa", correta: false },
                            { numero: 4, texto: "A morte de seu filho primogênito", correta: false }
                        ],
                        explicacao: "Ezequiel 24:16,18 - Filho do homem, eis que tirarei de ti o desejo dos teus olhos com um golpe... e à tarde morreu minha mulher.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "Como Ezequiel deveria se comportar após a morte de sua esposa, por ordem de Deus?",
                        opcoes: [
                            { numero: 1, texto: "Não deveria lamentar, nem chorar, nem fazer luto", correta: true },
                            { numero: 2, texto: "Deveria chorar por sete dias", correta: false },
                            { numero: 3, texto: "Deveria rasgar suas vestes", correta: false },
                            { numero: 4, texto: "Deveria oferecer um sacrifício de luto", correta: false }
                        ],
                        explicacao: "Ezequiel 24:16-17 - ...não lamentarás, nem chorarás... Não faças luto por mortos.",
                        pontosGanhos: 20
                    }
                ]);
            }
        ...
        25: {
            titulo: "Julgamento contra as Nações Vizinhas",
            texto: ` ¹ E veio a mim a palavra do Senhor, dizendo:
...
¹⁷ E executarei sobre eles grandes vinganças, com furiosos castigos, e saberão que eu sou o Senhor, quando eu tiver exercido a minha vingança sobre eles.`,
            get pergunta() {
                return sortear([
                    {
                        texto: "Por que o Senhor profetizou contra os filhos de Amom?",
                        opcoes: [
                            { numero: 1, texto: "Porque disseram 'Ah!' contra o santuário quando foi profanado", correta: true },
                            { numero: 2, texto: "Porque tentaram reconstruir o templo", correta: false },
                            { numero: 3, texto: "Porque enviaram ouro para Jerusalém", correta: false },
                            { numero: 4, texto: "Porque ficaram em silêncio", correta: false }
                        ],
                        explicacao: "Ezequiel 25:3 - ...Visto que disseste: Ah! contra o meu santuário, quando foi profanado...",
                        pontosGanhos: 20
                    },
                    {
                        texto: "O que o Senhor prometeu fazer com Edom por causa de sua vingança contra Judá?",
                        opcoes: [
                            { numero: 1, texto: "Estender a mão e arrancar dela homens e animais", correta: true },
                            { numero: 2, texto: "Dar a ela mais terras", correta: false },
                            { numero: 3, texto: "Torná-la rainha das nações", correta: false },
                            { numero: 4, texto: "Enviar profetas para salvá-la", correta: false }
                        ],
                        explicacao: "Ezequiel 25:13 - ...também estenderei a minha mão sobre Edom, e arrancarei dela homens e animais.",
                        pontosGanhos: 20
                    }
                ]);
            }
        ...
        26: {
            ...
            texto: ` ¹ E sucedeu no undécimo ano, ao primeiro do mês, que veio a mim a palavra do Senhor, dizendo:
...
`,
            get pergunta() {
                return sortear([
                    {
                        texto: "Qual nação se alegrou com a queda de Jerusalém, dizendo: 'Ah! Está quebrada a porta dos povos'?",
                        opcoes: [
                            { numero: 1, texto: "Tiro", correta: true },
                            { numero: 2, texto: "Egipto", correta: false },
                            { numero: 3, texto: "Edom", correta: false },
                            { numero: 4, texto: "Moabe", correta: false }
                        ],
                        explicacao: "Ezequiel 26:2 - Filho do homem, visto que Tiro disse no tocante a Jerusalém: Ah! está quebrada a porta dos povos...",
                        pontosGanhos: 20
                    },
                    {
                        texto: "O que Nabucodonosor faria com os muros e torres de Tiro?",
                        opcoes: [
                            { numero: 1, texto: "Iria pintá-los de azul", correta: false },
                            { numero: 2, texto: "Iria derrubá-los com seus aríetes e machados", correta: true },
                            { numero: 3, texto: "Iria reforçá-los para si", correta: false },
                            { numero: 4, texto: "Iria abandoná-los intactos", correta: false }
                        ],
                        explicacao: "Ezequiel 26:9 - E porá os seus aríetes contra os teus muros, e derrubará as tuas torres com os seus machados.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "A que Tiro seria reduzida após ser assolada?",
                        opcoes: [
                            { numero: 1, texto: "A um lugar para estender redes no meio do mar", correta: true },
                            { numero: 2, texto: "A um grande palácio", correta: false },
                            { numero: 3, texto: "A uma floresta densa", correta: false },
                            { numero: 4, texto: "A um deserto de areia", correta: false }
                        ],
                        explicacao: "Ezequiel 26:5 - Ela virá a ser no meio do mar um lugar para se estenderem as redes.",
                        pontosGanhos: 20
                    }
                ]);
            }
...
`,
            get pergunta() {
                return sortear([
                    {
                        texto: "Como Tiro é descrita em termos de sua localização e comércio?",
                        opcoes: [
                            { numero: 1, texto: "Situada à entrada do mar, negociante de povos em muitas ilhas", correta: true },
                            { numero: 2, texto: "Uma cidade escondida nas montanhas", correta: false },
                            { numero: 3, texto: "Uma aldeia de pastores no deserto", correta: false },
                            { numero: 4, texto: "Uma ilha sem contato com o exterior", correta: false }
                        ],
                        explicacao: "Ezequiel 27:3 - E dize a Tiro, que habita à entrada do mar, e negocia com os povos em muitas ilhas...",
                        pontosGanhos: 20
                    },
                    {
                        texto: "De onde vinham os remos dos navios de Tiro?",
                        opcoes: [
                            { numero: 1, texto: "Dos carvalhos de Basã", correta: true },
                            { numero: 2, texto: "Dos cedros do Líbano", correta: false },
                            { numero: 3, texto: "Das palmeiras do Egito", correta: false },
                            { numero: 4, texto: "Das oliveiras de Judá", correta: false }
                        ],
                        explicacao: "Ezequiel 27:6 - Dos carvalhos de Basã fizeram os teus remos.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "O que aconteceu com a 'nave' de Tiro quando foi levada para águas profundas?",
                        opcoes: [
                            { numero: 1, texto: "O vento oriental a quebrou no meio dos mares", correta: true },
                            { numero: 2, texto: "Ela descobriu novas terras", correta: false },
                            { numero: 3, texto: "Ela tornou-se a rainha dos oceanos", correta: false },
                            { numero: 4, texto: "Ela voltou cheia de ouro", correta: false }
                        ],
                        explicacao: "Ezequiel 27:26 - Os teus remadores te levaram sobre grandes águas; o vento oriental te quebrou no meio dos mares.",
                        pontosGanhos: 20
                    }
                ]);
            }
...
²⁶ E habitarão nela seguros, e edificarão casas, e plantarão vinhas, e habitarão seguros, quando eu executar juízos contra todos os que estão ao seu redor e que os desprezam; e saberão que eu sou o Senhor seu Deus.
 `,
            get pergunta() {
                return sortear([
                    {
                        texto: "O que o príncipe de Tiro disse em seu coração que provocou o julgamento de Deus?",
                        opcoes: [
                            { numero: 1, texto: "Eu sou um deus, e no trono de Deus me assento", correta: true },
                            { numero: 2, texto: "Eu sou o servo do Senhor", correta: false },
                            { numero: 3, texto: "Eu não sou ninguém", correta: false },
                            { numero: 4, texto: "Eu amo os pobres", correta: false }
                        ],
                        explicacao: "Ezequiel 28:2 - ...Visto que se elevou o teu coração e disseste: Eu sou um deus, sobre a cadeira de Deus me assento no meio dos mares.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "Onde o 'querubim ungido' estava antes de cair por causa da iniquidade?",
                        opcoes: [
                            { numero: 1, texto: "No Éden, jardim de Deus", correta: true },
                            { numero: 2, texto: "No deserto do Sinai", correta: false },
                            { numero: 3, texto: "No Egito", correta: false },
                            { numero: 4, texto: "Em uma caverna", correta: false }
                        ],
                        explicacao: "Ezequiel 28:13-14 - Estiveste no Éden, jardim de Deus... Tu eras o querubim, ungido para cobrir.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "O que foi achado no rei de Tiro que o levou à expulsão do monte de Deus?",
                        opcoes: [
                            { numero: 1, texto: "Iniquidade e violência no comércio", correta: true },
                            { numero: 2, texto: "Falta de ouro", correta: false },
                            { numero: 3, texto: "Muita humildade", correta: false },
                            { numero: 4, texto: "Sabedoria excessiva", correta: false }
                        ],
                        explicacao: "Ezequiel 28:15-16 - Perfeito eras nos teus caminhos... até que se achou iniquidade em ti. ...te lançarei, profanado, fora do monte de Deus.",
                        pontosGanhos: 20
                    }
                ]);
            }
        ...
        29: {
            ...
            texto: `¹ No décimo ano, no décimo mês, no dia doze do mês, veio a mim a palavra do Senhor, dizendo:
...
¹⁶ E não será mais a confiança da casa de Israel, para lhes trazer à lembrança a sua iniquidade, quando olharem para trás deles; antes saberão que eu sou o Senhor Deus.
...
²¹ Naquele dia farei brotar o poder na casa de Israel, e abrirei a tua boca no meio deles; e saberão que eu sou o Senhor. `,
            get pergunta() {
                return sortear([
                    {
                        texto: "A que animal o Faraó, rei do Egito, é comparado no verso 3?",
                        opcoes: [
                            { numero: 1, texto: "A um grande jacaré (ou monstro marinho) nos seus rios", correta: true },
                            { numero: 2, texto: "A um leão rugindo", correta: false },
                            { numero: 3, texto: "A uma águia veloz", correta: false },
                            { numero: 4, texto: "A um lobo do deserto", correta: false }
                        ],
                        explicacao: "Ezequiel 29:3 - ...Eis-me contra ti, ó Faraó... o grande dragão, que pousas no meio dos teus rios.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "Por quanto tempo a terra do Egito ficaria desolada, sem ser pisada por homem ou animal?",
                        opcoes: [
                            { numero: 1, texto: "40 anos", correta: true },
                            { numero: 2, texto: "7 anos", correta: false },
                            { numero: 3, texto: "100 anos", correta: false },
                            { numero: 4, texto: "10 anos", correta: false }
                        ],
                        explicacao: "Ezequiel 29:11-12 - Não passará por ela pé de homem... nem será habitada quarenta anos.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "O que o Senhor daria a Nabucodonosor como pagamento pelo trabalho realizado contra Tiro?",
                        opcoes: [
                            { numero: 1, texto: "A terra do Egito", correta: true },
                            { numero: 2, texto: "Todo o ouro de Jerusalém", correta: false },
                            { numero: 3, texto: "As ilhas do mar", correta: false },
                            { numero: 4, texto: "A cidade de Nínive", correta: false }
                        ],
                        explicacao: "Ezequiel 29:19 - ...Eis que eu darei a Nabucodonosor... a terra do Egito; e levará a sua multidão, e tomará o seu despojo.",
                        pontosGanhos: 20
                    }
                ]);
            }
        ...
        30: {
            titulo: "O Dia do Senhor Sobre o Egito",
            texto: `¹ E veio a mim a palavra do Senhor, dizendo:
...
²⁶ E espalharei os egípcios entre as nações, e os dispersarei entre as terras; assim saberão que eu sou o Senhor. `,
            get pergunta() {
                return sortear([
                    {
                        texto: "O que aconteceria com os aliados (sustentadores) do Egito?",
                        opcoes: [
                            { numero: 1, texto: "Cairiam todos juntamente com ele", correta: true },
                            { numero: 2, texto: "Tornar-se-iam os novos reis", correta: false },
                            { numero: 3, texto: "Fugiriam para as montanhas", correta: false },
                            { numero: 4, texto: "Seriam poupados pelo Senhor", correta: false }
                        ],
                        explicacao: "Ezequiel 30:6 - Assim diz o Senhor: Também cairão os que sustêm o Egito, e cairá a soberba do seu poder.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "O que o Senhor faria com os braços de Faraó e com os braços do rei de Babilônia?",
                        opcoes: [
                            { numero: 1, texto: "Quebraria os de Faraó e fortaleceria os de Babilônia", correta: true },
                            { numero: 2, texto: "Quebraria ambos", correta: false },
                            { numero: 3, texto: "Fortaleceria ambos", correta: false },
                            { numero: 4, texto: "Daria ouro em suas mãos", correta: false }
                        ],
                        explicacao: "Ezequiel 30:24 - E fortalecerei os braços do rei de Babilônia, e porei a minha espada na sua mão; mas quebrarei os braços de Faraó.",
                        pontosGanhos: 20
                    }
                ]);
            }
        ...
        31: {
            titulo: "A Queda do Grande Cedro",
            texto: `¹ E sucedeu, no ano undécimo, no terceiro mês, ao primeiro do mês, que veio a mim a palavra do Senhor, dizendo:
...
¹⁸ A quem, pois, és semelhante em glória e em grandeza entre as árvores do Éden? Todavia serás precipitado com as árvores do Éden às partes mais baixas da terra; no meio dos incircuncisos jazerás com os que foram traspassados à espada; este é Faraó e toda a sua multidão, diz o Senhor Deus.
 `,
            get pergunta() {
                return sortear([
                    {
                        texto: "A que árvore imponente o Egito (Assíria) é comparado no capítulo 31?",
                        opcoes: [
                            { numero: 1, texto: "A um cedro do Líbano de alta estatura", correta: true },
                            { numero: 2, texto: "A uma oliveira brava", correta: false },
                            { numero: 3, texto: "A um carvalho de Basã", correta: false },
                            { numero: 4, texto: "A uma figueira estéril", correta: false }
                        ],
                        explicacao: "Ezequiel 31:3 - Eis que a Assíria era um cedro no Líbano, de ramos formosos, de sombrosa ramagem e de alta estatura.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "O que aconteceu com a estatura desse cedro que causou a sua queda?",
                        opcoes: [
                            { numero: 1, texto: "O seu coração se exaltou na sua altura", correta: true },
                            { numero: 2, texto: "As suas raízes secaram por falta de água", correta: false },
                            { numero: 3, texto: "Foi atingido por um raio", correta: false },
                            { numero: 4, texto: "Os animais o derrubaram", correta: false }
                        ],
                        explicacao: "Ezequiel 31:10 - ...visto que se elevou na sua estatura... e o seu coração se exaltou na sua altura.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "Para onde o Senhor enviou o cedro e todos os que bebiam águas após a queda?",
                        opcoes: [
                            { numero: 1, texto: "Para as partes mais baixas da terra, com os que descem à cova", correta: true },
                            { numero: 2, texto: "Para o cume das montanhas", correta: false },
                            { numero: 3, texto: "Para um novo jardim", correta: false },
                            { numero: 4, texto: "Para as ilhas do mar", correta: false }
                        ],
                        explicacao: "Ezequiel 31:14 - ...porque todos eles estão entregues à morte, às partes mais baixas da terra... com os que descem à cova.",
                        pontosGanhos: 20
                    }
                ]);
            }
        ...
        32: {
            titulo: "Lamento pelo Egito e o Mundo dos Mortos",
            texto: ` ¹ E sucedeu que, no ano duodécimo, no duodécimo mês, ao primeiro do mês, veio a mim a palavra do Senhor, dizendo:
...
`,
            get pergunta() {
                return sortear([
                    {
                        texto: "O que o Senhor estenderia sobre o Faraó para capturá-lo, como se fosse um monstro marinho?",
                        opcoes: [
                            { numero: 1, texto: "A Sua rede, por meio de uma multidão de povos", correta: true },
                            { numero: 2, texto: "Um muro de pedras", correta: false },
                            { numero: 3, texto: "Uma corrente de ferro", correta: false },
                            { numero: 4, texto: "Um véu de escuridão", correta: false }
                        ],
                        explicacao: "Ezequiel 32:3 - ...estenderei sobre ti a minha rede por meio de uma multidão de grandes povos, e te farão subir na minha rede.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "O que o Senhor faria com as luzes do céu quando o Egito fosse extinto?",
                        opcoes: [
                            { numero: 1, texto: "Cobriria os céus e escureceria as suas estrelas", correta: true },
                            { numero: 2, texto: "Faria o sol brilhar sete vezes mais", correta: false },
                            { numero: 3, texto: "Criaria novas constelações", correta: false },
                            { numero: 4, texto: "Mandaria fogo sobre a lua", correta: false }
                        ],
                        explicacao: "Ezequiel 32:7 - E, apagando-te eu, cobrirei os céus, e escurecerei as suas estrelas; ao sol encobrirei com uma nuvem, e a lua não fará resplandecer a sua luz.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "Quais nações são mencionadas como estando no Seol (mundo dos mortos) aguardando o Egito?",
                        opcoes: [
                            { numero: 1, texto: "Assíria, Elão, Meseque, Tubal e Edom", correta: true },
                            { numero: 2, texto: "Grécia e Roma", correta: false },
                            { numero: 3, texto: "Espanha e França", correta: false },
                            { numero: 4, texto: "Apenas Israel", correta: false }
                        ],
                        explicacao: "Ezequiel 32:22-29 - Ali está a Assíria... Ali está Elão... Ali Meseque e Tubal... Ali está Edom...",
                        pontosGanhos: 20
                    }
                ]);
            }
        ...
        33: {
            titulo: "O Dever do Atalaia e a Justiça de Deus",
            texto: ` ¹ E veio a mim a palavra do Senhor, dizendo:
...
`,
            get pergunta() {
                return sortear([
                    {
                        texto: "De quem Deus requereria o sangue se o atalaia visse a espada e não tocasse a trombeta?",
                        opcoes: [
                            { numero: 1, texto: "Da mão do atalaia", correta: true },
                            { numero: 2, texto: "Do rei da cidade", correta: false },
                            { numero: 3, texto: "Ninguém seria responsável", correta: false },
                            { numero: 4, texto: "Dos anjos do céu", correta: false }
                        ],
                        explicacao: "Ezequiel 33:6 - Mas, se quando o atalaia vir que vem a espada, e não tocar a trombeta... o seu sangue da mão do atalaia o requererei.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "O que o Senhor diz sobre o prazer que Ele tem na morte do ímpio?",
                        opcoes: [
                            { numero: 1, texto: "Não tenho prazer na morte do ímpio, mas em que se converta e viva", correta: true },
                            { numero: 2, texto: "Deus se alegra quando o ímpio morre", correta: false },
                            { numero: 3, texto: "A morte é indiferente para Deus", correta: false },
                            { numero: 4, texto: "O ímpio não pode se converter", correta: false }
                        ],
                        explicacao: "Ezequiel 33:11 - ...Não tenho prazer na morte do ímpio, mas em que o ímpio se converta do seu caminho, e viva.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "O que aconteceu com a boca de Ezequiel na tarde antes de chegar o fugitivo de Jerusalém?",
                        opcoes: [
                            { numero: 1, texto: "Sua boca foi aberta e ele não ficou mais mudo", correta: true },
                            { numero: 2, texto: "Ele ficou mudo por mais um ano", correta: false },
                            { numero: 3, texto: "Ele começou a falar línguas estranhas", correta: false },
                            { numero: 4, texto: "Ele perdeu a voz totalmente", correta: false }
                        ],
                        explicacao: "Ezequiel 33:22 - Ora, a mão do Senhor estivera sobre mim pela tarde... e ele abriu a minha boca... e não fiquei mais mudo.",
                        pontosGanhos: 20
                    }
                ]);
            }
        ...
        34: {
            titulo: "Os Pastores de Israel e o Bom Pastor",
            texto: ` ¹ E veio a mim a palavra do Senhor, dizendo:
...
³¹ Vós, pois, ó ovelhas minhas, ovelhas do meu pasto; homens sois; porém eu sou o vosso Deus, diz o Senhor Deus.`,
            get pergunta() {
                return sortear([
                    {
                        texto: "Contra quem o Senhor manda Ezequiel profetizar no capítulo 34?",
                        opcoes: [
                            { numero: 1, texto: "Contra os pastores de Israel que se apascentavam a si mesmos", correta: true },
                            { numero: 2, texto: "Contra os agricultores do Egito", correta: false },
                            { numero: 3, texto: "Contra os marinheiros de Tiro", correta: false },
                            { numero: 4, texto: "Contra os construtores de muros", correta: false }
                        ],
                        explicacao: "Ezequiel 34:2 - ...profetiza contra os pastores de Israel... Ai dos pastores de Israel que se apascentam a si mesmos!",
                        pontosGanhos: 20
                    },
                    {
                        texto: "O que Deus promete fazer pelas Suas ovelhas, já que os pastores falharam?",
                        opcoes: [
                            { numero: 1, texto: "Eu mesmo procurarei as minhas ovelhas e as buscarei", correta: true },
                            { numero: 2, texto: "Deixará que elas se percam", correta: false },
                            { numero: 3, texto: "Contratará pastores estrangeiros", correta: false },
                            { numero: 4, texto: "Enviará lobos para castigá-las", correta: false }
                        ],
                        explicacao: "Ezequiel 34:11 - Porque assim diz o Senhor Deus: Eis que eu, eu mesmo, procurarei as minhas ovelhas, e as buscarei.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "Quem o Senhor prometeu levantar como único pastor sobre o Seu povo?",
                        opcoes: [
                            { numero: 1, texto: "O Seu servo Davi", correta: true },
                            { numero: 2, texto: "O rei Salomão", correta: false },
                            { numero: 3, texto: "O profeta Moisés", correta: false },
                            { numero: 4, texto: "Um anjo do céu", correta: false }
                        ],
                        explicacao: "Ezequiel 34:23 - E levantarei sobre elas um só pastor, e ele as apascentará; o meu servo Davi é que as apascentará.",
                        pontosGanhos: 20
                    }
                ]);
            }
        ...
        35: {
            titulo: "Profecia Contra o Monte Seir (Edom)",
            texto: `¹ E veio a mim a palavra do Senhor, dizendo:
...
¹⁵ Como te alegraste da herança da casa de Israel, porque foi assolada, assim te farei a ti; assolado serás, ó monte Seir, e todo o Edom, sim, todo ele; e saberão que eu sou o Senhor.
 `,
            get pergunta() {
                return sortear([
                    {
                        texto: "Por que o Senhor estava contra o Monte Seir?",
                        opcoes: [
                            { numero: 1, texto: "Por causa do seu ódio perpétuo e por entregar Israel à espada no dia da calamidade", correta: true },
                            { numero: 2, texto: "Porque eles tinham muitas montanhas", correta: false },
                            { numero: 3, texto: "Porque não enviaram presentes a Ezequiel", correta: false },
                            { numero: 4, texto: "Porque eram muito pobres", correta: false }
                        ],
                        explicacao: "Ezequiel 35:5 - Pois que tiveste um ódio perpétuo, e entregaste os filhos de Israel ao poder da espada no tempo da sua calamidade.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "O que Edom disse sobre as duas nações (Israel e Judá) que provocou a ira de Deus?",
                        opcoes: [
                            { numero: 1, texto: "Estas duas nações... serão minhas, e nós as possuiremos", correta: true },
                            { numero: 2, texto: "Nós as ajudaremos", correta: false },
                            { numero: 3, texto: "Elas são santas", correta: false },
                            { numero: 4, texto: "Não queremos essas terras", correta: false }
                        ],
                        explicacao: "Ezequiel 35:10 - Porquanto disseste: Estas duas nações e estas duas terras serão minhas, e nós as possuiremos, sendo que o Senhor se achava ali.",
                        pontosGanhos: 20
                    }
                ]);
            }
        ...
        36: {
            ...
            texto: `¹ E tu, ó filho do homem, profetiza aos montes de Israel, e dize: Montes de Israel, ouvi a palavra do Senhor.
...
³⁸ Como o rebanho santificado, como o rebanho de Jerusalém nas suas solenidades, assim as cidades desertas se encherão de rebanhos de homens; e saberão que eu sou o Senhor.
 `,
            get pergunta() {
                return sortear([
                    {
                        texto: "O que Deus prometeu aspergir sobre o povo para purificá-lo de suas imundícias?",
                        opcoes: [
                            { numero: 1, texto: "Azeite de oliva", correta: false },
                            { numero: 2, texto: "Água pura", correta: true },
                            { numero: 3, texto: "Sangue de cordeiro", correta: false },
                            { numero: 4, texto: "Vinho novo", correta: false }
                        ],
                        explicacao: "Ezequiel 36:25 - Então aspergirei água pura sobre vós, e ficareis purificados; de todas as vossas imundícias e de todos os vossos ídolos vos purificarei.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "Que mudança profunda Deus prometeu fazer no interior do Seu povo?",
                        opcoes: [
                            { numero: 1, texto: "Dar um coração de carne em lugar do coração de pedra", correta: true },
                            { numero: 2, texto: "Torná-los mais inteligentes que os gregos", correta: false },
                            { numero: 3, texto: "Dar-lhes visões constantes", correta: false },
                            { numero: 4, texto: "Remover todas as suas memórias", correta: false }
                        ],
                        explicacao: "Ezequiel 36:26 - E dar-vos-ei um coração novo, e porei dentro de vós um espírito novo; e tirarei da vossa carne o coração de pedra, e vos darei um coração de carne.",
                        pontosGanhos: 20
                    }
                ]);
            }
        ...
        37: {
            titulo: "O Vale de Ossos Secos",
            texto: ` ¹ Veio sobre mim a mão do Senhor, e ele me fez sair no Espírito do Senhor, e me pôs no meio de um vale que estava cheio de ossos.
...
`,
            get pergunta() {
                return sortear([
                    {
                        texto: "O que aconteceu quando Ezequiel profetizou aos ossos secos conforme a ordem do Senhor?",
                        opcoes: [
                            { numero: 1, texto: "Os ossos se juntaram, e cresceram neles nervos, carne e pele", correta: true },
                            { numero: 2, texto: "Os ossos viraram pó", correta: false },
                            { numero: 3, texto: "Os ossos foram levados pelo vento", correta: false },
                            { numero: 4, texto: "Nada aconteceu", correta: false }
                        ],
                        explicacao: "Ezequiel 37:7-8 - ...e os ossos se juntaram, cada osso ao seu osso. E olhei, e eis que vieram nervos sobre eles, e cresceu a carne, e estendeu-se a pele sobre eles.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "De onde veio o fôlego que fez o exército de ossos reviver e pôr-se em pé?",
                        opcoes: [
                            { numero: 1, texto: "Do sol", correta: false },
                            { numero: 2, texto: "Dos quatro ventos", correta: true },
                            { numero: 3, texto: "Do fundo do mar", correta: false },
                            { numero: 4, texto: "Da boca do profeta", correta: false }
                        ],
                        explicacao: "Ezequiel 37:9-10 - ...Vem dos quatro ventos, ó fôlego, e assopra sobre estes mortos, para que vivam.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "O que simbolizava a união dos dois pedaços de madeira (de Judá e de José)?",
                        opcoes: [
                            { numero: 1, texto: "A unificação de Israel e Judá em um só reino e um só povo", correta: true },
                            { numero: 2, texto: "A construção de um novo templo de madeira", correta: false },
                            { numero: 3, texto: "O fim das guerras mundiais", correta: false },
                            { numero: 4, texto: "A aliança com a Babilônia", correta: false }
                        ],
                        explicacao: "Ezequiel 37:22 - E deles farei uma nação na terra... e todos eles terão um só rei, e nunca mais serão duas nações.",
                        pontosGanhos: 20
                    }
                ]);
            }
        ...
        38: {
            titulo: "A Invasão de Gogue",
            texto: `¹ Veio a mim a palavra do Senhor, dizendo:
...
²³ Assim eu me engrandecerei e me santificarei, e me darei a conhecer aos olhos de muitas nações; e saberão que eu sou o Senhor.
 ...
 `,
            get pergunta() {
                return sortear([
                    {
                        texto: "Quem é o líder mencionado que viria das bandas do norte para invadir a terra de Israel?",
                        opcoes: [
                            { numero: 1, texto: "Nabucodonosor", correta: false },
                            { numero: 2, texto: "Gogue, da terra de Magogue", correta: true },
                            { numero: 3, texto: "Faraó Neco", correta: false },
                            { numero: 4, texto: "Ciro, o Persa", correta: false }
                        ],
                        explicacao: "Ezequiel 38:2 - Filho do homem, põe o teu rosto contra Gogue, da terra de Magogue, príncipe e chefe de Meseque e Tubal.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "Como estaria o povo de Israel quando Gogue decidisse invadi-lo?",
                        opcoes: [
                            { numero: 1, texto: "Habitando seguro, em cidades sem muros nem ferrolhos", correta: true },
                            { numero: 2, texto: "Em guerra civil", correta: false },
                            { numero: 3, texto: "Escondido em cavernas debaixo da terra", correta: false },
                            { numero: 4, texto: "Preparado com o maior exército do mundo", correta: false }
                        ],
                        explicacao: "Ezequiel 38:11 - ...Irei contra os que estão em repouso, que habitam seguros; todos eles habitam sem muro, e não têm ferrolhos nem portas.",
                        pontosGanhos: 20
                    }
                ]);
            }
        ...
        39: {
            titulo: "A Derrota de Gogue",
            texto: ` ¹ Tu, pois, ó filho do homem, profetiza ainda contra Gogue, e dize: Assim diz o Senhor Deus: Eis que eu sou contra ti, ó Gogue, príncipe e chefe de Meseque e de Tubal.
...
`,
            get pergunta() {
                return sortear([
                    {
                        texto: "Por quantos anos os habitantes de Israel queimariam as armas dos invasores derrotados como combustível?",
                        opcoes: [
                            { numero: 1, texto: "Um ano", correta: false },
                            { numero: 2, texto: "Sete anos", correta: true },
                            { numero: 3, texto: "Três anos", correta: false },
                            { numero: 4, texto: "Dez anos", correta: false }
                        ],
                        explicacao: "Ezequiel 39:9 - ...e acenderão o fogo, e queimarão as armas... por sete anos as queimarão.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "Quanto tempo a casa de Israel levaria para enterrar todos os mortos e purificar a terra?",
                        opcoes: [
                            { numero: 1, texto: "Sete meses", correta: true },
                            { numero: 2, texto: "Um mês", correta: false },
                            { numero: 3, texto: "Dois anos", correta: false },
                            { numero: 4, texto: "Sete dias", correta: false }
                        ],
                        explicacao: "Ezequiel 39:12 - E a casa de Israel os enterrará por sete meses, para purificar a terra.",
                        pontosGanhos: 20
                    }
                ]);
            }
        ...
        40: {
            titulo: "A Visão do Novo Templo",
            texto: `¹ No ano vinte e cinco do nosso cativeiro, no princípio do ano, no décimo dia do mês, catorze anos depois que a cidade foi conquistada, naquele mesmo dia veio sobre mim a mão do Senhor, e me levou para lá.
...
¹⁵ E, desde a face da porta da entrada até à face do vestíbulo da porta interior, havia cinquenta côvados.
...
⁴⁹ O comprimento do vestíbulo era de vinte côvados, e a largura de onze côvados, e era por degraus, que se subia a ele; e havia colunas junto aos pilares, uma de um lado e outra do outro.
 `,
            get pergunta() {
                return sortear([
                    {
                        texto: "Quem Ezequiel viu no alto de um monte, cujo aspecto era como o de bronze?",
                        opcoes: [
                            { numero: 1, texto: "Um homem com um cordel de linho e uma cana de medir na mão", correta: true },
                            { numero: 2, texto: "O rei Davi coroado", correta: false },
                            { numero: 3, texto: "Um exército de querubins", correta: false },
                            { numero: 4, texto: "O profeta Moisés", correta: false }
                        ],
                        explicacao: "Ezequiel 40:3 - ...e eis que havia um homem cujo aspecto era como o aspecto do bronze, e tinha um cordel de linho na mão e uma cana de medir.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "Qual era a medida da cana (vara) de medir que o homem segurava?",
                        opcoes: [
                            { numero: 1, texto: "Seis côvados, cada um de um côvado e quatro dedos", correta: true },
                            { numero: 2, texto: "Doze metros", correta: false },
                            { numero: 3, texto: "Dez palmos", correta: false },
                            { numero: 4, texto: "Cinquenta côvados", correta: false }
                        ],
                        explicacao: "Ezequiel 40:5 - ...e na mão do homem uma cana de medir de seis côvados, cada um dos quais era de um côvado e quatro dedos.",
                        pontosGanhos: 20
                    }
                ]);
            }
        ...
        41: {
            titulo: "As Medidas do Templo",
            texto: ` ¹ Então me levou ao templo, e mediu os pilares, seis côvados de largura de um lado, e seis côvados de largura do outro, que era a largura da tenda.
...
`,
            get pergunta() {
                return sortear([
                    {
                        texto: "Qual era a largura da entrada do lugar santíssimo medida pelo homem na visão?",
                        opcoes: [
                            { numero: 1, texto: "Seis côvados", correta: true },
                            { numero: 2, texto: "Dez côvados", correta: false },
                            { numero: 3, texto: "Doze côvados", correta: false },
                            { numero: 4, texto: "Vinte côvados", correta: false }
                        ],
                        explicacao: "Ezequiel 41:3 - E entrou no interior, e mediu a ombreira da entrada, de dois côvados; e a entrada, de seis côvados.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "O que estava entalhado nas paredes do Templo, entre os querubins?",
                        opcoes: [
                            { numero: 1, texto: "Palmeiras", correta: true },
                            { numero: 2, texto: "Leões de ouro", correta: false },
                            { numero: 3, texto: "Estrelas de prata", correta: false },
                            { numero: 4, texto: "Escudos de bronze", correta: false }
                        ],
                        explicacao: "Ezequiel 41:18 - E estava feito com querubins e palmeiras, de maneira que cada palmeira estava entre querubim e querubim.",
                        pontosGanhos: 20
                    }
                ]);
            }
        ...
        42: {
            titulo: "As Câmaras dos Sacerdotes",
            texto: ` ¹ Depois disto fez-me sair para fora, ao átrio exterior, para o lado do caminho do norte; e me levou às câmaras que estavam defronte do lugar separado, e que estavam defronte do edifício, do lado norte.
...
⁷ E o muro que estava de fora, defronte das câmaras, no caminho do átrio exterior, diante das câmaras, tinha cinquenta côvados de comprimento.
...
`,
            get pergunta() {
                return sortear([
                    {
                        texto: "Para que serviam as câmaras santas mencionadas no capítulo 42?",
                        opcoes: [
                            { numero: 1, texto: "Para os sacerdotes comerem as coisas santíssimas e guardarem suas vestes", correta: true },
                            { numero: 2, texto: "Para o povo dormir durante as festas", correta: false },
                            { numero: 3, texto: "Para guardar os cavalos do rei", correta: false },
                            { numero: 4, texto: "Para esconder o ouro de Tiro", correta: false }
                        ],
                        explicacao: "Ezequiel 42:13-14 - ...são câmaras santas, em que os sacerdotes... comerão as coisas santíssimas... e ali porão as suas vestes.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "Qual era o objetivo do muro que cercava o Templo por todos os quatro lados?",
                        opcoes: [
                            { numero: 1, texto: "Fazer separação entre o santo e o profano", correta: true },
                            { numero: 2, texto: "Proteger contra exércitos inimigos", correta: false },
                            { numero: 3, texto: "Servir de suporte para jardins suspensos", correta: false },
                            { numero: 4, texto: "Marcar o limite da cidade", correta: false }
                        ],
                        explicacao: "Ezequiel 42:20 - ...tinha um muro em redor... para fazer separação entre o santo e o profano.",
                        pontosGanhos: 20
                    }
                ]);
            }
        ...
        43: {
            titulo: "A Glória de Deus Retorna",
            texto: `¹ Então me levou à porta, à porta que olha para o caminho do oriente.
...
²⁷ E, cumprindo eles estes dias, será que, ao oitavo dia, e dali em diante, os sacerdotes oferecerão sobre o altar os vossos holocaustos e as vossas ofertas pacíficas; e eu me deleitarei em vós, diz o Senhor Deus.
 `,
            get pergunta() {
                return sortear([
                    {
                        texto: "De que direção veio a glória do Deus de Israel para habitar no novo Templo?",
                        opcoes: [
                            { numero: 1, texto: "Do caminho do oriente", correta: true },
                            { numero: 2, texto: "Do sul, vinda do Egito", correta: false },
                            { numero: 3, texto: "Do norte, vinda de Babilônia", correta: false },
                            { numero: 4, texto: "Do ocidente, vinda do mar", correta: false }
                        ],
                        explicacao: "Ezequiel 43:2 - E eis que a glória do Deus de Israel vinha do caminho do oriente; e a sua voz era como a voz de muitas águas.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "O que o Senhor disse sobre o lugar onde Seu trono estaria para sempre no meio de Israel?",
                        opcoes: [
                            { numero: 1, texto: "Que a casa de Israel nunca mais profanaria o Seu santo nome", correta: true },
                            { numero: 2, texto: "Que o lugar era temporário", correta: false },
                            { numero: 3, texto: "Que o ouro seria a base do trono", correta: false },
                            { numero: 4, texto: "Que os reis estrangeiros poderiam visitá-lo", correta: false }
                        ],
                        explicacao: "Ezequiel 43:7 - ...este é o lugar do meu trono... onde habitarei no meio dos filhos de Israel para sempre; e a casa de Israel não profanará mais o meu nome santo.",
                        pontosGanhos: 20
                    }
                ]);
            }
        ...
        44: {
            titulo: "Os Sacerdotes e as Leis do Santuário",
            texto: ` ¹ Então me fez voltar para o caminho da porta exterior do santuário, que olha para o oriente, a qual estava fechada.
...
`,
            get pergunta() {
                return sortear([
                    {
                        texto: "Por que a porta exterior do santuário, que olha para o oriente, deveria permanecer fechada?",
                        opcoes: [
                            { numero: 1, texto: "Porque o Senhor, Deus de Israel, entrou por ela", correta: true },
                            { numero: 2, texto: "Porque a chave foi perdida", correta: false },
                            { numero: 3, texto: "Para evitar o vento do deserto", correta: false },
                            { numero: 4, texto: "Para proteger o ouro", correta: false }
                        ],
                        explicacao: "Ezequiel 44:2 - Esta porta estará fechada... porque o Senhor, Deus de Israel, entrou por ela.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "Qual linhagem de sacerdotes foi escolhida para se aproximar do Senhor, por ter guardado o santuário?",
                        opcoes: [
                            { numero: 1, texto: "Os filhos de Zadoque", correta: true },
                            { numero: 2, texto: "Os filhos de Corá", correta: false },
                            { numero: 3, texto: "Os levitas que se desviaram", correta: false },
                            { numero: 4, texto: "Os descendentes de Eli", correta: false }
                        ],
                        explicacao: "Ezequiel 44:15 - Mas os sacerdotes levíticos, os filhos de Zadoque, que guardaram a ordenança do meu santuário... eles se chegarão a mim.",
                        pontosGanhos: 20
                    }
                ]);
            }
        ...
        45: {
            titulo: "A Porção da Terra e os Pesos Justos",
            texto: ` ¹ Quando, pois, repartirdes a terra em herança, oferecereis uma oferta ao Senhor, uma porção santa da terra; o seu comprimento será de vinte e cinco mil canas e a largura de dez mil. Esta será santa em toda a sua extensão ao redor.
...
`,
            get pergunta() {
                return sortear([
                    {
                        texto: "O que o Senhor exige dos príncipes de Israel quanto às medidas e pesos?",
                        opcoes: [
                            { numero: 1, texto: "Balanças justas, efa justo e bato justo", correta: true },
                            { numero: 2, texto: "Que cobrem o máximo de impostos", correta: false },
                            { numero: 3, texto: "Que usem pesos de ouro", correta: false },
                            { numero: 4, texto: "Que não usem balanças", correta: false }
                        ],
                        explicacao: "Ezequiel 45:10 - Balanças justas, efa justo e bato justo tereis.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "Em qual dia do primeiro mês deve-se celebrar a Páscoa, segundo o verso 21?",
                        opcoes: [
                            { numero: 1, texto: "Aos quatorze dias do mês", correta: true },
                            { numero: 2, texto: "No primeiro dia", correta: false },
                            { numero: 3, texto: "No sétimo dia", correta: false },
                            { numero: 4, texto: "No décimo dia", correta: false }
                        ],
                        explicacao: "Ezequiel 45:21 - No primeiro mês, aos catorze dias do mês, tereis a páscoa.",
                        pontosGanhos: 20
                    }
                ]);
            }
        ...
        46: {
            titulo: "O Culto e as Ofertas do Príncipe",
            texto: ` ¹ Assim diz o Senhor Deus: A porta do átrio interior que dá para o oriente, estará fechada durante os seis dias que são de trabalho; mas no dia de sábado ela se abrirá; também no dia da lua nova se abrirá.
...
`,
            get pergunta() {
                return sortear([
                    {
                        texto: "Em quais dias a porta do átrio interior que olha para o oriente deve ser aberta?",
                        opcoes: [
                            { numero: 1, texto: "No dia de sábado e no dia da lua nova", correta: true },
                            { numero: 2, texto: "Todos os dias da semana", correta: false },
                            { numero: 3, texto: "Apenas no dia da Expiação", correta: false },
                            { numero: 4, texto: "Somente uma vez por ano", correta: false }
                        ],
                        explicacao: "Ezequiel 46:1 - ...estará fechada durante os seis dias que são de trabalho; mas no dia de sábado se abrirá; também no dia da lua nova se abrirá.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "Como o povo deveria entrar e sair do templo durante as festas fixas para manter a ordem?",
                        opcoes: [
                            { numero: 1, texto: "Deveriam sair pela porta oposta à que entraram", correta: true },
                            { numero: 2, texto: "Deveriam sair pela mesma porta que entraram", correta: false },
                            { numero: 3, texto: "Deveriam sair todos pela porta do oriente", correta: false },
                            { numero: 4, texto: "Poderiam sair por qualquer janela", correta: false }
                        ],
                        explicacao: "Ezequiel 46:9 - ...aquele que entrar pela porta do norte... sairá pela porta do sul; e o que entrar pela porta do sul sairá pela porta do norte.",
                        pontosGanhos: 20
                    }
                ]);
            }
        ...
        47: {
            titulo: "O Rio de Águas Purificadoras",
            texto: `¹ Depois disto me fez voltar à porta da casa, e eis que saíam águas por debaixo do umbral da casa para o oriente; porque a face da casa dava para o oriente, e as águas desciam de debaixo, desde o lado direito da casa, ao sul do altar.
...
²³ E será que na tribo em que habitar o estrangeiro, ali lhe dareis a sua herança, diz o Senhor Deus.
 ...
 `,
            get pergunta() {
                return sortear([
                    {
                        texto: "De onde saíam as águas que Ezequiel viu na visão do Templo?",
                        opcoes: [
                            { numero: 1, texto: "De debaixo do limiar da casa, para o oriente", correta: true },
                            { numero: 2, texto: "Do topo do monte Sião", correta: false },
                            { numero: 3, texto: "De uma nuvem que pairava sobre o altar", correta: false },
                            { numero: 4, texto: "Das janelas do santuário", correta: false }
                        ],
                        explicacao: "Ezequiel 47:1 - ...e eis que saíam águas de debaixo do limiar da casa, para o oriente.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "O que aconteceria com as águas do Mar Morto (Mar Salgado) quando o rio chegasse lá?",
                        opcoes: [
                            { numero: 1, texto: "As águas seriam saneadas (tornar-se-iam saudáveis)", correta: true },
                            { numero: 2, texto: "O mar secaria completamente", correta: false },
                            { numero: 3, texto: "O mar transbordaria e cobriria a terra", correta: false },
                            { numero: 4, texto: "As águas se tornariam sangue", correta: false }
                        ],
                        explicacao: "Ezequiel 47:8 - ...e, entrando no mar, as águas serão saneadas.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "O que cresceria junto à margem do rio e para que serviriam suas folhas?",
                        opcoes: [
                            { numero: 1, texto: "Toda sorte de árvore frutífera; as folhas serviriam para remédio", correta: true },
                            { numero: 2, texto: "Apenas espinheiros para proteção", correta: false },
                            { numero: 3, texto: "Carvalhos para construção de navios", correta: false },
                            { numero: 4, texto: "Flores de ouro para decoração", correta: false }
                        ],
                        explicacao: "Ezequiel 47:12 - ...e não cairá a sua folha, nem faltará o seu fruto... e a sua folha servirá de remédio.",
                        pontosGanhos: 20
                    }
                ]);
            }
        ...
        48: {
            titulo: "A Divisão das Tribos e o Nome da Cidade",
            texto: `¹ E estes são os nomes das tribos: desde o extremo norte, ao longo do caminho de Hetlom, indo para Hamate, até Hazar-Enom, termo de Damasco para o norte, ao pé de Hamate, terá Dã uma parte, desde o lado oriental até o ocidental.
...
³⁵ Dezoito mil canas por medida terá ao redor; e o nome da cidade desde aquele dia será: o Senhor está ali. `,
            get pergunta() {
                return sortear([
                    {
                        texto: "Quantas portas terá a cidade no total, e por que nomes serão chamadas?",
                        opcoes: [
                            { numero: 1, texto: "12 portas, com os nomes das tribos de Israel", correta: true },
                            { numero: 2, texto: "7 portas, com os nomes dos arcanjos", correta: false },
                            { numero: 3, texto: "4 portas, com os nomes dos pontos cardeais", correta: false },
                            { numero: 4, texto: "10 portas, com os nomes dos mandamentos", correta: false }
                        ],
                        explicacao: "Ezequiel 48:31 - E as portas da cidade serão conforme os nomes das tribos de Israel.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "Qual será o nome da cidade de Jerusalém restaurada desde aquele dia em diante?",
                        opcoes: [
                            { numero: 1, texto: "O Senhor está ali (Jehovah-Shammah)", correta: true },
                            { numero: 2, texto: "A Cidade de Ouro", correta: false },
                            { numero: 3, texto: "A Nova Babilônia", correta: false },
                            { numero: 4, texto: "Monte Santo", correta: false }
                        ],
                        explicacao: "Ezequiel 48:35 - ...e o nome da cidade desde aquele dia será: O Senhor está ali.",
                        pontosGanhos: 20
                    }
                ]);
            }
