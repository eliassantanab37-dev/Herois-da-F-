// js/livros/josué.js
// ═══════════════════════════════════════════════════════════════════════════════
// LIVRO: JOSUÉ - O LIVRO DA CONQUISTA E POSSE DA PROMESSA
// ═══════════════════════════════════════════════════════════════════════════════
...
export const josue = {
    ...
    // ───────────────────────────────────────────────────────────────────────────
    nome: "Josué",     // Nome que aparece no título
    icone: "📜",         // Emoji ou Ícone que aparece no card
    autor: "Josué/ final outro lider",      // Nome do autor que aparece abaixo do título
    
    // CAMINHO DA IMAGEM: Esta imagem fica no fundo quando o capítulo abre
    background: "./imagens/josue_bg.jpg", 
    ...
    // ───────────────────────────────────────────────────────────────────────────
    capitulos: {
        // --- INÍCIO DO CAPÍTULO 1 DE JOSUÉ ---
        // --- CONTINUAÇÃO DO CAPÍTULO 1 DE JOSUÉ ---
        1: {
            titulo: "A Sucessão e a Coragem de Josué",
            subtitulo: "A ordem de Deus para atravessar o Jordão e a promessa de vitória",
...
⁴ Desde o deserto e o Líbano, até ao grande rio, o rio Eufrates, toda a terra dos heteus, e até ao grande mar para o poente do sol, será o vosso termo.
...
⁹ Não mo ordenei eu? Esforça-te, e tem bom ânimo; não temas, nem te espantes; porque o SENHOR teu Deus é contigo, por onde quer que andares.
¹⁰ Então deu Josué ordem aos oficiais do povo, dizendo:
¹¹ Passai pelo meio do arraial e ordenai ao povo, dizendo: Provende-vos de comida, porque dentro de três dias passareis este Jordão, para que entreis a possuir a terra que vos dá o SENHOR vosso Deus, para a possuirdes.
...
¹⁵ até que o SENHOR dê descanso a vossos irmãos, como a vós, e eles também possuam a terra que o SENHOR vosso Deus lhes dá; então tornareis à terra da vossa possessão e possuireis a que vos deu Moisés, o servo do SENHOR, desta banda do Jordão, para o nascente do sol.
...
¹⁸ Todo homem que for rebelde à tua ordem e não ouvir as tuas palavras em tudo quanto lhe mandares morrerá. Tão-somente esforça-te e tem bom ânimo.
`,

            // O DESAFIO
            pergunta: {
                texto: "Qual foi a principal instrução dada por Deus a Josué no versículo 8 para garantir que seu caminho prosperasse?",
                opcoes: [
                    { numero: 1, texto: "Reunir o exército mais numeroso de Canaã", correta: false },
                    { numero: 2, texto: "Construir um novo tabernáculo no monte Nebo", correta: false },
                    { numero: 3, texto: "Meditar no livro da lei dia e noite e não se afastar dele", correta: true },
                    { numero: 4, texto: "Enviar espias imediatamente para Jericó", correta: false }
                ],
                explicacao: "Josué 1:8 - O sucesso de Josué não estava baseado apenas em estratégia militar, mas na obediência e meditação constante na Lei de Deus.",
                pontosGanhos: 20
            }

        },
        2: {
            titulo: "Raabe e os Espias em Jericó",
            subtitulo: "A missão secreta e o pacto de proteção em Jericó",

            texto: `
¹ E enviou Josué, filho de Num, dois homens desde Sitim a espiar secretamente, dizendo: Ide, observai a terra e a Jericó. Foram, pois, e entraram na casa de uma mulher prostituta, cujo nome era Raabe, e dormiram ali.
...
³ Por isso enviou o rei de Jericó a Raabe, dizendo: Tira fora os homens que vieram a ti e entraram na tua casa, porque vieram espiar toda a terra.
...
⁷ E foram-se aqueles homens após eles pelo caminho do Jordão, até aos vaus; e, saindo os que iam após eles, fechou-se a porta.
⁸ E, antes que eles dormissem, ela subiu a eles ao telhado;
...
¹¹ E, ouvindo isso, desmaiou o nosso coração, e em ninguém mais há ânimo algum, por causa da vossa presença; porque o Senhor vosso Deus é Deus em cima nos céus e embaixo na terra.
¹² Agora, pois, jurai-me pelo Senhor que, assim como usei de benevolência convosco, também vós usareis de benevolência com a casa de meu pai; e dai-me um sinal seguro,
¹³ de que dareis vida a meu pai e a minha mãe, como também a meus irmãos e a minhas irmãs, com tudo quanto têm, e de que livrareis as nossas vidas da morte.
¹⁴ Então aqueles homens lhe responderam: A nossa vida responderá pela vossa, até à morte; se não denunciardes este nosso negócio, acontecerá que, dando-nos o Senhor esta terra, usaremos contigo de benevolência e fidelidade.
¹⁵ Ela, pois, os fez descer por uma corda pela janela; porquanto a sua casa estava sobre o muro da cidade, e morava sobre o muro.
¹⁶ E disse-lhes: Ide-vos ao monte, para que porventura vos não encontrem os que vos seguem; e escondei-vos ali três dias, até que tornem os que vos seguem; depois, ide pelo vosso caminho.
¹⁷ E disseram-lhe aqueles homens: Desobrigados seremos deste teu juramento, que nos fizeste jurar,
¹⁸ se, entrando nós na terra, não atares este cordão de fio de escarlata à janela por onde nos fizeste descer; e não recolheres em casa contigo teu pai, e tua mãe, e teus irmãos, e toda a família de teu pai.
¹⁹ Será, pois, que qualquer que sair fora da porta de tua casa, o seu sangue será sobre a sua cabeça, e nós seremos inocentes; mas qualquer que estiver contigo em casa, o seu sangue será sobre a nossa cabeça, se alguma mão for contra ele.
²⁰ Porém, se denunciares este nosso negócio, seremos desobrigados do teu juramento, que nos fizeste jurar.
...
²² Foram-se, pois, e chegaram ao monte, e ficaram ali três dias, até que voltaram os que os seguiam; e buscaram-nos por todo o caminho, porém não os acharam.
...
²⁴ E disseram a Josué: Verdadeiramente o Senhor tem dado toda esta terra na nossa mão; porque até todos os moradores da terra estão desmaiados diante de nós.`,
            // O DESAFIO
            pergunta: {
                texto: "Onde Raabe escondeu os dois espias enviados por Josué quando os mensageiros do rei de Jericó foram procurá-los?",
                opcoes: [
                    { numero: 1, texto: "Dentro de um poço seco no quintal", correta: false },
                    { numero: 2, texto: "No telhado, entre as canas de linho", correta: true },
                    { numero: 3, texto: "Em uma caverna fora das muralhas", correta: false },
                    { numero: 4, texto: "Debaixo de tapetes em seu quarto", correta: false }
                ],
                explicacao: "Josué 2:6 - Raabe levou os homens ao eirado (telhado) e os escondeu sob as hastes de linho que ali havia espalhado.",
                pontosGanhos: 20
            }
        },
        3: {
            titulo: "A Travessia do Jordão",
            subtitulo: "Deus abre as águas e o povo de Israel passa a seco",
...
⁴ Contudo, haja distância entre vós e ela como da medida de dois mil côvados; e não vos chegueis a ela, para que saibais o caminho pelo qual haveis de ir; porquanto por este caminho nunca passastes antes.
⁵ Disse Josué também ao povo: Santificai-vos, porque amanhã fará o SENHOR maravilhas no meio de vós.
⁶ E falou Josué aos sacerdotes, dizendo: Levantai a arca do concerto e passai adiante deste povo. Levantaram, pois, a arca do concerto e foram adiante do povo.
⁷ E o SENHOR disse a Josué: Hoje começarei a engrandecer-te perante os olhos de todo o Israel, para que saibam que, como fui com Moisés, assim serei contigo.
...
¹³ porque há de ser que, assim que as plantas dos pés dos sacerdotes que levam a arca do SENHOR, o Senhor de toda a terra, pousem nas águas do Jordão, se separarão as águas do Jordão, e as águas que vêm de cima pararão num montão.
...
¹⁶ pararam as águas que vinham de cima; levantaram-se num montão, mui longe da cidade de Adã, que está da banda de Sartã; e as que desciam ao mar das planícies, que é o mar Salgado, foram de todo cortadas; então, passou o povo defronte de Jericó.
...
`,
            ...
            // O DESAFIO
            pergunta: {
                texto: "O que aconteceu com as águas do Jordão no momento em que os sacerdotes que carregavam a arca tocaram os pés na borda do rio?",
                opcoes: [
                    { numero: 1, texto: "As águas secaram por causa do calor intenso", correta: false },
                    { numero: 2, texto: "As águas que vinham de cima pararam e se levantaram num montão", correta: true },
                    { numero: 3, texto: "O rio mudou de curso para o deserto", correta: false },
                    { numero: 4, texto: "As águas tornaram-se vermelhas como sangue", correta: false }
                ],
                explicacao: "Josué 3:15-16 - Assim que os pés dos sacerdotes se molharam na borda das águas, as águas que vinham de cima pararam e se amontoaram, permitindo a travessia em seco.",
                pontosGanhos: 20
            }
        },
        4: {
            titulo: "As Doze Pedras Memoriais",
            subtitulo: "O monumento no Jordão para as futuras gerações",
...
³ e mandai-lhes, dizendo: Tirai daqui, do meio do Jordão, do lugar onde pararam firmes os pés dos sacerdotes, doze pedras; e levai-as convosco e depositai-as no alojamento onde passardes esta noite.
⁴ Chamou, pois, Josué os doze homens que escolherá dos filhos de Israel, de cada tribo um homem;
⁵ e disse-lhes Josué: Passai diante da arca do SENHOR, vosso Deus, ao meio do Jordão; e cada um levante uma pedra sobre o seu ombro, conforme o número das tribos dos filhos de Israel;
...
⁷ Então, lhes direis que as águas do Jordão se separaram diante da arca do concerto do SENHOR; passando ela o Jordão, separaram-se as águas do Jordão; assim que estas pedras serão para sempre por memorial aos filhos de Israel.
⁸ Fizeram, pois, os filhos de Israel assim como Josué tinha ordenado, e levantaram doze pedras do meio do Jordão, como o SENHOR dissera a Josué, conforme o número das tribos dos filhos de Israel; e levaram-nas consigo ao alojamento e as depositaram ali.
⁹ Levantou Josué também doze pedras no meio do Jordão, no lugar onde pararam os pés dos sacerdotes que levavam a arca do concerto; e ali estão até ao dia de hoje.
¹⁰ Pararam, pois, os sacerdotes que levavam a arca no meio do Jordão, até que se cumpriu tudo quanto o SENHOR ordenara a Josué que dissesse ao povo, conforme tudo quanto Moisés ordenara a Josué; e apressou-se o povo e passou.
¹¹ E sucedeu que, acabando todo o povo de passar, então, passou a arca do SENHOR, e os sacerdotes, à vista do povo.
...
¹⁸ E aconteceu que, subindo os sacerdotes que levavam a arca do concerto do SENHOR do meio do Jordão, e as plantas dos pés dos sacerdotes se pondo em seco, as águas do Jordão se tornaram ao seu lugar e corriam sobre todas as suas ribanceiras, como dantes.
¹⁹ O povo, pois, subiu do Jordão aos dez do mês primeiro; e acamparam-se em Gilgal, da banda do oriente de Jericó.
²⁰ E as doze pedras que tinham tomado do Jordão levantou-as Josué em Gilgal.
²¹ E falou aos filhos de Israel, dizendo: Quando vossos filhos no futuro perguntarem a seus pais, dizendo: Que significam estas pedras?
²² Fareis saber a vossos filhos, dizendo: Israel passou este Jordão em seco.
²³ Porque o SENHOR, vosso Deus, fez secar as águas do Jordão diante de vós, até que passásseis, como o SENHOR, vosso Deus, fez ao mar Vermelho, que fez secar perante nós, até que passámos;
²⁴ para que todos os povos da terra conheçam a mão do SENHOR, que é forte, para que temais ao SENHOR, vosso Deus, todos os dias.
`,

            // O DESAFIO
            pergunta: {
                texto: "Qual era o propósito principal das doze pedras que Josué ordenou que fossem tiradas do meio do rio Jordão?",
                opcoes: [
                    { numero: 1, texto: "Servir de material para a construção de um novo altar de sacrifícios", correta: false },
                    { numero: 2, texto: "Marcar o local exato onde Jericó deveria ser atacada", correta: false },
                    { numero: 3, texto: "Servir como um memorial eterno para que as futuras gerações soubessem que o Senhor secou o Jordão", correta: true },
                    { numero: 4, texto: "Serem usadas como armas na primeira batalha contra os cananeus", correta: false }
                ],
                explicacao: "Josué 4:6-7 - As pedras foram colocadas como um sinal e memorial para que, quando os filhos perguntassem sobre elas, a história do milagre do Jordão fosse contada.",
                pontosGanhos: 20
            }
        },
        5: {
            titulo: "A Circuncisão e a Páscoa em Gilgal",
            subtitulo: "A nova geração é consagrada e o Príncipe do Exército do Senhor aparece",

            texto: `
¹ E sucedeu que, ouvindo todos os reis dos amorreus, que estavam da banda do Jordão, ao ocidente, e todos os reis dos cananeus, que estavam ao pé do mar, que o SENHOR tinha secado as águas do Jordão, diante dos filhos de Israel, até que passássemos, desmaiou-se-lhes o coração, e não houve mais espírito neles, por causa dos filhos de Israel.
² Naquele tempo, disse o SENHOR a Josué: Faz facas de pedra, e torna a circuncidar segunda vez aos filhos de Israel.
³ Então, Josué fez facas de pedra e circuncidou aos filhos de Israel no outeiro dos prepúcios.
⁴ E foi esta a causa por que Josué os circuncidou: todo o povo que tinha saído do Egito, os varões, todos os homens de guerra, eram mortos no deserto, pelo caminho, depois que saíram do Egito.
⁵ Porque todo o povo que saíra estava circuncidado, mas a todo o povo que nascera no deserto, pelo caminho, depois que saíram do Egito, não o haviam circuncidado.
...
⁷ Porém em seu lugar pôs a seus filhos; a estes Josué circuncidou, porquanto estavam incircuncisos, porque os não circuncidaram pelo caminho.
⁸ E aconteceu que, acabando de circuncidar toda a gente, ficaram no seu lugar no arraial, até que sararam.
⁹ Disse mais o SENHOR a Josué: Hoje tirei de sobre vós o opróbrio do Egito; pelo que o nome daquele lugar se chamou Gilgal, até ao dia de hoje.
¹⁰ E acamparam-se os filhos de Israel em Gilgal e celebraram a Páscoa no dia catorze do mês, à tarde, nas campinas de Jericó.
...
¹⁵ Então, disse o príncipe do exército do SENHOR a Josué: Descalça os sapatos de teus pés, porque o lugar que pisas é santo. E fez Josué assim.
`,

            // O DESAFIO
            pergunta: {
                texto: "O que aconteceu em relação à provisão de alimento dos israelitas logo após eles comerem do fruto da terra de Canaã?",
                opcoes: [
                    { numero: 1, texto: "O maná começou a cair em dobro para estocar", correta: false },
                    { numero: 2, texto: "O maná cessou e eles passaram a comer dos frutos da terra", correta: true },
                    { numero: 3, texto: "Deus enviou codornizes como no deserto", correta: false },
                    { numero: 4, texto: "Eles jejuaram por sete dias antes de colher", correta: false }
                ],
                explicacao: "Josué 5:12 - O maná, que sustentou o povo por 40 anos no deserto, cessou assim que eles começaram a usufruir do sustento vindo da terra prometida.",
                pointsGanhos: 20
            }
        },
        6: {
            titulo: "A Queda de Jericó",
            subtitulo: "O cerco, as sete voltas e o milagre das muralhas",

            texto: `
¹ Ora, Jericó estava mui fechada e cerrada por causa dos filhos de Israel; ninguém saía nem entrava.
...
⁴ E sete sacerdotes levarão sete buzinas de chifres de carneiros diante da arca, e no sétimo dia rodeareis a cidade sete vezes, e os sacerdotes tocarão as buzinas.
⁵ E será que, tocando-se longamente a buzina de chifre de carneiro, ouvindo vós o som da buzina, todo o povo gritará com grande grito; e o muro da cidade cairá abaixo, e o povo subirá, cada qual em frente de si.
⁶ Então, chamou Josué, filho de Num, aos sacerdotes e disse-lhes: Levantai a arca do concerto; e sete sacerdotes levem sete buzinas de chifres de carneiros diante da arca do SENHOR.
⁷ E disse ao povo: Passai e rodeai a cidade; e quem estiver armado passe adiante da arca do SENHOR.
⁸ E assim foi que, como Josué dissera ao povo, os sete sacerdotes, levando as sete buzinas de chifres de carneiros diante do SENHOR, passaram e tocaram as buzinas; e a arca do concerto do SENHOR os seguia.
...
¹¹ E fez a arca do SENHOR rodear a cidade, rodeando-a uma vez; e vieram ao arraial e pernoitaram no arraial.
¹² Depois, Josué se levantou de madrugada, e os sacerdotes levantaram a arca do SENHOR.
¹³ E os sete sacerdotes, que levavam as sete buzinas de chifres de carneiros diante da arca do SENHOR, iam andando e tocavam as buzinas; e os homens armados iam adiante deles, e a retaguarda seguia após a arca do SENHOR; andando e tocando as buzinas iam os sacerdotes.
¹⁴ Assim rodearam a cidade outra vez no segundo dia e voltaram para o arraial; e assim fizeram por seis dias.
...
¹⁸ Tão-somente guardai-vos do anátema, para que não toqueis em coisa alguma anátema, tomando dela, e façais anátema o arraial de Israel, e o turbeis.
¹⁹ Porém toda a prata, e o ouro, e os utensílios de metal e de ferro são consagrados ao SENHOR; irão ao tesouro do SENHOR.
²⁰ Gritou, pois, o povo, tocando os sacerdotes as buzinas; e sucedeu que, ouvindo o povo o som da buzina, gritou o povo com grande grito; e o muro caiu abaixo, e o povo subiu à cidade, cada qual em frente de si, e tomaram a cidade.
²¹ E tudo quanto na cidade havia destruíram totalmente a fio de espada, desde o homem até à mulher, desde o menino até ao velho, e até ao boi e gado miúdo, e ao jumento.
...
²³ Então, entraram os jovens espias e tiraram a Raabe, e a seu pai, e a sua mãe, e a seus irmãos, e a tudo quanto tinha; tiraram também a todas as suas famílias e puseram-nos fora do arraial de Israel.
²⁴ Porém a cidade e tudo quanto havia nela queimaram a fogo; tão-somente a prata, e o ouro, e os utensílios de metal e de ferro deram para o tesouro da Casa do SENHOR.
²⁵ Assim, deu Josué vida à prostituta Raabe, e à família de seu pai, e a tudo quanto tinha; e habitou no meio de Israel até ao dia de hoje, porquanto escondera os mensageiros que Josué enviara a espiar a Jericó.
²⁶ E, naquele tempo, Josué os esconjurou, dizendo: Maldito diante do SENHOR seja o homem que se levantar e edificar esta cidade de Jericó; perdendo o seu primogênito a fundará e perdendo o seu mais novo lhe porá as portas.
²⁷ Assim, era o SENHOR com Josué; e corria a sua fama por toda a terra.
`,

            // O DESAFIO
            pergunta: {
                texto: "Quantas vezes o povo rodeou a cidade de Jericó no sétimo dia, antes que os muros caíssem?",
                opcoes: [
                    { numero: 1, texto: "Apenas uma vez, como nos dias anteriores", correta: false },
                    { numero: 2, texto: "Três vezes, representando a Trindade", correta: false },
                    { numero: 3, texto: "Sete vezes", correta: true },
                    { numero: 4, texto: "Doze vezes, uma para cada tribo", correta: false }
                ],
                explicacao: "Josué 6:15 - No sétimo dia, o povo madrugou e rodeou a cidade sete vezes, sendo esta a única vez em que fizeram mais de uma volta no mesmo dia.",
                pontosGanhos: 20
            }
        },
        7: {
            titulo: "O Pecado de Acã e a Derrota em Ai",
            subtitulo: "A desobediência ao anátema e a consequência para o povo de Israel",
...
³ E voltaram a Josué e disseram-lhe: Não suba todo o povo; subam alguns dois mil ou três mil homens a ferir a Ai; não fatigueis ali a todo o povo, porque poucos são os inimigos.
⁴ Assim, subiram lá do povo alguns três mil homens, os quais fugiram diante dos homens de Ai.
⁵ E os homens de Ai feriram deles uns trinta e seis, e perseguiram-nos desde a porta até Sebarim, e feriram-nos na descida; e o coração do povo se derreteu e se tornou como água.
...
⁷ E disse Josué: Ah! Senhor JEOVÁ! Por que fizeste a este povo passar o Jordão, para nos entregares nas mãos dos amorreus, para nos fazerem perecer? Antes nos tivéssemos contentado com ficarmos dalém do Jordão.
⁸ Ah, Senhor! Que direi, pois que Israel voltou as costas diante dos seus inimigos?
...
¹⁰ Então, disse o SENHOR a Josué: Levanta-te! Por que estás prostrado sobre o teu rosto?
...
¹² Pelo que os filhos de Israel não poderão subsistir perante os seus inimigos; voltarão as costas diante dos seus inimigos, porquanto são anátema; não serei mais convosco, se não desarraigardes o anátema do meio de vós.
¹³ Levanta-te, santifica o povo e dize: Santificai-vos para amanhã, porque assim diz o SENHOR, o Deus de Israel: Anátema há no meio de ti, Israel; diante dos teus inimigos não poderás subsistir, até que tireis o anátema do meio de vós.
...
¹⁵ E será que aquele que for tomado com o anátema será queimado a fogo, ele e tudo quanto tiver, porquanto transgrediu o concerto do SENHOR e fez loucura em Israel.
¹⁶ Então, Josué se levantou de madrugada e fez chegar a Israel, segundo as suas tribos; e a tribo de Judá foi tomada.
¹⁷ E, fazendo chegar a família de Judá, tomou a família de Zerá; e, fazendo chegar a família de Zerá, homem por homem, foi tomado Zabdi;
...
²¹ Vi entre os despojos uma boa capa babilônica, e duzentos siclos de prata, e uma cunha de ouro do peso de cinquenta siclos; e cobicei-os e tomei-os; e eis que estão escondidos na terra, no meio da minha tenda, e a prata, debaixo dela.
...
²³ Tomaram, pois, aquelas coisas do meio da tenda, e as trouxeram a Josué e a todos os filhos de Israel, e as puseram diante do SENHOR.
...
²⁶ E levantaram sobre ele um grande montão de pedras, até ao dia de hoje; e o SENHOR se aplacou do ardor da sua ira; pelo que se chamou o nome daquele lugar o vale de Acor, até ao dia de hoje.
`,

            // O DESAFIO
            pergunta: {
                texto: "Quais itens Acã confessou ter roubado e escondido em sua tenda?",
                opcoes: [
                    { numero: 1, texto: "Uma armadura real e cavalos egípcios", correta: false },
                    { numero: 2, texto: "Uma capa babilônica, prata e uma cunha de ouro", correta: true },
                    { numero: 3, texto: "Idolos de madeira e vasos de bronze", correta: false },
                    { numero: 4, texto: "Especiarias raras e tecidos de púrpura", correta: false }
                ],
                explicacao: "Josué 7:21 - Acã admitiu ter cobiçado e tomado uma capa babilônica, 200 siclos de prata e uma cunha de ouro de 50 siclos.",
                pontosGanhos: 20
            }
        },
        8: {
            titulo: "Conquista de Ai",
            texto: `¹ Então disse o Senhor a Josué: Não temas, e não te espantes: toma contigo toda a gente de guerra, e levanta-te, sobe a Ai: olha que te tenho dado na tua mão o rei de Ai, e o seu povo, e a sua cidade, e a sua terra. 
...
¹⁴ E sucedeu que, vendo-o o rei de Ai, se apressaram, e se levantaram de madrugada, e os homens da cidade saíram ao encontro de Israel ao combate, ele e todo o seu povo, ao tempo assinalado, perante as campinas: porque ele não sabia que se lhe houvesse posto emboscada detrás da cidade. 
...
²² Também aqueles da cidade lhes saíram ao encontro, e assim ficaram no meio dos israelitas, uns de uma, e outros de outra parte: feriram-nos, até que nenhum deles ficou, que escapasse. 
...
²⁵ E todos os que caíram aquele dia, assim homens como mulheres, foram doze mil: todos os moradores de Ai. 
...
³¹ Como Moisés, servo do Senhor, ordenou aos filhos de Israel, conforme ao que está escrito no livro da lei de Moisés, a saber: um altar de pedras inteiras, sobre o qual se não movera ferro: e ofereceram sobre ele holocaustos ao Senhor, e sacrificaram sacrifícios pacíficos. 
...
³⁵ Palavra nenhuma houve, de tudo o que Moisés ordenara, que Josué não lesse perante toda a congregação de Israel, e das mulheres, e dos meninos, e dos estrangeiros que andavam no meio deles.`,
            pergunta: {
                texto: "Qual foi a estratégia para conquistar Ai?",
                opcoes: [
                    { numero: 1, texto: "Uma emboscada", correta: true },
                    { numero: 2, texto: "Marchar ao redor da cidade", correta: false },
                    { numero: 3, texto: "Escalar os muros", correta: false },
                    { numero: 4, texto: "Cavar túneis", correta: false }
                ],
                explicacao: "Josué usou uma emboscada para conquistar a cidade de Ai.",
                pontosGanhos: 20,
                versiculoReferencia: "Josué 8:1-29"
            }
        },
        9: {
            titulo: "Tratado com os Gibeonitas",
            texto: `1 E SUCEDEU que, ouvindo isto todos os reis que estavam daquém do Jordão, nas montanhas e nas campinas, em toda a costa do grande mar, em frente do Líbano, os heteus e os amorreus, os cananeus, os pereseus, os heveus e os jebuseus, 
2Se ajuntaram eles, de comum acordo, para pelejar contra Josué e contra Israel. 
3E os moradores de Gibeon, ouvindo o que Josué fizera com Jericó e com Ai, 
4Usaram de astúcia, e foram e se fingiram embaixadores; e tomaram sacos velhos sobre os seus jumentos, e odres de vinho velhos, e rotos, e remendados; 
5E nos seus pés, sapatos velhos e remendados, e vestidos velhos sobre si, e todo o pão que traziam para o caminho era seco e bolorento. 
6E vieram a Josué, ao arraial, a Gilgal, e lhe disseram, a ele e aos homens de Israel: Vimos de uma terra distante; fazei, pois, agora, concerto connosco. 
7E os homens de Israel responderam aos heveus: Porventura habitais no meio de nós; como, pois, faremos concerto convosco? 
8Então disseram a Josué: Nós somos teus servos. E disse-lhes Josué: Quem sois vós, e de onde vindes? 
9E lhe responderam: Teus servos vieram de uma terra mui distante, por causa do nome do Senhor, teu Deus; porquanto ouvimos a sua fama, e tudo quanto fez no Egito; 
10E tudo quanto fez aos dois reis dos amorreus, que estavam dalém do Jordão, a Seón, rei de Hesbon, e a Og, rei de Basan, que estava em Astaroth. 
11Pelo que os nossos anciãos, e todos os moradores da nossa terra, nos falaram, dizendo: Tomai convosco nas vossas mãos provisão para o caminho, e ide-lhes ao encontro; e dizei-lhes: Nós somos vossos servos; fazei, pois, agora, concerto connosco. 
12Este nosso pão tomámos quente das nossas casas, para nossa provisão, no dia em que saímos para vir a vós; e ei-lo aqui, agora, já seco e bolorento: 
13E estes odres, que enchemos de vinho, eram novos, e ei-los aqui já rotos: e estes nossos vestidos e nossos sapatos já se têm envelhecido, por causa do mui longo caminho. 
14Então aqueles homens tomaram da sua provisão; e não pediram conselho à boca do Senhor. 
15E Josué fez paz com eles, e fez um concerto com eles, que lhes daria a vida: e os príncipes da congregação lhes prestaram juramento. 
16E sucedeu que, ao fim de três dias, depois de fazerem concerto com eles, ouviram que eram seus vizinhos, e que moravam no meio deles. 
17Porque, partindo os filhos de Israel, chegaram às suas cidades ao terceiro dia: e suas cidades eram Gibeon, e Cefira, e Beeroth, e Quiriath-Jearim. 
18E os filhos de Israel não os feriram; porquanto os príncipes da congregação lhes juraram pelo Senhor, Deus de Israel: pelo que, toda a congregação murmurava contra os príncipes. 
19Então todos os príncipes disseram a toda a congregação: Nós jurámos-lhes pelo Senhor, Deus de Israel; pelo que não podemos tocar-lhes. 
20Isto, porém, lhes faremos: dar-lhes-emos a vida; para que não haja grande ira sobre nós, por causa do juramento que já lhes temos jurado. 
21Disseram-lhes, pois, os príncipes: Vivam, e sejam rachadores de lenha e tiradores de água, para toda a congregação, como os príncipes lhes têm dito.
22E Josué os chamou, e falou-lhes, dizendo: Por que nos enganastes, dizendo: Mui longe de vós habitamos, morando vós no meio de nós?
23Agora, pois, sereis malditos; e de entre vós não deixará de haver servos, nem rachadores de lenha, nem tiradores de água, para a casa do meu Deus. 
24Então responderam a Josué, e disseram: Porquanto, com certeza, foi anunciado aos teus servos que o Senhor, teu Deus, ordenou a Moisés, seu servo, que vos desse toda esta terra, e destruisse todos os moradores da terra diante de vós, tememos muito pelas nossas vidas, por causa de vós; por isso fizemos assim. 
25E eis que, agora, estamos na tua mão: faze aquilo que te pareça bom e reto que se nos faça. 
26Assim, pois, lhes fez; e livrou-os das mãos dos filhos de Israel, e não os mataram. 
27E, naquele dia, Josué os deu como rachadores de lenha e tiradores de água para a congregação e para o altar do Senhor, até ao dia de hoje, no lugar que escolhesse.`,
            pergunta: {
                texto: "Como os gibeonitas enganaram Josué?",
                opcoes: [
                    { numero: 1, texto: "Fingindo vir de longe com roupas rasgadas", correta: true },
                    { numero: 2, texto: "Dizendo que eram reis", correta: false },
                    { numero: 3, texto: "Oferecendo ouro", correta: false },
                    { numero: 4, texto: "Trazendo servos", correta: false }
                ],
                explicacao: "Os gibeonitas enganaram Josué fingindo serem de uma terra distante.",
                pontosGanhos: 20,
                versiculoReferencia: "Josué 9:4-6"
            }
        },
        10: {
            titulo: "Batalha de Gibeom",
            texto: `
...
³³ Então, Horão, rei de Gezer, subiu a ajudar a Laquis; porém Josué o feriu, a ele e ao seu povo, até que`,
            pergunta: {
                texto: "O que Josué pediu a Deus durante a batalha de Gibeom?",
                opcoes: [
                    { numero: 1, texto: "Que o sol parasse", correta: true },
                    { numero: 2, texto: "Que chovesse fogo", correta: false },
                    { numero: 3, texto: "Que o vento parasse", correta: false },
                    { numero: 4, texto: "Que os inimigos adormecessem", correta: false }
                ],
                explicacao: "Josué pediu que o sol parasse para completar a vitória.",
                pontosGanhos: 20,
                versiculoReferencia: "Josué 10:12"
            }
        },
        11: {
            titulo: "Derrota de Jabin",
            texto: `
...
²³ Assim, Josué tomou toda esta terra conforme tudo o que o Senhor tinha dito a Moisés; e Josué a deu em herança aos filhos de Israel, conforme as suas divisões, conforme as suas tribos; e a terra repousou da  

Josué 11:1-23`,
            pergunta: {
                texto: "Quem era Jabin?",
                opcoes: [
                    { numero: 1, texto: "Rei de Hazor", correta: true },
                    { numero: 2, texto: "Rei de Jericó", correta: false },
                    { numero: 3, texto: "Rei de Gibeom", correta: false },
                    { numero: 4, texto: "Rei do Egito", correta: false }
                ],
                explicacao: "Jabin era rei de Hazor e liderou uma coalizão contra Israel.",
                pontosGanhos: 20,
                versiculoReferencia: "Josué 11:1"
            }
        },
        12: {
            titulo: "Resumo dos Reis Vencidos",
            texto: `
...
²⁴ o rei de Tirza, outro; trinta e um reis ao todo `,
            pergunta: {
                texto: "Quantos reis foram vencidos em total?",
                opcoes: [
                    { numero: 1, texto: "31 reis", correta: true },
                    { numero: 2, texto: "21 reis", correta: false },
                    { numero: 3, texto: "41 reis", correta: false },
                    { numero: 4, texto: "15 reis", correta: false }
                ],
                explicacao: "Um total de 31 reis foram vencidos durante as conquistas de Josué.",
                pontosGanhos: 20,
                versiculoReferencia: "Josué 12:24"
            }
        },
        13: {
            titulo: "Distribuição da Terra",
            texto: `
...
Josué 13:1-33`,
            pergunta: {
                texto: "Qual tribo recebeu a herança leste do Jordão?",
                opcoes: [
                    { numero: 1, texto: "Rúben, Gade e Manassés", correta: true },
                    { numero: 2, texto: "Judá e Benjamim", correta: false },
                    { numero: 3, texto: "Efraim e Issacar", correta: false },
                    { numero: 4, texto: "Simeão e Levi", correta: false }
                ],
                explicacao: "Rúben, Gade e meia tribo de Manassés receberam terras a leste do Jordão.",
                pontosGanhos: 20,
                versiculoReferencia: "Josué 13:8"
            }
        },
        14: {
            titulo: "Herança de Judá e Calebe",
            texto: `
...
¹² Agora, pois, dá-me este monte de que o Senhor falou aquele dia; pois, naquele dia, tu ouviste que os anaquins estão ali, grandes e fortes cidades há ali; porventura, o Senhorserá comigo, para os expelir, como o Senhor disse.
...
`,
            pergunta: {
                texto: "Por quanto tempo Calebe esperou pela sua herança?",
                opcoes: [
                    { numero: 1, texto: "45 anos", correta: true },
                    { numero: 2, texto: "30 anos", correta: false },
                    { numero: 3, texto: "50 anos", correta: false },
                    { numero: 4, texto: "40 anos", correta: false }
                ],
                explicacao: "Calebe esperou 45 anos desde que foi enviado como espião até receber sua herança.",
                pontosGanhos: 20,
                versiculoReferencia: "Josué 14:10"
            }
        },
        15: {
            titulo: "Herança de Judá",
            texto: `
...
`,
            pergunta: {
                texto: "Qual cidade foi dada a Calebe?",
                opcoes: [
                    { numero: 1, texto: "Quiriate-Arba (Hebrom)", correta: true },
                    { numero: 2, texto: "Jerusalém", correta: false },
                    { numero: 3, texto: "Belém", correta: false },
                    { numero: 4, texto: "Jericó", correta: false }
                ],
                explicacao: "Calebe recebeu Quiriate-Arba, também conhecida como Hebrom.",
                pontosGanhos: 20,
                versiculoReferencia: "Josué 15:13"
            }
        },
        16: {
            titulo: "Herança de Efraim e Manassés",
            texto: `
...
`,
            pergunta: {
                texto: "Qual foi a herança dos filhos de José?",
                opcoes: [
                    { numero: 1, texto: "Efraim e Manassés", correta: true },
                    { numero: 2, texto: "Rúben e Simeão", correta: false },
                    { numero: 3, texto: "Judá e Benjamim", correta: false },
                    { numero: 4, texto: "Gade e Asser", correta: false }
                ],
                explicacao: "Os filhos de José, Efraim e Manassés, receberam herança em Canaã.",
                pontosGanhos: 20,
                versiculoReferencia: "Josué 16:1"
            }
        },
        17: {
            titulo: "Herança de Manassés",
            texto: `
...
`,
            pergunta: {
                texto: "Quem foram as filhas de Zelofeade?",
                opcoes: [
                    { numero: 1, texto: "Filhas que receberam herança por não ter irmãos homens", correta: true },
                    { numero: 2, texto: "Filhas do rei de Canaã", correta: false },
                    { numero: 3, texto: "Filhas de Moisés", correta: false },
                    { numero: 4, texto: "Filhas de Calebe", correta: false }
                ],
                explicacao: "As filhas de Zelofeade receberam herança porque não tinha irmãos homens.",
                pontosGanhos: 20,
                versiculoReferencia: "Josué 17:3-6"
            }
        },
        18: {
            titulo: "Herança de Benjamim",
            texto: `
...
⁷ Porquanto os levitas não têm parte no meio de vós, porém o sacerdócio do Senhoré a sua parte. E Gade, e Rúben, e a meia tribo de Manassés tomaram a sua herança dalém do Jordão para o oriente, a qual lhes deu Moisés, o servo do Senhor.
...
¹⁵ E a sua extensão para o sul estava 

`,
            pergunta: {
                texto: "Quantas tribos ainda não tinha recebido sua herança?",
                opcoes: [
                    { numero: 1, texto: "Sete tribos", correta: true },
                    { numero: 2, texto: "Três tribos", correta: false },
                    { numero: 3, texto: "Cinco tribos", correta: false },
                    { numero: 4, texto: "Nove tribos", correta: false }
                ],
                explicacao: "Sete tribos ainda não tinham recebido sua herança em Silo.",
                pontosGanhos: 20,
                versiculoReferencia: "Josué 18:2"
            }
        },
        19: {
            titulo: "Herança das Tribos Restantes",
            texto: `
...
`,
            pergunta: {
                texto: "Qual foi a última cidade dada a Josué?",
                opcoes: [
                    { numero: 1, texto: "Timnate-Sera", correta: true },
                    { numero: 2, texto: "Jerusalém", correta: false },
                    { numero: 3, texto: "Silo", correta: false },
                    { numero: 4, texto: "Gibeom", correta: false }
                ],
                explicacao: "Timnate-Sera foi a cidade dada a Josué como sua herança.",
                pontosGanhos: 20,
                versiculoReferencia: "Josué 19:50"
            }
        },
        20: {
            titulo: "Cidades de Refúgio",
            texto: `
...
Josué 20:1-9`,
            pergunta: {
                texto: "Qual era o propósito das cidades de refúgio?",
                opcoes: [
                    { numero: 1, texto: "Proteger o homicida involuntário", correta: true },
                    { numero: 2, texto: "Guardar o ouro do tabernáculo", correta: false },
                    { numero: 3, texto: "Treinar guerreiros", correta: false },
                    { numero: 4, texto: "Armazenar alimentos", correta: false }
                ],
                explicacao: "As cidades de refúgio protegiam aquele que matava alguém involuntariamente.",
                pontosGanhos: 20,
                versiculoReferencia: "Josué 20:2-3"
            }
        },
        21: {
            titulo: "Cidades para os Levitas",
            texto: `
...
`,
            pergunta: {
                texto: "Quantas cidades foram dadas aos levitas?",
                opcoes: [
                    { numero: 1, texto: "48 cidades", correta: true },
                    { numero: 2, texto: "32 cidades", correta: false },
                    { numero: 3, texto: "64 cidades", correta: false },
                    { numero: 4, texto: "40 cidades", correta: false }
                ],
                explicacao: "48 cidades foram dadas aos levitas para habitarem.",
                pontosGanhos: 20,
                versiculoReferencia: "Josué 21:41"
            }
        },
        22: {
            titulo: "Construção de um Altar",
            texto: `
...
³¹ E disse Fineias, filho de Eleazar, o sacerdote, aos filhos de Rúben, aos filhos de Gade, e aos filhos de Manassés: Hoje, sabemos que o Senhorestá no meio de nós; porquanto não cometestes transgressão contra o Senhor; agora, livrastes os filhos de Israel da mão do Senhor.
...
³⁴ E os filhos de Rúben e os filhos de Gade puseram no altar o nome Ede, para que seja testemunho entre nós que o Senhoré 

`,
            pergunta: {
                texto: "Por que as tribos do leste construíram um altar?",
                opcoes: [
                    { numero: 1, texto: "Como testemunho entre eles", correta: true },
                    { numero: 2, texto: "Para oferecer sacrifícios", correta: false },
                    { numero: 3, texto: "Para adorar ídolos", correta: false },
                    { numero: 4, texto: "Para guardar ouro", correta: false }
                ],
                explicacao: "O altar foi construído como testemunho da aliança entre as tribos.",
                pontosGanhos: 20,
                versiculoReferencia: "Josué 22:26-28"
            }
        },
        23: {
            titulo: "Admoestação de Josué",
            texto: `
...
¹⁰ Um só homem dentre vós perseguirá a mil, pois é o mesmoSenhor, vosso Deus, o que peleja por vós, como já vos tem dito.
...
`,
            pergunta: {
                texto: "Qual era a admoestação principal de Josué ao povo?",
                opcoes: [
                    { numero: 1, texto: "Guardar a lei de Moisés", correta: true },
                    { numero: 2, texto: "Conquistar mais terras", correta: false },
                    { numero: 3, texto: "Multiplicar seus cavalos", correta: false },
                    { numero: 4, texto: "Fazer alianças com pagãos", correta: false }
                ],
                explicacao: "Josué admoestou o povo a guardar a lei de Moisés e a Deus.",
                pontosGanhos: 20,
                versiculoReferencia: "Josué 23:6"
            }
        },
        24: {
            titulo: "Aliança em Siquém",
            texto: `
...
`,
            pergunta: {
                texto: "Qual foi o compromisso do povo com Josué?",
                opcoes: [
                    { numero: 1, texto: "Servir ao Senhor", correta: true },
                    { numero: 2, texto: "Servir aos reis de Canaã", correta: false },
                    { numero: 3, texto: "Abandonar a lei de Moisés", correta: false },
                    { numero: 4, texto: "Adorar ídolos", correta: false }
                ],
                explicacao: "O povo se comprometeu a servir ao Senhor com todo o seu coração.",
                pontosGanhos: 20,
                versiculoReferencia: "Josué 24:21"
            }
        }
    }
};

console.log('✅ Livro de Josué carregado!');