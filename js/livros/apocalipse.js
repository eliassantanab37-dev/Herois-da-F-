// js/livros/apocalipse.js (Parte 1: Capítulos 1-5)
const sortear = (lista) => lista[Math.floor(Math.random() * lista.length)];

export const apocalipse = {
    nome: "Apocalipse",
    icone: "👑", // Ícone sugerindo a realeza e a vitória final de Cristo
    autor: "João",
  //  background: "./imagens/apocalipse_bg.jpg", 
    ...
    capitulos: {
        1: {
            titulo: "A Visão do Filho do Homem",
            texto: `¹ Revelação de Jesus Cristo, a qual Deus lhe deu, para mostrar aos seus servos as coisas que brevemente devem acontecer; e pelo seu anjo as enviou, e as notificou a João seu servo;
...
²⁰ O mistério das sete estrelas, que viste na minha destra, e dos sete castiçais de ouro. As sete estrelas são os anjos das sete igrejas, e os sete castiçais, que viste, são as sete igrejas.
 ...
 `,
            get pergunta() {
                return sortear([
                    {
                        texto: "Bem-aventurado aquele que faz o quê em relação às palavras desta profecia?",
                        opcoes: [
                            { numero: 1, texto: "Apenas as guarda em segredo", correta: false },
                            { numero: 2, texto: "Aquele que lê, e os que ouvem e guardam as coisas nela escritas", correta: true },
                            { numero: 3, texto: "Aquele que as vende em livros", correta: false },
                            { numero: 4, texto: "Aquele que as ignora por medo", correta: false }
                        ],
                        explicacao: "Apocalipse 1:3 - Bem-aventurado aquele que lê, e os que ouvem as palavras desta profecia...",
                        pontosGanhos: 20
                    },
                    {
                        texto: "Onde João estava quando recebeu a revelação?",
                        opcoes: [
                            { numero: 1, texto: "Em Jerusalém", correta: false },
                            { numero: 2, texto: "No deserto do Saara", correta: false },
                            { numero: 3, texto: "Na ilha chamada Patmos", correta: true },
                            { numero: 4, texto: "Em Roma", correta: false }
                        ],
                        explicacao: "Apocalipse 1:9 - ...estava na ilha chamada Patmos, por causa da palavra de Deus...",
                        pontosGanhos: 20
                    },
                    {
                        texto: "O que Jesus diz ser no versículo 8?",
                        opcoes: [
                            { numero: 1, texto: "Um anjo de luz", correta: false },
                            { numero: 2, texto: "Um profeta como Moisés", correta: false },
                            { numero: 3, texto: "O início de uma nova era", correta: false },
                            { numero: 4, texto: "O Alfa e o Ômega, o princípio e o fim", correta: true }
                        ],
                        explicacao: "Apocalipse 1:8 - Eu sou o Alfa e o Ômega, o princípio e o fim, diz o Senhor...",
                        pontosGanhos: 20
                    }
                ]);
            }
        ...
        2: {
            titulo: "As Cartas às Igrejas (Parte 1)",
            texto: ` ¹ Escreve ao anjo da igreja de Éfeso: Isto diz aquele que tem na sua destra as sete estrelas, que anda no meio dos sete castiçais de ouro:
...
¹⁵ Assim tens também os que retém a doutrina dos nicolaítas, o que eu odeio.
...
¹⁹ Eu conheço as tuas obras, e amor, e serviço, e fé, e a tua paciência, e que as tuas últimas obras são mais do que as primeiras.
...
²³ E destruirei com morte a seus filhos, e todas as igrejas saberão que eu sou aquele que sonda as entranhas e os corações. E darei a cada um de vós segundo as vossas obras.
...
`,
            get pergunta() {
                return sortear([
                    {
                        texto: "Qual foi a queixa contra a igreja de Éfeso?",
                        opcoes: [
                            { numero: 1, texto: "Que eles eram pobres", correta: false },
                            { numero: 2, texto: "Que deixaste o teu primeiro amor", correta: true },
                            { numero: 3, texto: "Que eles não oravam", correta: false },
                            { numero: 4, texto: "Que eles fugiram da cidade", correta: false }
                        ],
                        explicacao: "Apocalipse 2:4 - Tenho, porém, contra ti que deixaste o teu primeiro amor.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "O que é prometido ao que vencer na igreja de Esmirna?",
                        opcoes: [
                            { numero: 1, texto: "Riquezas mundanas", correta: false },
                            { numero: 2, texto: "Uma viagem para Roma", correta: false },
                            { numero: 3, texto: "A coroa da vida", correta: true },
                            { numero: 4, texto: "Um palácio de ouro", correta: false }
                        ],
                        explicacao: "Apocalipse 2:10 - ...Sê fiel até à morte, e dar-te-ei a coroa da vida.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "Como deve ser a fidelidade de quem deseja receber a coroa da vida?",
                        opcoes: [
                            { numero: 1, texto: "Apenas nos momentos bons", correta: false },
                            { numero: 2, texto: "Apenas na frente de outros", correta: false },
                            { numero: 3, texto: "De vez em quando", correta: false },
                            { numero: 4, texto: "Sê fiel até à morte", correta: true }
                        ],
                        explicacao: "Apocalipse 2:10 - ...Sê fiel até à morte, e dar-te-ei a coroa da vida.",
                        pontosGanhos: 20
                    }
        ...
        3: {
            titulo: "As Cartas às Igrejas (Parte 2)",
            texto: ` ¹ E ao anjo da igreja que está em Sardes escreve: Isto diz o que tem os sete espíritos de Deus, e as sete estrelas: Conheço as tuas obras, que tens nome de que vives, e estás morto.
...
`,
            get pergunta() {
                return sortear([
                    {
                        texto: "O que Jesus diz à igreja de Laodiceia por ela ser morna?",
                        opcoes: [
                            { numero: 1, texto: "Que ele a amaria assim mesmo", correta: false },
                            { numero: 2, texto: "Estou a ponto de vomitar-te da minha boca", correta: true },
                            { numero: 3, texto: "Que ele daria mais riquezas", correta: false },
                            { numero: 4, texto: "Que ela era a melhor igreja", correta: false }
                        ],
                        explicacao: "Apocalipse 3:16 - Assim, porque és morno... estou a ponto de vomitar-te da minha boca.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "Eis que estou à porta e:",
                        opcoes: [
                            { numero: 1, texto: "Espero que você saia", correta: false },
                            { numero: 2, texto: "Vou embora se não abrir", correta: false },
                            { numero: 3, texto: "Bato", correta: true },
                            { numero: 4, texto: "Derrubo a entrada", correta: false }
                        ],
                        explicacao: "Apocalipse 3:20 - Eis que estou à porta, e bato; se alguém ouvir a minha voz, e abrir a porta, entrarei...",
                        pontosGanhos: 20
                    },
                    {
                        texto: "O que acontecerá se alguém abrir a porta para Jesus?",
                        opcoes: [
                            { numero: 1, texto: "Ele apenas deixará um presente", correta: false },
                            { numero: 2, texto: "Ele passará direto", correta: false },
                            { numero: 3, texto: "Ele enviará um anjo", correta: false },
                            { numero: 4, texto: "Entrarei em sua casa, e com ele cearei", correta: true }
                        ],
                        explicacao: "Apocalipse 3:20 - ...se alguém ouvir a minha voz, e abrir a porta, entrarei em sua casa, e com ele cearei, e ele comigo.",
                        pontosGanhos: 20
                    }
                ]);
            }
        ...
        4: {
            ...
            texto: ` ¹ Depois destas coisas, olhei, e eis que estava uma porta aberta no céu; e a primeira voz que, como de trombeta, ouvira falar comigo, disse: Sobe aqui, e mostrar-te-ei as coisas que depois destas devem acontecer.
...
`,
            get pergunta() {
                return sortear([
                    {
                        texto: "Quantos anciãos estavam assentados ao redor do trono?",
                        opcoes: [
                            { numero: 1, texto: "Doze", correta: false },
                            { numero: 2, texto: "Vinte e quatro", correta: true },
                            { numero: 3, texto: "Sete", correta: false },
                            { numero: 4, texto: "Cem", correta: false }
                        ],
                        explicacao: "Apocalipse 4:4 - E ao redor do trono havia vinte e quatro tronos... assentados vinte e quatro anciãos.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "O que os quatro animais não cessavam de dizer dia e noite?",
                        opcoes: [
                            { numero: 1, texto: "Justiça, Justiça, Justiça", correta: false },
                            { numero: 2, texto: "Glória ao homem", correta: false },
                            { numero: 3, texto: "Santo, Santo, Santo é o Senhor Deus", correta: true },
                            { numero: 4, texto: "Paz na terra", correta: false }
                        ],
                        explicacao: "Apocalipse 4:8 - ...não descansam nem de dia nem de noite, dizendo: Santo, Santo, Santo, é o Senhor Deus...",
                        pontosGanhos: 20
                    },
                    {
                        texto: "O que os anciãos lançavam diante do trono?",
                        opcoes: [
                            { numero: 1, texto: "Suas vestes", correta: false },
                            { numero: 2, texto: "Seus livros", correta: false },
                            { numero: 3, texto: "Palmas de louvor", correta: false },
                            { numero: 4, texto: "As suas coroas", correta: true }
                        ],
                        explicacao: "Apocalipse 4:10 - ...lançavam as suas coroas diante do trono, dizendo...",
                        pontosGanhos: 20
                    }
                ]);
            }
        ...
        5: {
            ...
            texto: ` ¹ E vi na destra do que estava assentado sobre o trono um livro escrito por dentro e por fora, selado com sete selos.
...
¹³ E ouvi a toda criatura que está no céu, e na terra, e debaixo da terra, e que estão no mar, e a todas as coisas que neles há, dizendo: Ao que está assentado sobre o trono, e ao Cordeiro, sejam dadas ações de graças, e honra, e glória, e poder para todo o sempre.
...
`,
            get pergunta() {
                return sortear([
                    {
                        texto: "Quem foi achado digno de abrir o livro e desatar os seus selos?",
                        opcoes: [
                            { numero: 1, texto: "Um anjo forte", correta: false },
                            { numero: 2, texto: "O Leão da tribo de Judá, a Raiz de Davi", correta: true },
                            { numero: 3, texto: "O apóstolo João", correta: false },
                            { numero: 4, texto: "Ninguém na terra", correta: false }
                        ],
                        explicacao: "Apocalipse 5:5 - ...eis que o Leão da tribo de Judá, a raiz de Davi, venceu para abrir o livro...",
                        pontosGanhos: 20
                    },
                    {
                        texto: "Como o Cordeiro apareceu no meio do trono?",
                        opcoes: [
                            { numero: 1, texto: "Como um guerreiro com espada", correta: false },
                            { numero: 2, texto: "Como um rei com coroa de ouro", correta: false },
                            { numero: 3, texto: "Como havendo sido morto", correta: true },
                            { numero: 4, texto: "Como uma pomba branca", correta: false }
                        ],
                        explicacao: "Apocalipse 5:6 - E olhei, e eis que estava no meio do trono... um Cordeiro, como havendo sido morto...",
                        pontosGanhos: 20
                    },
                    {
                        texto: "O que representavam as taças de ouro cheias de incenso?",
                        opcoes: [
                            { numero: 1, texto: "O perfume do céu", correta: false },
                            { numero: 2, texto: "As lágrimas dos apóstolos", correta: false },
                            { numero: 3, texto: "O ouro purificado", correta: false },
                            { numero: 4, texto: "As orações dos santos", correta: true }
                        ],
                        explicacao: "Apocalipse 5:8 - ...tendo cada um deles harpas e salvas de ouro cheias de incenso, que são as orações dos santos.",
                        pontosGanhos: 20
                    }
                ]);
            }
        ...
        6: {
            titulo: "Os Selos e os Cavaleiros",
            texto: `¹ E depois destas coisas vi quatro anjos que estavam sobre os quatro cantos da terra, retendo os quatro ventos da terra, para que nenhum vento soprasse sobre a terra, nem sobre o mar, nem contra árvore alguma.
...
¹⁷ Porque o Cordeiro que está no meio do trono os apascentará, e lhes servirá de guia para as fontes vivas das águas; e Deus limpará de seus olhos toda a lágrima.
 ...
 `,
            get pergunta() {
                return sortear([
                    {
                        texto: "O que o cavaleiro do cavalo branco carregava nas mãos?",
                        opcoes: [
                            { numero: 1, texto: "Uma grande espada", correta: false },
                            { numero: 2, texto: "Um arco", correta: true },
                            { numero: 3, texto: "Uma balança", correta: false },
                            { numero: 4, texto: "Uma foice", correta: false }
                        ],
                        explicacao: "Apocalipse 6:2 - E olhei, e eis um cavalo branco; e o que estava assentado sobre ele tinha um arco...",
                        pontosGanhos: 20
                    },
                    {
                        texto: "Qual era a cor do cavalo cujo cavaleiro tinha o nome de Morte?",
                        opcoes: [
                            { numero: 1, texto: "Preto", correta: false },
                            { numero: 2, texto: "Vermelho", correta: false },
                            { numero: 3, texto: "Branco", correta: false },
                            { numero: 4, texto: "Amarelo (ou Pálido)", correta: true }
                        ],
                        explicacao: "Apocalipse 6:8 - E olhei, e eis um cavalo amarelo, e o que estava assentado sobre ele tinha por nome Morte...",
                        pontosGanhos: 20
                    },
                    {
                        texto: "O que aconteceu quando o sexto selo foi aberto?",
                        opcoes: [
                            { numero: 1, texto: "Houve um grande terremoto e o sol se tornou negro", correta: true },
                            { numero: 2, texto: "O céu ficou azul brilhante", correta: false },
                            { numero: 3, texto: "Caiu mel das nuvens", correta: false },
                            { numero: 4, texto: "Apareceu um arco-íris duplo", correta: false }
                        ],
                        explicacao: "Apocalipse 6:12 - E, havendo aberto o sexto selo, olhei, e eis que houve um grande tremor de terra; e o sol tornou-se negro...",
                        pontosGanhos: 20
                    }
                ]);
            }
...
`,
            get pergunta() {
                return sortear([
                    {
                        texto: "Quantos foram selados de todas as tribos dos filhos de Israel?",
                        opcoes: [
                            { numero: 1, texto: "Doze mil", correta: false },
                            { numero: 2, texto: "Cento e quarenta e quatro mil", correta: true },
                            { numero: 3, texto: "Setenta mil", correta: false },
                            { numero: 4, texto: "Um milhão", correta: false }
                        ],
                        explicacao: "Apocalipse 7:4 - E ouvi o número dos selados, e eram cento e quarenta e quatro mil selados...",
                        pontosGanhos: 20
                    },
                    {
                        texto: "De onde vinha a grande multidão que ninguém podia contar?",
                        opcoes: [
                            { numero: 1, texto: "Apenas de Jerusalém", correta: false },
                            { numero: 2, texto: "De todas as nações, tribos, povos e línguas", correta: true },
                            { numero: 3, texto: "Somente das ilhas", correta: false },
                            { numero: 4, texto: "De uma única cidade", correta: false }
                        ],
                        explicacao: "Apocalipse 7:9 - Depois destas coisas olhei, e eis aqui uma grande multidão... de todas as nações, e tribos, e povos, e línguas...",
                        pontosGanhos: 20
                    },
                    {
                        texto: "O que os salvos tinham nas mãos diante do trono e do Cordeiro?",
                        opcoes: [
                            { numero: 1, texto: "Espadas de prata", correta: false },
                            { numero: 2, texto: "Livros de oração", correta: false },
                            { numero: 3, texto: "Cajados de madeira", correta: false },
                            { numero: 4, texto: "Palmas", correta: true }
                        ],
                        explicacao: "Apocalipse 7:9 - ...estavam diante do trono, e perante o Cordeiro, trajando vestes brancas e com palmas nas suas mãos.",
                        pontosGanhos: 20
                    }
                ]);
            }
        ...
        8: {
            ...
            texto: `¹ E, havendo aberto o sétimo selo, fez-se silêncio no céu quase por meia hora.
...
¹³ E olhei, e ouvi um anjo voar pelo meio do céu, dizendo com grande voz: Ai! Ai! Ai! Dos que habitam sobre a terra! Por causa das outras vozes das trombetas dos três anjos que estão por tocar.

 `,
            get pergunta() {
                return sortear([
                    {
                        texto: "Quanto tempo houve silêncio no céu ao abrir o sétimo selo?",
                        opcoes: [
                            { numero: 1, texto: "Quase uma hora", correta: false },
                            { numero: 2, texto: "Um dia inteiro", correta: false },
                            { numero: 3, texto: "Quase meia hora", correta: true },
                            { numero: 4, texto: "Sete minutos", correta: false }
                        ],
                        explicacao: "Apocalipse 8:1 - E, havendo aberto o sétimo selo, fez-se silêncio no céu quase por meia hora.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "Qual é o nome da grande estrela que caiu sobre a terça parte dos rios?",
                        opcoes: [
                            { numero: 1, texto: "Absinto", correta: true },
                            { numero: 2, texto: "Mata-fome", correta: false },
                            { numero: 3, texto: "Luz do Amanhã", correta: false },
                            { numero: 4, texto: "Fogo Ardente", correta: false }
                        ],
                        explicacao: "Apocalipse 8:11 - E o nome da estrela era Absinto, e a terça parte das águas tornou-se em absinto...",
                        pontosGanhos: 20
                    },
                    {
                        texto: "O que aconteceu quando o quarto anjo tocou a trombeta?",
                        opcoes: [
                            { numero: 1, texto: "As águas secaram", correta: false },
                            { numero: 2, texto: "O sol se apagou totalmente", correta: false },
                            { numero: 3, texto: "Caiu fogo do céu", correta: false },
                            { numero: 4, texto: "Ferida foi a terça parte do sol, da lua e das estrelas", correta: true }
                        ],
                        explicacao: "Apocalipse 8:12 - ...e foi ferida a terça parte do sol, e a terça parte da lua, e a terça parte das estrelas...",
                        pontosGanhos: 20
                    }
                ]);
            }
        ...
        9: {
            titulo: "Gafanhotos e Cavalaria",
            texto: ` ¹ E o quinto anjo tocou a sua trombeta, e vi uma estrela que do céu caiu na terra; e foi-lhe dada a chave do poço do abismo.
...
`,
            get pergunta() {
                return sortear([
                    {
                        texto: "Qual era o nome do anjo do abismo em hebraico?",
                        opcoes: [
                            { numero: 1, texto: "Abadon", correta: true },
                            { numero: 2, texto: "Apolion", correta: false },
                            { numero: 3, texto: "Gabriel", correta: false },
                            { numero: 4, texto: "Miguel", correta: false }
                        ],
                        explicacao: "Apocalipse 9:11 - E tinham sobre si rei, o anjo do abismo; em hebraico era o seu nome Abadon...",
                        pontosGanhos: 20
                    },
                    {
                        texto: "O que os gafanhotos tinham ordem para não danificar?",
                        opcoes: [
                            { numero: 1, texto: "As cidades", correta: false },
                            { numero: 2, texto: "Os animais domésticos", correta: false },
                            { numero: 3, texto: "A erva da terra, nem verdura alguma, nem árvore alguma", correta: true },
                            { numero: 4, texto: "As fontes de água", correta: false }
                        ],
                        explicacao: "Apocalipse 9:4 - E foi-lhes dito que não danificassem a erva da terra, nem verdura alguma, nem árvore alguma...",
                        pontosGanhos: 20
                    },
                    {
                        texto: "Onde estavam presos os quatro anjos soltos na sexta trombeta?",
                        opcoes: [
                            { numero: 1, texto: "No Mar Morto", correta: false },
                            { numero: 2, texto: "No Monte Sinai", correta: false },
                            { numero: 3, texto: "No templo de Jerusalém", correta: false },
                            { numero: 4, texto: "Junto ao grande rio Eufrates", correta: true }
                        ],
                        explicacao: "Apocalipse 9:14 - ...Solta os quatro anjos que estão presos junto ao grande rio Eufrates.",
                        pontosGanhos: 20
                    }
                ]);
            }
        ...
        10: {
            titulo: "O Livrinho Comido",
            texto: `¹ E vi outro anjo forte, que descia do céu, vestido de uma nuvem; e por cima da sua cabeça estava o arco celeste, e o seu rosto era como o sol, e os seus pés como colunas de fogo;
² E tinha na sua mão um livrinho aberto. E pôs o seu pé direito sobre o mar, e o esquerdo sobre a terra;
³ E clamou com grande voz, como quando ruge um leão; e, quando clamou, os sete trovões emitiram as suas vozes.
...
¹¹ E ele disse-me: Importa que profetizes outra vez a muitos povos, e nações, e línguas e reis.
 `,
            get pergunta() {
                return sortear([
                    {
                        texto: "O que João teve que fazer com o livrinho que recebeu do anjo?",
                        opcoes: [
                            { numero: 1, texto: "Queimá-lo", correta: false },
                            { numero: 2, texto: "Comê-lo", correta: true },
                            { numero: 3, texto: "Enterrá-lo", correta: false },
                            { numero: 4, texto: "Entregá-lo aos anciãos", correta: false }
                        ],
                        explicacao: "Apocalipse 10:9 - ...Toma-o, e come-o, e ele fará amargo o teu ventre, mas na tua boca será doce como mel.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "Como era o gosto do livrinho na boca de João?",
                        opcoes: [
                            { numero: 1, texto: "Amargo como fel", correta: false },
                            { numero: 2, texto: "Salgado como o mar", correta: false },
                            { numero: 3, texto: "Doce como mel", correta: true },
                            { numero: 4, texto: "Sem gosto nenhum", correta: false }
                        ],
                        explicacao: "Apocalipse 10:10 - ...e na minha boca era doce como mel; e, havendo-o comido, o meu ventre ficou amargo.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "O que aconteceu com o ventre de João após comer o livrinho?",
                        opcoes: [
                            { numero: 1, texto: "Ficou cheio de luz", correta: false },
                            { numero: 2, texto: "Ficou fortalecido", correta: false },
                            { numero: 3, texto: "Ficou satisfeito", correta: false },
                            { numero: 4, texto: "Ficou amargo", correta: true }
                        ],
                        explicacao: "Apocalipse 10:10 - ...e, havendo-o comido, o meu ventre ficou amargo.",
                        pontosGanhos: 20
                    }
                ]);
            }
        },
        // js/livros/apocalipse.js (Parte 3: Capítulos 11-15)

        11: {
            titulo: "As Duas Testemunhas",
            texto: ` ¹ E foi-me dada uma cana semelhante a uma vara; e chegou o anjo, e disse: Levanta-te, e mede o templo de Deus, e o altar, e os que nele adoram.
...
`,
            get pergunta() {
                return sortear([
                    {
                        texto: "Por quanto tempo as duas testemunhas profetizarão vestidas de saco?",
                        opcoes: [
                            { numero: 1, texto: "Mil e cem dias", correta: false },
                            { numero: 2, texto: "Mil duzentos e sessenta dias", correta: true },
                            { numero: 3, texto: "Quinhentos dias", correta: false },
                            { numero: 4, texto: "Sete anos exatos", correta: false }
                        ],
                        explicacao: "Apocalipse 11:3 - E darei poder às minhas duas testemunhas, e profetizarão por mil duzentos e sessenta dias, vestidas de saco.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "O que aconteceu com as duas testemunhas após três dias e meio mortas?",
                        opcoes: [
                            { numero: 1, texto: "Foram enterradas em segredo", correta: false },
                            { numero: 2, texto: "Permaneceram no chão para sempre", correta: false },
                            { numero: 3, texto: "O espírito de vida, vindo de Deus, entrou nelas, e puseram-se sobre seus pés", correta: true },
                            { numero: 4, texto: "Foram levadas pelos inimigos", correta: false }
                        ],
                        explicacao: "Apocalipse 11:11 - E depois daqueles três dias e meio o espírito de vida, vindo de Deus, entrou neles; e puseram-se sobre seus pés...",
                        pontosGanhos: 20
                    },
                    {
                        texto: "O que se abriu no céu quando o sétimo anjo tocou a trombeta?",
                        opcoes: [
                            { numero: 1, texto: "Um jardim suspenso", correta: false },
                            { numero: 2, texto: "Uma escada de ouro", correta: false },
                            { numero: 3, texto: "Um deserto de cristal", correta: false },
                            { numero: 4, texto: "O templo de Deus, e a arca da sua aliança foi vista", correta: true }
                        ],
                        explicacao: "Apocalipse 11:19 - E abriu-se no céu o templo de Deus, e a arca da sua aliança foi vista no seu templo...",
                        pontosGanhos: 20
                    }
                ]);
            }
...
¹⁷ E o dragão irou-se contra a mulher, e foi fazer guerra ao remanescente da sua semente, os que guardam os mandamentos de Deus, e têm o testemunho de Jesus Cristo.
 ...
 `,
            get pergunta() {
                return sortear([
                    {
                        texto: "O que apareceu no céu sob os pés da mulher vestida do sol?",
                        opcoes: [
                            { numero: 1, texto: "As nuvens", correta: false },
                            { numero: 2, texto: "A lua", correta: true },
                            { numero: 3, texto: "Sete estrelas", correta: false },
                            { numero: 4, texto: "Um tapete vermelho", correta: false }
                        ],
                        explicacao: "Apocalipse 12:1 - E viu-se um grande sinal no céu: uma mulher vestida do sol, tendo a lua debaixo dos seus pés...",
                        pontosGanhos: 20
                    },
                    {
                        texto: "Quem lutou contra o dragão e seus anjos no céu?",
                        opcoes: [
                            { numero: 1, texto: "Os anciãos", correta: false },
                            { numero: 2, texto: "Os profetas", correta: false },
                            { numero: 3, texto: "Miguel e os seus anjos", correta: true },
                            { numero: 4, texto: "As duas testemunhas", correta: false }
                        ],
                        explicacao: "Apocalipse 12:7 - E houve batalha no céu; Miguel e os seus anjos batalhavam contra o dragão...",
                        pontosGanhos: 20
                    },
                    {
                        texto: "Como os irmãos venceram o dragão (o acusador)?",
                        opcoes: [
                            { numero: 1, texto: "Pela força física", correta: false },
                            { numero: 2, texto: "Pelo conhecimento humano", correta: false },
                            { numero: 3, texto: "Pela fuga para os montes", correta: false },
                            { numero: 4, texto: "Pelo sangue do Cordeiro e pela palavra do seu testemunho", correta: true }
                        ],
                        explicacao: "Apocalipse 12:11 - E eles o venceram pelo sangue do Cordeiro e pela palavra do seu testemunho...",
                        pontosGanhos: 20
                    }
                ]);
            }
        ...
        13: {
            titulo: "As Duas Bestas",
            texto: `¹ E eu pus-me sobre a areia do mar, e vi subir do mar uma besta que tinha sete cabeças e dez chifres, e sobre os seus chifres dez diademas, e sobre as suas cabeças um nome de blasfêmia.
...
`,
            get pergunta() {
                return sortear([
                    {
                        texto: "Quantas cabeças e quantos chifres tinha a besta que subiu do mar?",
                        opcoes: [
                            { numero: 1, texto: "Sete cabeças e dez chifres", correta: true },
                            { numero: 2, texto: "Uma cabeça e sete chifres", correta: false },
                            { numero: 3, texto: "Quatro cabeças e quatro chifres", correta: false },
                            { numero: 4, texto: "Dez cabeças e sete chifres", correta: false }
                        ],
                        explicacao: "Apocalipse 13:1 - ...vi subir do mar uma besta que tinha sete cabeças e dez chifres...",
                        pontosGanhos: 20
                    },
                    {
                        texto: "O que a segunda besta (que subiu da terra) fazia a imagem da primeira besta fazer?",
                        opcoes: [
                            { numero: 1, texto: "Falar e fazer com que fossem mortos os que não a adorassem", correta: true },
                            { numero: 2, texto: "Cantar hinos", correta: false },
                            { numero: 3, texto: "Distribuir comida", correta: false },
                            { numero: 4, texto: "Desaparecer no ar", correta: false }
                        ],
                        explicacao: "Apocalipse 13:15 - E foi-lhe concedido que desse espírito à imagem da besta, para que também a imagem da besta falasse...",
                        pontosGanhos: 20
                    },
                    {
                        texto: "Qual é o número da besta mencionado no final do capítulo 13?",
                        opcoes: [
                            { numero: 1, texto: "777", correta: false },
                            { numero: 2, texto: "144", correta: false },
                            { numero: 3, texto: "333", correta: false },
                            { numero: 4, texto: "666", correta: true }
                        ],
                        explicacao: "Apocalipse 13:18 - ...o seu número é seiscentos e sessenta e seis.",
                        pontosGanhos: 20
                    }
                ]);
            }
        ...
        14: {
            titulo: "O Cordeiro e o Juízo",
            texto: ` ¹ E olhei, e eis que estava o Cordeiro sobre o monte Sião, e com ele cento e quarenta e quatro mil, que em suas testas tinham escrito o nome de seu Pai.
...
`,
            get pergunta() {
                return sortear([
                    {
                        texto: "O que os 144 mil tinham escrito em suas testas?",
                        opcoes: [
                            { numero: 1, texto: "O nome do Cordeiro e o nome de seu Pai", correta: true },
                            { numero: 2, texto: "O nome de uma cidade", correta: false },
                            { numero: 3, texto: "Uma estrela de ouro", correta: false },
                            { numero: 4, texto: "O número sete", correta: false }
                        ],
                        explicacao: "Apocalipse 14:1 - ...e com ele cento e quarenta e quatro mil, que em suas testas tinham escrito o nome de seu Pai.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "O que o primeiro anjo que voava pelo meio do céu dizia em grande voz?",
                        opcoes: [
                            { numero: 1, texto: "O dia está lindo", correta: false },
                            { numero: 2, texto: "Buscai riquezas", correta: false },
                            { numero: 3, texto: "Temei a Deus, e dai-lhe glória; porque é vinda a hora do seu juízo", correta: true },
                            { numero: 4, texto: "O silêncio é melhor", correta: false }
                        ],
                        explicacao: "Apocalipse 14:7 - Dizendo com grande voz: Temei a Deus, e dai-lhe glória; porque é vinda a hora do seu juízo...",
                        pontosGanhos: 20
                    },
                    {
                        texto: "O que diz a voz do céu sobre os mortos que morrem no Senhor?",
                        opcoes: [
                            { numero: 1, texto: "Que eles serão esquecidos", correta: false },
                            { numero: 2, texto: "Que eles voltarão à terra logo", correta: false },
                            { numero: 3, texto: "Que eles precisam de ajuda", correta: false },
                            { numero: 4, texto: "Bem-aventurados... para que descansem dos seus trabalhos", correta: true }
                        ],
                        explicacao: "Apocalipse 14:13 - ...Bem-aventurados os mortos que desde agora morrem no Senhor... para que descansem dos seus trabalhos...",
                        pontosGanhos: 20
                    }
                ]);
            }
        ...
        15: {
            titulo: "As Sete Pragas",
            texto: `¹ E vi outro grande e admirável sinal no céu: sete anjos, que tinham as sete últimas pragas; porque nelas é consumada a ira de Deus.
...
⁸ E o templo encheu-se com a fumaça da glória de Deus e do seu poder; e ninguém podia entrar no templo, até que se consumassem as sete pragas dos sete anjos.
 ...
 `,
            get pergunta() {
                return sortear([
                    {
                        texto: "O que os vitoriosos sobre a besta cantavam?",
                        opcoes: [
                            { numero: 1, texto: "O cântico de Moisés e o cântico do Cordeiro", correta: true },
                            { numero: 2, texto: "O cântico dos reis", correta: false },
                            { numero: 3, texto: "Salmos de Davi apenas", correta: false },
                            { numero: 4, texto: "Hinos nacionais", correta: false }
                        ],
                        explicacao: "Apocalipse 15:3 - E cantavam o cântico de Moisés, servo de Deus, e o cântico do Cordeiro...",
                        pontosGanhos: 20
                    },
                    {
                        texto: "Do que o templo se encheu, vindo da glória de Deus e do seu poder?",
                        opcoes: [
                            { numero: 1, texto: "Água cristalina", correta: false },
                            { numero: 2, texto: "Fumaça", correta: true },
                            { numero: 3, texto: "Flores brancas", correta: false },
                            { numero: 4, texto: "Luz azul", correta: false }
                        ],
                        explicacao: "Apocalipse 15:8 - E o templo encheu-se com a fumaça da glória de Deus e do seu poder...",
                        pontosGanhos: 20
                    },
                    {
                        texto: "Quem entregou aos sete anjos as sete taças de ouro cheias da ira de Deus?",
                        opcoes: [
                            { numero: 1, texto: "João", correta: false },
                            { numero: 2, texto: "Um dos anciãos", correta: false },
                            { numero: 3, texto: "Um dos profetas", correta: false },
                            { numero: 4, texto: "Um dos quatro animais", correta: true }
                        ],
                        explicacao: "Apocalipse 15:7 - E um dos quatro animais deu aos sete anjos sete taças de ouro, cheias da ira de Deus...",
                        pontosGanhos: 20
                    }
                ]);
            }
        },
        // js/livros/apocalipse.js (Parte 4: Capítulos 16-20)

        16: {
            titulo: "As Sete Taças da Ira",
            texto: ` ¹ E ouvi, vinda do templo, uma grande voz, que dizia aos sete anjos: Ide, e derramai sobre a terra as sete taças da ira de Deus.
...
¹⁴ Porque são espíritos de demônios, que fazendo milagres vão ao encontro dos reis da terra e de todo o mundo, para os congregar para a batalha, daquele grande dia do Deus Todo-Poderoso.
...
`,
            get pergunta() {
                return sortear([
                    {
                        texto: "O que aconteceu quando a quarta taça foi derramada sobre o sol?",
                        opcoes: [
                            { numero: 1, texto: "O sol parou de brilhar", correta: false },
                            { numero: 2, texto: "Foi-lhe permitido que abrasasse os homens com fogo", correta: true },
                            { numero: 3, texto: "O sol tornou-se azul", correta: false },
                            { numero: 4, texto: "A temperatura da terra caiu drasticamente", correta: false }
                        ],
                        explicacao: "Apocalipse 16:8 - E o quarto anjo derramou a sua taça sobre o sol, e foi-lhe permitido que abrasasse os homens com fogo.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "Para onde os espíritos de demônios congregaram os reis da terra para a batalha?",
                        opcoes: [
                            { numero: 1, texto: "Para o Egito", correta: false },
                            { numero: 2, texto: "Para as ilhas do mar", correta: false },
                            { numero: 3, texto: "Para o lugar que em hebraico se chama Armagedom", correta: true },
                            { numero: 4, texto: "Para as montanhas de Edom", correta: false }
                        ],
                        explicacao: "Apocalipse 16:16 - E os congregaram no lugar que em hebraico se chama Armagedom.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "O que aconteceu com as ilhas e os montes na sétima taça?",
                        opcoes: [
                            { numero: 1, texto: "Tornaram-se maiores", correta: false },
                            { numero: 2, texto: "Ficaram cobertos de neve", correta: false },
                            { numero: 3, texto: "Foram protegidos", correta: false },
                            { numero: 4, texto: "Toda a ilha fugiu; e os montes não se acharam", correta: true }
                        ],
                        explicacao: "Apocalipse 16:20 - E toda a ilha fugiu; e os montes não se acharam.",
                        pontosGanhos: 20
                    }
                ]);
            }
        ...
        17: {
            titulo: "A Mulher e a Besta Escarlate",
            texto: `¹ E veio um dos sete anjos que tinham as sete taças, e falou comigo, dizendo-me: Vem, mostrar-te-ei a condenação da grande prostituta que está assentada sobre muitas águas;
...
¹⁸ E a mulher que viste é a grande cidade que reina sobre os reis da terra.
 ...
 `,
            get pergunta() {
                return sortear([
                    {
                        texto: "O que estava escrito na testa da mulher sentada sobre a besta escarlate?",
                        opcoes: [
                            { numero: 1, texto: "O nome de uma rainha", correta: false },
                            { numero: 2, texto: "Mistério, a grande Babilônia", correta: true },
                            { numero: 3, texto: "A senhora do mundo", correta: false },
                            { numero: 4, texto: "Paz e Segurança", correta: false }
                        ],
                        explicacao: "Apocalipse 17:5 - E na sua testa estava escrito um nome: Mistério, a grande Babilônia...",
                        pontosGanhos: 20
                    },
                    {
                        texto: "Quem vencerá a besta e os dez reis?",
                        opcoes: [
                            { numero: 1, texto: "Os exércitos da terra", correta: false },
                            { numero: 2, texto: "A própria natureza", correta: false },
                            { numero: 3, texto: "O Cordeiro, porque é o Senhor dos senhores e o Rei dos reis", correta: true },
                            { numero: 4, texto: "Ninguém poderá vencê-los", correta: false }
                        ],
                        explicacao: "Apocalipse 17:14 - Estes combaterão contra o Cordeiro, e o Cordeiro os vencerá, porque é o Senhor dos senhores...",
                        pontosGanhos: 20
                    },
                    {
                        texto: "O que representam as águas onde a prostituta está assentada?",
                        opcoes: [
                            { numero: 1, texto: "Oceanos físicos", correta: false },
                            { numero: 2, texto: "Rios de água doce", correta: false },
                            { numero: 3, texto: "O tempo que passou", correta: false },
                            { numero: 4, texto: "Povos, multidões, nações e línguas", correta: true }
                        ],
                        explicacao: "Apocalipse 17:15 - ...As águas que viste, onde se assenta a prostituta, são povos, multidões, nações e línguas.",
                        pontosGanhos: 20
                    }
                ]);
            }
        ...
        18: {
            ...
            texto: `¹ E depois destas coisas vi descer do céu outro anjo, que tinha grande poder, e a terra foi iluminada com a sua glória.
...
²⁴ E nela se achou o sangue dos profetas, e dos santos, e de todos os que foram mortos na terra.
 ...
 `,
            get pergunta() {
                return sortear([
                    {
                        texto: "O que a voz do céu ordenou ao povo de Deus em relação à Babilônia?",
                        opcoes: [
                            { numero: 1, texto: "Que entrassem nela para converter todos", correta: false },
                            { numero: 2, texto: "Sai dela, povo meu, para que não sejas participante dos seus pecados", correta: true },
                            { numero: 3, texto: "Que lutassem com armas contra ela", correta: false },
                            { numero: 4, texto: "Que comprassem suas mercadorias", correta: false }
                        ],
                        explicacao: "Apocalipse 18:4 - E ouvi outra voz do céu, que dizia: Sai dela, povo meu, para que não sejas participante dos seus pecados...",
                        pontosGanhos: 20
                    },
                    {
                        texto: "Em quanto tempo veio o juízo e a destruição da Babilônia?",
                        opcoes: [
                            { numero: 1, texto: "Em um ano", correta: false },
                            { numero: 2, texto: "Em um mês", correta: false },
                            { numero: 3, texto: "Em uma hora", correta: true },
                            { numero: 4, texto: "Em uma semana", correta: false }
                        ],
                        explicacao: "Apocalipse 18:10 - ...Ai! ai daquela grande cidade... pois numa hora veio o teu juízo.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "O que um anjo forte lançou no mar para ilustrar a queda da cidade?",
                        opcoes: [
                            { numero: 1, texto: "Uma âncora de ferro", correta: false },
                            { numero: 2, texto: "Um navio de mercadorias", correta: false },
                            { numero: 3, texto: "As chaves da cidade", correta: false },
                            { numero: 4, texto: "Uma pedra como uma grande mó", correta: true }
                        ],
                        explicacao: "Apocalipse 18:21 - E um forte anjo levantou uma pedra como uma grande mó, e lançou-a no mar...",
                        pontosGanhos: 20
                    }
                ]);
            }
        ...
        19: {
            titulo: "As Bodas do Cordeiro e o Cavaleiro",
            texto: ` ¹ E, depois destas coisas ouvi no céu uma grande voz de uma grande multidão, que dizia: Aleluia! A salvação, e a glória, e a honra, e o poder pertencem ao Senhor nosso Deus;
...
`,
            get pergunta() {
                return sortear([
                    {
                        texto: "Como é chamado o cavaleiro do cavalo branco no versículo 11?",
                        opcoes: [
                            { numero: 1, texto: "Guerreiro da Luz", correta: false },
                            { numero: 2, texto: "Fiel e Verdadeiro", correta: true },
                            { numero: 3, texto: "O Primeiro de Todos", correta: false },
                            { numero: 4, texto: "Justiça Divina", correta: false }
                        ],
                        explicacao: "Apocalipse 19:11 - E vi o céu aberto, e eis um cavalo branco; e o que estava assentado sobre ele chama-se Fiel e Verdadeiro...",
                        pontosGanhos: 20
                    },
                    {
                        texto: "O que saía da boca do cavaleiro para ferir as nações?",
                        opcoes: [
                            { numero: 1, texto: "Fogo e enxofre", correta: false },
                            { numero: 2, texto: "Um vento forte", correta: false },
                            { numero: 3, texto: "Uma aguda espada", correta: true },
                            { numero: 4, texto: "Água da vida", correta: false }
                        ],
                        explicacao: "Apocalipse 19:15 - E da sua boca saía uma aguda espada, para ferir com ela as nações...",
                        pontosGanhos: 20
                    },
                    {
                        texto: "Qual nome estava escrito na veste e na coxa do cavaleiro?",
                        opcoes: [
                            { numero: 1, texto: "Filho de Davi", correta: false },
                            { numero: 2, texto: "Salvador do Mundo", correta: false },
                            { numero: 3, texto: "O Verbo Eterno", correta: false },
                            { numero: 4, texto: "Rei dos reis, e Senhor dos senhores", correta: true }
                        ],
                        explicacao: "Apocalipse 19:16 - E no manto e na sua coxa tem escrito este nome: Rei dos reis, e Senhor dos senhores.",
                        pontosGanhos: 20
                    }
                ]);
            }
        ...
        20: {
            ...
            texto: ` ¹ E vi descer do céu um anjo, que tinha a chave do abismo, e uma grande cadeia na sua mão.
...
¹² E vi os mortos, pequenos e grandes, que estavam diante de Deus, e abriram-se os livros; e abriu-se outro livro, que é o da vida. E os mortos foram julgados pelas coisas que estavam escritas nos livros, segundo as suas obras.
...
`,
            get pergunta() {
                return sortear([
                    {
                        texto: "Por quanto tempo Satanás foi preso no abismo?",
                        opcoes: [
                            { numero: 1, texto: "Cem anos", correta: false },
                            { numero: 2, texto: "Mil anos", correta: true },
                            { numero: 3, texto: "Sete mil anos", correta: false },
                            { numero: 4, texto: "Para sempre, desde o início", correta: false }
                        ],
                        explicacao: "Apocalipse 20:2 - Ele prendeu o dragão... e amarrou-o por mil anos.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "Onde foram lançados a morte e o inferno (Hades)?",
                        opcoes: [
                            { numero: 1, texto: "No fundo do mar", correta: false },
                            { numero: 2, texto: "Em uma prisão eterna na terra", correta: false },
                            { numero: 3, texto: "No lago de fogo", correta: true },
                            { numero: 4, texto: "No vazio do espaço", correta: false }
                        ],
                        explicacao: "Apocalipse 20:14 - E a morte e o inferno foram lançados no lago de fogo. Esta é a segunda morte.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "Quem foi lançado no lago de fogo, segundo o versículo 15?",
                        opcoes: [
                            { numero: 1, texto: "Apenas os reis da terra", correta: false },
                            { numero: 2, texto: "Aqueles que não tinham riquezas", correta: false },
                            { numero: 3, texto: "Os que não conheciam a história", correta: false },
                            { numero: 4, texto: "Aquele que não foi achado escrito no livro da vida", correta: true }
                        ],
                        explicacao: "Apocalipse 20:15 - E aquele que não foi achado escrito no livro da vida foi lançado no lago de fogo.",
                        pontosGanhos: 20
                    }
                ]);
            }
        },
        // js/livros/apocalipse.js (Parte Final: Capítulos 21-22 e Fechamento)

        21: {
            titulo: "Novo Céu e Nova Terra",
            texto: ` ¹ E vi um novo céu, e uma nova terra. Porque já o primeiro céu e a primeira terra passaram, e o mar já não existe.
...
`,
            get pergunta() {
                return sortear([
                    {
                        texto: "O que Deus limpará dos olhos dos seus filhos?",
                        opcoes: [
                            { numero: 1, texto: "A poeira do caminho", correta: false },
                            { numero: 2, texto: "Toda a lágrima", correta: true },
                            { numero: 3, texto: "O cansaço da jornada", correta: false },
                            { numero: 4, texto: "A visão do passado", correta: false }
                        ],
                        explicacao: "Apocalipse 21:4 - E Deus limpará de seus olhos toda a lágrima; e não haverá mais morte, nem pranto...",
                        pontosGanhos: 20
                    },
                    {
                        texto: "Como era a praça da cidade (Nova Jerusalém)?",
                        opcoes: [
                            { numero: 1, texto: "De mármore branco", correta: false },
                            { numero: 2, texto: "De pedras preciosas verdes", correta: false },
                            { numero: 3, texto: "De ouro puro, como vidro transparente", correta: true },
                            { numero: 4, texto: "De cristais coloridos", correta: false }
                        ],
                        explicacao: "Apocalipse 21:21 - ...e a praça da cidade de ouro puro, como vidro transparente.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "Por que a cidade não precisava de sol nem de lua?",
                        opcoes: [
                            { numero: 1, texto: "Porque as pessoas não dormiam mais", correta: false },
                            { numero: 2, texto: "Porque havia luz artificial", correta: false },
                            { numero: 3, texto: "Porque o céu era sempre azul", correta: false },
                            { numero: 4, texto: "Porque a glória de Deus a iluminava, e o Cordeiro era a sua lâmpada", correta: true }
                        ],
                        explicacao: "Apocalipse 21:23 - E a cidade não necessita de sol nem de lua... porque a glória de Deus a iluminou, e o Cordeiro é a sua lâmpada.",
                        pontosGanhos: 20
                    }
                ]);
            }
        ...
        22: {
            titulo: "O Rio da Vida e o Fim",
            texto: `¹ E mostrou-me o rio puro da água da vida, claro como cristal, que procedia do trono de Deus e do Cordeiro.
...
²¹ A graça de nosso Senhor Jesus Cristo seja com todos vós. Amém.
 ...
 `,
            get pergunta() {
                return sortear([
                    {
                        texto: "O que estava no meio da praça da cidade e de ambos os lados do rio?",
                        opcoes: [
                            { numero: 1, texto: "O trono de Davi", correta: false },
                            { numero: 2, texto: "A árvore da vida", correta: true },
                            { numero: 3, texto: "Uma estátua de ouro", correta: false },
                            { numero: 4, texto: "O templo de Salomão", correta: false }
                        ],
                        explicacao: "Apocalipse 22:2 - No meio da sua praça... estava a árvore da vida, que produz doze frutos...",
                        pontosGanhos: 20
                    },
                    {
                        texto: "Qual é o aviso sobre aquele que acrescentar algo às palavras deste livro?",
                        opcoes: [
                            { numero: 1, texto: "Será apenas repreendido", correta: false },
                            { numero: 2, texto: "Perderá seus bens", correta: false },
                            { numero: 3, texto: "Deus fará vir sobre ele as pragas escritas neste livro", correta: true },
                            { numero: 4, texto: "Não acontecerá nada", correta: false }
                        ],
                        explicacao: "Apocalipse 22:18 - ...se alguém lhes acrescentar alguma coisa, Deus fará vir sobre ele as pragas que estão escritas neste livro.",
                        pontosGanhos: 20
                    },
                    {
                        texto: "Qual é a última promessa de Jesus no livro de Apocalipse?",
                        opcoes: [
                            { numero: 1, texto: "Fiquem em paz", correta: false },
                            { numero: 2, texto: "O fim está longe", correta: false },
                            { numero: 3, texto: "Ouçam os profetas", correta: false },
                            { numero: 4, texto: "Certamente cedo venho", correta: true }
                        ],
                        explicacao: "Apocalipse 22:20 - Aquele que testifica estas coisas diz: Certamente cedo venho. Amém. Ora vem, Senhor Jesus.",
                        pontosGanhos: 20
                    }
                ]);
            }
